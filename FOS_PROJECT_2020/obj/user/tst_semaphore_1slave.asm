...
_main(void)
{
  ...
  8000d2:	e8 0c 18 00 00       	call   8018e3 <env_sleep>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  80165b:	e8 27 fc ff ff       	call   801287 <syscall>
...
sys_run_env(int32 envId)
{
  ...
  801673:	50                   	push   %eax
  801674:	6a 22                	push   $0x22
  801676:	e8 0c fc ff ff       	call   801287 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801692:	e8 f0 fb ff ff       	call   801287 <syscall>
...
sys_get_virtual_time()
{
  ...
  8016b6:	e8 cc fb ff ff       	call   801287 <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8016e3:	6a 13                	push   $0x13
  8016e5:	e8 9d fb ff ff       	call   801287 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8016ff:	e8 83 fb ff ff       	call   801287 <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801724:	e8 5e fb ff ff       	call   801287 <syscall>
...
void rsttst()
{
  ...
  80173e:	e8 44 fb ff ff       	call   801287 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801769:	e8 19 fb ff ff       	call   801287 <syscall>
...
void chktst(uint32 n)
{
  ...
  801784:	e8 fe fa ff ff       	call   801287 <syscall>
...
void inctst()
{
  ...
  80179e:	e8 e4 fa ff ff       	call   801287 <syscall>
...
uint32 gettst()
{
  ...
  8017b8:	e8 ca fa ff ff       	call   801287 <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8017d4:	e8 ae fa ff ff       	call   801287 <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801805:	e8 7d fa ff ff       	call   801287 <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801836:	e8 4c fa ff ff       	call   801287 <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801867:	e8 1b fa ff ff       	call   801287 <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801896:	e8 ec f9 ff ff       	call   801287 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8018b9:	e8 c9 f9 ff ff       	call   801287 <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8018d9:	e8 a9 f9 ff ff       	call   801287 <syscall>
