	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8008af:	e8 44 13 00 00       	call   801bf8 <__udivdi3>
  ...
  8008fd:	52                   	push   %edx
  8008fe:	50                   	push   %eax
  8008ff:	e8 04 14 00 00       	call   801d08 <__umoddi3>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801970:	e8 27 fc ff ff       	call   80159c <syscall>
...
sys_run_env(int32 envId)
{
  ...
  80198b:	e8 0c fc ff ff       	call   80159c <syscall>
...
sys_free_env(int32 envId)
{
  ...
  8019a7:	e8 f0 fb ff ff       	call   80159c <syscall>
...
sys_get_virtual_time()
{
  ...
  8019cb:	e8 cc fb ff ff       	call   80159c <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8019fa:	e8 9d fb ff ff       	call   80159c <syscall>
...
uint32 sys_rcr2()
{
  ...
  801a14:	e8 83 fb ff ff       	call   80159c <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801a39:	e8 5e fb ff ff       	call   80159c <syscall>
...
void rsttst()
{
  ...
  801a53:	e8 44 fb ff ff       	call   80159c <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801a7e:	e8 19 fb ff ff       	call   80159c <syscall>
...
void chktst(uint32 n)
{
  ...
  801a99:	e8 fe fa ff ff       	call   80159c <syscall>
...
void inctst()
{
  ...
  801ab3:	e8 e4 fa ff ff       	call   80159c <syscall>
...
uint32 gettst()
{
  ...
  801acd:	e8 ca fa ff ff       	call   80159c <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801ae9:	e8 ae fa ff ff       	call   80159c <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801b1a:	e8 7d fa ff ff       	call   80159c <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801b4b:	e8 4c fa ff ff       	call   80159c <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801b7c:	e8 1b fa ff ff       	call   80159c <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801bab:	e8 ec f9 ff ff       	call   80159c <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801bce:	e8 c9 f9 ff ff       	call   80159c <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801bee:	e8 a9 f9 ff ff       	call   80159c <syscall>
