...
void high_complexity_function()
{
  ...
  800052:	50                   	push   %eax
  800053:	e8 24 14 00 00       	call   80147c <sys_get_virtual_time>
  ...
  800073:	50                   	push   %eax
  800074:	e8 03 14 00 00       	call   80147c <sys_get_virtual_time>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801437:	50                   	push   %eax
  801438:	6a 21                	push   $0x21
  80143a:	e8 27 fc ff ff       	call   801066 <syscall>
  80143f:	83 c4 18             	add    $0x18,%esp
}
  801442:	c9                   	leave  
  801443:	c3                   	ret    

00801444 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  801452:	50                   	push   %eax
  801453:	6a 22                	push   $0x22
  801455:	e8 0c fc ff ff       	call   801066 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  80146e:	50                   	push   %eax
  80146f:	6a 23                	push   $0x23
  801471:	e8 f0 fb ff ff       	call   801066 <syscall>
...
sys_get_virtual_time()
{
  ...
  801482:	8d 45 f8             	lea    -0x8(%ebp),%eax
  801485:	8d 50 04             	lea    0x4(%eax),%edx
  ...
  801491:	52                   	push   %edx
  801492:	50                   	push   %eax
  801493:	6a 24                	push   $0x24
  801495:	e8 cc fb ff ff       	call   801066 <syscall>
  ...
  8014a8:	89 51 04             	mov    %edx,0x4(%ecx)
}
  8014ab:	8b 45 08             	mov    0x8(%ebp),%eax
  8014ae:	c9                   	leave  
  8014af:	c2 04 00             	ret    $0x4

008014b2 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8014c4:	e8 9d fb ff ff       	call   801066 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8014de:	e8 83 fb ff ff       	call   801066 <syscall>
  8014e3:	83 c4 18             	add    $0x18,%esp
}
  8014e6:	c9                   	leave  
  8014e7:	c3                   	ret    

008014e8 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  8014f1:	88 45 fc             	mov    %al,-0x4(%ebp)
	syscall(SYS_bypassPageFault, instrLength, 0, 0, 0, 0);
  8014f4:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  8014f8:	6a 00                	push   $0x0
  8014fa:	6a 00                	push   $0x0
  8014fc:	6a 00                	push   $0x0
  8014fe:	6a 00                	push   $0x0
  801500:	50                   	push   %eax
  801501:	6a 26                	push   $0x26
  801503:	e8 5e fb ff ff       	call   801066 <syscall>
...
void rsttst()
{
  ...
  80151b:	6a 28                	push   $0x28
  80151d:	e8 44 fb ff ff       	call   801066 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801534:	8b 55 18             	mov    0x18(%ebp),%edx
  801537:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  80153b:	52                   	push   %edx
  80153c:	50                   	push   %eax
  80153d:	ff 75 10             	pushl  0x10(%ebp)
  801540:	ff 75 0c             	pushl  0xc(%ebp)
  801543:	ff 75 08             	pushl  0x8(%ebp)
  801546:	6a 27                	push   $0x27
  801548:	e8 19 fb ff ff       	call   801066 <syscall>
...
void chktst(uint32 n)
{
  ...
  801561:	6a 29                	push   $0x29
  801563:	e8 fe fa ff ff       	call   801066 <syscall>
...
void inctst()
{
  ...
  80157d:	e8 e4 fa ff ff       	call   801066 <syscall>
...
uint32 gettst()
{
  ...
  801595:	6a 2b                	push   $0x2b
  801597:	e8 ca fa ff ff       	call   801066 <syscall>
  80159c:	83 c4 18             	add    $0x18,%esp
}
  80159f:	c9                   	leave  
  8015a0:	c3                   	ret    

008015a1 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8015b3:	e8 ae fa ff ff       	call   801066 <syscall>
  8015b8:	83 c4 18             	add    $0x18,%esp
  8015bb:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8015be:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8015c2:	75 07                	jne    8015cb <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8015c4:	b8 01 00 00 00       	mov    $0x1,%eax
  8015c9:	eb 05                	jmp    8015d0 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
008015d2 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  8015e4:	e8 7d fa ff ff       	call   801066 <syscall>
  8015e9:	83 c4 18             	add    $0x18,%esp
  8015ec:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  8015ef:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  8015f3:	75 07                	jne    8015fc <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  8015f5:	b8 01 00 00 00       	mov    $0x1,%eax
  8015fa:	eb 05                	jmp    801601 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801603 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801615:	e8 4c fa ff ff       	call   801066 <syscall>
  80161a:	83 c4 18             	add    $0x18,%esp
  80161d:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  801620:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801624:	75 07                	jne    80162d <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801626:	b8 01 00 00 00       	mov    $0x1,%eax
  80162b:	eb 05                	jmp    801632 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801634 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801646:	e8 1b fa ff ff       	call   801066 <syscall>
  80164b:	83 c4 18             	add    $0x18,%esp
  80164e:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801651:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801655:	75 07                	jne    80165e <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801657:	b8 01 00 00 00       	mov    $0x1,%eax
  80165c:	eb 05                	jmp    801663 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801665 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801673:	6a 2d                	push   $0x2d
  801675:	e8 ec f9 ff ff       	call   801066 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801694:	52                   	push   %edx
  801695:	50                   	push   %eax
  801696:	6a 2e                	push   $0x2e
  801698:	e8 c9 f9 ff ff       	call   801066 <syscall>
...
008016a5 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8016b8:	e8 a9 f9 ff ff       	call   801066 <syscall>
