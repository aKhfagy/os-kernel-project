...
void _main(void)
{
  ...
  8000f4:	50                   	push   %eax
  8000f5:	e8 08 1a 00 00       	call   801b02 <sys_check_LRU_lists>
  ...
  800329:	50                   	push   %eax
  80032a:	e8 d3 17 00 00       	call   801b02 <sys_check_LRU_lists>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8007fb:	e8 44 13 00 00       	call   801b44 <__udivdi3>
  ...
  800849:	52                   	push   %edx
  80084a:	50                   	push   %eax
  80084b:	e8 04 14 00 00       	call   801c54 <__umoddi3>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8018b9:	50                   	push   %eax
  8018ba:	6a 21                	push   $0x21
  8018bc:	e8 27 fc ff ff       	call   8014e8 <syscall>
  8018c1:	83 c4 18             	add    $0x18,%esp
}
  8018c4:	c9                   	leave  
  8018c5:	c3                   	ret    

008018c6 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  8018d7:	e8 0c fc ff ff       	call   8014e8 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  8018f0:	50                   	push   %eax
  8018f1:	6a 23                	push   $0x23
  8018f3:	e8 f0 fb ff ff       	call   8014e8 <syscall>
...
sys_get_virtual_time()
{
  ...
  801913:	52                   	push   %edx
  801914:	50                   	push   %eax
  801915:	6a 24                	push   $0x24
  801917:	e8 cc fb ff ff       	call   8014e8 <syscall>
  80191c:	83 c4 18             	add    $0x18,%esp
	return result;
  80191f:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801922:	8b 45 f8             	mov    -0x8(%ebp),%eax
  801925:	8b 55 fc             	mov    -0x4(%ebp),%edx
  801928:	89 01                	mov    %eax,(%ecx)
  80192a:	89 51 04             	mov    %edx,0x4(%ecx)
}
  80192d:	8b 45 08             	mov    0x8(%ebp),%eax
  801930:	c9                   	leave  
  801931:	c2 04 00             	ret    $0x4

00801934 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801944:	6a 13                	push   $0x13
  801946:	e8 9d fb ff ff       	call   8014e8 <syscall>
...
uint32 sys_rcr2()
{
  ...
  80195e:	6a 25                	push   $0x25
  801960:	e8 83 fb ff ff       	call   8014e8 <syscall>
  801965:	83 c4 18             	add    $0x18,%esp
}
  801968:	c9                   	leave  
  801969:	c3                   	ret    

0080196a <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801976:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  80197a:	6a 00                	push   $0x0
  80197c:	6a 00                	push   $0x0
  80197e:	6a 00                	push   $0x0
  801980:	6a 00                	push   $0x0
  801982:	50                   	push   %eax
  801983:	6a 26                	push   $0x26
  801985:	e8 5e fb ff ff       	call   8014e8 <syscall>
...
void rsttst()
{
  ...
  80199d:	6a 28                	push   $0x28
  80199f:	e8 44 fb ff ff       	call   8014e8 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8019b6:	8b 55 18             	mov    0x18(%ebp),%edx
  ...
  8019c8:	6a 27                	push   $0x27
  8019ca:	e8 19 fb ff ff       	call   8014e8 <syscall>
...
void chktst(uint32 n)
{
  ...
  8019e3:	6a 29                	push   $0x29
  8019e5:	e8 fe fa ff ff       	call   8014e8 <syscall>
...
void inctst()
{
  ...
  8019fd:	6a 2a                	push   $0x2a
  8019ff:	e8 e4 fa ff ff       	call   8014e8 <syscall>
...
uint32 gettst()
{
  ...
  801a17:	6a 2b                	push   $0x2b
  801a19:	e8 ca fa ff ff       	call   8014e8 <syscall>
  801a1e:	83 c4 18             	add    $0x18,%esp
}
  801a21:	c9                   	leave  
  801a22:	c3                   	ret    

00801a23 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801a35:	e8 ae fa ff ff       	call   8014e8 <syscall>
  801a3a:	83 c4 18             	add    $0x18,%esp
  801a3d:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801a40:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801a44:	75 07                	jne    801a4d <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801a46:	b8 01 00 00 00       	mov    $0x1,%eax
  801a4b:	eb 05                	jmp    801a52 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801a54 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801a64:	6a 2c                	push   $0x2c
  801a66:	e8 7d fa ff ff       	call   8014e8 <syscall>
  801a6b:	83 c4 18             	add    $0x18,%esp
  801a6e:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  801a71:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801a75:	75 07                	jne    801a7e <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801a77:	b8 01 00 00 00       	mov    $0x1,%eax
  801a7c:	eb 05                	jmp    801a83 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801a85 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801a95:	6a 2c                	push   $0x2c
  801a97:	e8 4c fa ff ff       	call   8014e8 <syscall>
  801a9c:	83 c4 18             	add    $0x18,%esp
  801a9f:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  801aa2:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801aa6:	75 07                	jne    801aaf <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801aa8:	b8 01 00 00 00       	mov    $0x1,%eax
  801aad:	eb 05                	jmp    801ab4 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801ab6 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801ac6:	6a 2c                	push   $0x2c
  801ac8:	e8 1b fa ff ff       	call   8014e8 <syscall>
  801acd:	83 c4 18             	add    $0x18,%esp
  801ad0:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801ad3:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801ad7:	75 07                	jne    801ae0 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801ad9:	b8 01 00 00 00       	mov    $0x1,%eax
  801ade:	eb 05                	jmp    801ae5 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801ae7 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801af7:	e8 ec f9 ff ff       	call   8014e8 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801b16:	52                   	push   %edx
  801b17:	50                   	push   %eax
  801b18:	6a 2e                	push   $0x2e
  801b1a:	e8 c9 f9 ff ff       	call   8014e8 <syscall>
...
00801b27 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801b36:	52                   	push   %edx
  801b37:	50                   	push   %eax
  801b38:	6a 2f                	push   $0x2f
  801b3a:	e8 a9 f9 ff ff       	call   8014e8 <syscall>
