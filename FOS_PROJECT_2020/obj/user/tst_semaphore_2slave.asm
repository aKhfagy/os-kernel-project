...
_main(void)
{
  ...
  80007c:	e8 3e 16 00 00       	call   8016bf <env_sleep>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801434:	50                   	push   %eax
  801435:	6a 21                	push   $0x21
  801437:	e8 27 fc ff ff       	call   801063 <syscall>
  80143c:	83 c4 18             	add    $0x18,%esp
}
  80143f:	c9                   	leave  
  801440:	c3                   	ret    

00801441 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  80144f:	50                   	push   %eax
  801450:	6a 22                	push   $0x22
  801452:	e8 0c fc ff ff       	call   801063 <syscall>
...
sys_get_virtual_time()
{
  ...
  80147f:	8d 45 f8             	lea    -0x8(%ebp),%eax
  801482:	8d 50 04             	lea    0x4(%eax),%edx
  801485:	8d 45 f8             	lea    -0x8(%ebp),%eax
  ...
  801492:	e8 cc fb ff ff       	call   801063 <syscall>
  801497:	83 c4 18             	add    $0x18,%esp
	return result;
  80149a:	8b 4d 08             	mov    0x8(%ebp),%ecx
  80149d:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8014a0:	8b 55 fc             	mov    -0x4(%ebp),%edx
  8014a3:	89 01                	mov    %eax,(%ecx)
  8014a5:	89 51 04             	mov    %edx,0x4(%ecx)
}
  8014a8:	8b 45 08             	mov    0x8(%ebp),%eax
  8014ab:	c9                   	leave  
  8014ac:	c2 04 00             	ret    $0x4

008014af <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8014bf:	6a 13                	push   $0x13
  8014c1:	e8 9d fb ff ff       	call   801063 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8014db:	e8 83 fb ff ff       	call   801063 <syscall>
  8014e0:	83 c4 18             	add    $0x18,%esp
}
  8014e3:	c9                   	leave  
  8014e4:	c3                   	ret    

008014e5 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  8014f1:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  8014f5:	6a 00                	push   $0x0
  8014f7:	6a 00                	push   $0x0
  8014f9:	6a 00                	push   $0x0
  8014fb:	6a 00                	push   $0x0
  8014fd:	50                   	push   %eax
  8014fe:	6a 26                	push   $0x26
  801500:	e8 5e fb ff ff       	call   801063 <syscall>
...
void rsttst()
{
  ...
  80151a:	e8 44 fb ff ff       	call   801063 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801531:	8b 55 18             	mov    0x18(%ebp),%edx
  801534:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  801538:	52                   	push   %edx
  801539:	50                   	push   %eax
  80153a:	ff 75 10             	pushl  0x10(%ebp)
  80153d:	ff 75 0c             	pushl  0xc(%ebp)
  801540:	ff 75 08             	pushl  0x8(%ebp)
  801543:	6a 27                	push   $0x27
  801545:	e8 19 fb ff ff       	call   801063 <syscall>
...
void chktst(uint32 n)
{
  ...
  80155e:	6a 29                	push   $0x29
  801560:	e8 fe fa ff ff       	call   801063 <syscall>
...
void inctst()
{
  ...
  80157a:	e8 e4 fa ff ff       	call   801063 <syscall>
...
uint32 gettst()
{
  ...
  801592:	6a 2b                	push   $0x2b
  801594:	e8 ca fa ff ff       	call   801063 <syscall>
  801599:	83 c4 18             	add    $0x18,%esp
}
  80159c:	c9                   	leave  
  80159d:	c3                   	ret    

0080159e <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8015b0:	e8 ae fa ff ff       	call   801063 <syscall>
  8015b5:	83 c4 18             	add    $0x18,%esp
  8015b8:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8015bb:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8015bf:	75 07                	jne    8015c8 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8015c1:	b8 01 00 00 00       	mov    $0x1,%eax
  8015c6:	eb 05                	jmp    8015cd <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
008015cf <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  8015e1:	e8 7d fa ff ff       	call   801063 <syscall>
  8015e6:	83 c4 18             	add    $0x18,%esp
  8015e9:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  8015ec:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  8015f0:	75 07                	jne    8015f9 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  8015f2:	b8 01 00 00 00       	mov    $0x1,%eax
  8015f7:	eb 05                	jmp    8015fe <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801600 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801612:	e8 4c fa ff ff       	call   801063 <syscall>
  801617:	83 c4 18             	add    $0x18,%esp
  80161a:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  80161d:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801621:	75 07                	jne    80162a <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801623:	b8 01 00 00 00       	mov    $0x1,%eax
  801628:	eb 05                	jmp    80162f <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801631 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801643:	e8 1b fa ff ff       	call   801063 <syscall>
  801648:	83 c4 18             	add    $0x18,%esp
  80164b:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  80164e:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801652:	75 07                	jne    80165b <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801654:	b8 01 00 00 00       	mov    $0x1,%eax
  801659:	eb 05                	jmp    801660 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801662 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801670:	6a 2d                	push   $0x2d
  801672:	e8 ec f9 ff ff       	call   801063 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801695:	e8 c9 f9 ff ff       	call   801063 <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8016b1:	52                   	push   %edx
  8016b2:	50                   	push   %eax
  8016b3:	6a 2f                	push   $0x2f
  8016b5:	e8 a9 f9 ff ff       	call   801063 <syscall>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  8016fd:	50                   	push   %eax
  8016fe:	e8 76 fd ff ff       	call   801479 <sys_get_virtual_time>
  ...
  80170e:	50                   	push   %eax
  80170f:	e8 65 fd ff ff       	call   801479 <sys_get_virtual_time>
