...
//	cprintf("envID = %d\n",envID);
  ...
  800086:	50                   	push   %eax
  800087:	e8 b8 19 00 00       	call   801a44 <sys_check_LRU_lists>
  ...
  80013a:	50                   	push   %eax
  80013b:	e8 04 19 00 00       	call   801a44 <sys_check_LRU_lists>
  ...
  8001f4:	50                   	push   %eax
  8001f5:	e8 4a 18 00 00       	call   801a44 <sys_check_LRU_lists>
  ...
  80027a:	50                   	push   %eax
  80027b:	e8 c4 17 00 00       	call   801a44 <sys_check_LRU_lists>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8017fe:	e8 27 fc ff ff       	call   80142a <syscall>
  801803:	83 c4 18             	add    $0x18,%esp
}
  801806:	c9                   	leave  
  801807:	c3                   	ret    

00801808 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  801816:	50                   	push   %eax
  801817:	6a 22                	push   $0x22
  801819:	e8 0c fc ff ff       	call   80142a <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801835:	e8 f0 fb ff ff       	call   80142a <syscall>
...
sys_get_virtual_time()
{
  ...
  801849:	8d 50 04             	lea    0x4(%eax),%edx
  ...
  801859:	e8 cc fb ff ff       	call   80142a <syscall>
  80185e:	83 c4 18             	add    $0x18,%esp
	return result;
  801861:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801864:	8b 45 f8             	mov    -0x8(%ebp),%eax
  801867:	8b 55 fc             	mov    -0x4(%ebp),%edx
  80186a:	89 01                	mov    %eax,(%ecx)
  80186c:	89 51 04             	mov    %edx,0x4(%ecx)
}
  80186f:	8b 45 08             	mov    0x8(%ebp),%eax
  801872:	c9                   	leave  
  801873:	c2 04 00             	ret    $0x4

00801876 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801886:	6a 13                	push   $0x13
  801888:	e8 9d fb ff ff       	call   80142a <syscall>
...
uint32 sys_rcr2()
{
  ...
  8018a0:	6a 25                	push   $0x25
  8018a2:	e8 83 fb ff ff       	call   80142a <syscall>
  8018a7:	83 c4 18             	add    $0x18,%esp
}
  8018aa:	c9                   	leave  
  8018ab:	c3                   	ret    

008018ac <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  8018b8:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  ...
  8018c7:	e8 5e fb ff ff       	call   80142a <syscall>
...
void rsttst()
{
  ...
  8018e1:	e8 44 fb ff ff       	call   80142a <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8018f5:	88 45 fc             	mov    %al,-0x4(%ebp)
	syscall(SYS_testNum, n, v1, v2, c, inv);
  8018f8:	8b 55 18             	mov    0x18(%ebp),%edx
  ...
  80190c:	e8 19 fb ff ff       	call   80142a <syscall>
...
void chktst(uint32 n)
{
  ...
  801925:	6a 29                	push   $0x29
  801927:	e8 fe fa ff ff       	call   80142a <syscall>
...
void inctst()
{
  ...
  80193f:	6a 2a                	push   $0x2a
  801941:	e8 e4 fa ff ff       	call   80142a <syscall>
...
uint32 gettst()
{
  ...
  801959:	6a 2b                	push   $0x2b
  80195b:	e8 ca fa ff ff       	call   80142a <syscall>
  801960:	83 c4 18             	add    $0x18,%esp
}
  801963:	c9                   	leave  
  801964:	c3                   	ret    

00801965 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801977:	e8 ae fa ff ff       	call   80142a <syscall>
  80197c:	83 c4 18             	add    $0x18,%esp
  80197f:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801982:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801986:	75 07                	jne    80198f <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801988:	b8 01 00 00 00       	mov    $0x1,%eax
  80198d:	eb 05                	jmp    801994 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801996 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  8019a6:	6a 2c                	push   $0x2c
  8019a8:	e8 7d fa ff ff       	call   80142a <syscall>
  8019ad:	83 c4 18             	add    $0x18,%esp
  8019b0:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  8019b3:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  8019b7:	75 07                	jne    8019c0 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  8019b9:	b8 01 00 00 00       	mov    $0x1,%eax
  8019be:	eb 05                	jmp    8019c5 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
008019c7 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  8019d7:	6a 2c                	push   $0x2c
  8019d9:	e8 4c fa ff ff       	call   80142a <syscall>
  8019de:	83 c4 18             	add    $0x18,%esp
  8019e1:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  8019e4:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  8019e8:	75 07                	jne    8019f1 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  8019ea:	b8 01 00 00 00       	mov    $0x1,%eax
  8019ef:	eb 05                	jmp    8019f6 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
008019f8 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801a08:	6a 2c                	push   $0x2c
  801a0a:	e8 1b fa ff ff       	call   80142a <syscall>
  801a0f:	83 c4 18             	add    $0x18,%esp
  801a12:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801a15:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801a19:	75 07                	jne    801a22 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801a1b:	b8 01 00 00 00       	mov    $0x1,%eax
  801a20:	eb 05                	jmp    801a27 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801a39:	e8 ec f9 ff ff       	call   80142a <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801a48:	8b 5d 14             	mov    0x14(%ebp),%ebx
  ...
  801a5c:	e8 c9 f9 ff ff       	call   80142a <syscall>
...
00801a69 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801a78:	52                   	push   %edx
  801a79:	50                   	push   %eax
  801a7a:	6a 2f                	push   $0x2f
  801a7c:	e8 a9 f9 ff ff       	call   80142a <syscall>
