	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800381:	e8 ea 15 00 00       	call   801970 <__udivdi3>
  ...
  8003cf:	52                   	push   %edx
  8003d0:	50                   	push   %eax
  8003d1:	e8 aa 16 00 00       	call   801a80 <__umoddi3>
...
void readline(const char *prompt, char* buf)
{
  ...
  800991:	e8 d0 0f 00 00       	call   801966 <iscons>
  800996:	83 c4 10             	add    $0x10,%esp
  800999:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  80099c:	e8 77 0f 00 00       	call   801918 <getchar>
  ...
  8009e7:	e8 e4 0e 00 00       	call   8018d0 <cputchar>
  ...
  800a1e:	e8 ad 0e 00 00       	call   8018d0 <cputchar>
  ...
  800a47:	e8 84 0e 00 00       	call   8018d0 <cputchar>
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  800a94:	e8 cd 0e 00 00       	call   801966 <iscons>
  800a99:	83 c4 10             	add    $0x10,%esp
  800a9c:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  800a9f:	e8 74 0e 00 00       	call   801918 <getchar>
  ...
  800aeb:	e8 e0 0d 00 00       	call   8018d0 <cputchar>
  ...
  800b22:	e8 a9 0d 00 00       	call   8018d0 <cputchar>
  ...
  800b4b:	e8 80 0d 00 00       	call   8018d0 <cputchar>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801645:	50                   	push   %eax
  801646:	6a 21                	push   $0x21
  801648:	e8 27 fc ff ff       	call   801274 <syscall>
...
sys_run_env(int32 envId)
{
  ...
  801660:	50                   	push   %eax
  801661:	6a 22                	push   $0x22
  801663:	e8 0c fc ff ff       	call   801274 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  80167f:	e8 f0 fb ff ff       	call   801274 <syscall>
...
sys_get_virtual_time()
{
  ...
  80169f:	52                   	push   %edx
  8016a0:	50                   	push   %eax
  8016a1:	6a 24                	push   $0x24
  8016a3:	e8 cc fb ff ff       	call   801274 <syscall>
  ...
  8016b6:	89 51 04             	mov    %edx,0x4(%ecx)
}
  8016b9:	8b 45 08             	mov    0x8(%ebp),%eax
  8016bc:	c9                   	leave  
  8016bd:	c2 04 00             	ret    $0x4

008016c0 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8016d0:	6a 13                	push   $0x13
  8016d2:	e8 9d fb ff ff       	call   801274 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8016ec:	e8 83 fb ff ff       	call   801274 <syscall>
  8016f1:	83 c4 18             	add    $0x18,%esp
}
  8016f4:	c9                   	leave  
  8016f5:	c3                   	ret    

008016f6 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801702:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  801706:	6a 00                	push   $0x0
  801708:	6a 00                	push   $0x0
  80170a:	6a 00                	push   $0x0
  80170c:	6a 00                	push   $0x0
  80170e:	50                   	push   %eax
  80170f:	6a 26                	push   $0x26
  801711:	e8 5e fb ff ff       	call   801274 <syscall>
...
void rsttst()
{
  ...
  801729:	6a 28                	push   $0x28
  80172b:	e8 44 fb ff ff       	call   801274 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801742:	8b 55 18             	mov    0x18(%ebp),%edx
  801745:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  801749:	52                   	push   %edx
  80174a:	50                   	push   %eax
  ...
  801756:	e8 19 fb ff ff       	call   801274 <syscall>
...
void chktst(uint32 n)
{
  ...
  801771:	e8 fe fa ff ff       	call   801274 <syscall>
...
void inctst()
{
  ...
  80178b:	e8 e4 fa ff ff       	call   801274 <syscall>
...
uint32 gettst()
{
  ...
  8017a3:	6a 2b                	push   $0x2b
  8017a5:	e8 ca fa ff ff       	call   801274 <syscall>
  8017aa:	83 c4 18             	add    $0x18,%esp
}
  8017ad:	c9                   	leave  
  8017ae:	c3                   	ret    

008017af <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8017bf:	6a 2c                	push   $0x2c
  8017c1:	e8 ae fa ff ff       	call   801274 <syscall>
  8017c6:	83 c4 18             	add    $0x18,%esp
  8017c9:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8017cc:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8017d0:	75 07                	jne    8017d9 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8017d2:	b8 01 00 00 00       	mov    $0x1,%eax
  8017d7:	eb 05                	jmp    8017de <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
008017e0 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  8017f0:	6a 2c                	push   $0x2c
  8017f2:	e8 7d fa ff ff       	call   801274 <syscall>
  8017f7:	83 c4 18             	add    $0x18,%esp
  8017fa:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  8017fd:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801801:	75 07                	jne    80180a <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801803:	b8 01 00 00 00       	mov    $0x1,%eax
  801808:	eb 05                	jmp    80180f <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801811 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801821:	6a 2c                	push   $0x2c
  801823:	e8 4c fa ff ff       	call   801274 <syscall>
  801828:	83 c4 18             	add    $0x18,%esp
  80182b:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  80182e:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801832:	75 07                	jne    80183b <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801834:	b8 01 00 00 00       	mov    $0x1,%eax
  801839:	eb 05                	jmp    801840 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801842 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801854:	e8 1b fa ff ff       	call   801274 <syscall>
  801859:	83 c4 18             	add    $0x18,%esp
  80185c:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  80185f:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801863:	75 07                	jne    80186c <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801865:	b8 01 00 00 00       	mov    $0x1,%eax
  80186a:	eb 05                	jmp    801871 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801873 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801883:	e8 ec f9 ff ff       	call   801274 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8018a2:	52                   	push   %edx
  8018a3:	50                   	push   %eax
  8018a4:	6a 2e                	push   $0x2e
  8018a6:	e8 c9 f9 ff ff       	call   801274 <syscall>
...
008018b3 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8018c2:	52                   	push   %edx
  8018c3:	50                   	push   %eax
  8018c4:	6a 2f                	push   $0x2f
  8018c6:	e8 a9 f9 ff ff       	call   801274 <syscall>
...
cputchar(int ch)
{
  ...
  8018e3:	50                   	push   %eax
  8018e4:	e8 fb fb ff ff       	call   8014e4 <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  8018f2:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8018f5:	e8 b6 fb ff ff       	call   8014b0 <sys_disable_interrupt>
	char c = ch;
  ...
  801907:	50                   	push   %eax
  801908:	e8 d7 fb ff ff       	call   8014e4 <sys_cputc>
  80190d:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  801910:	e8 b5 fb ff ff       	call   8014ca <sys_enable_interrupt>
}
  801915:	90                   	nop
  801916:	c9                   	leave  
  801917:	c3                   	ret    
...
getchar(void)
{
  ...
  801925:	eb 08                	jmp    80192f <getchar+0x17>
	{
		c = sys_cgetc();
  801927:	e8 9c f9 ff ff       	call   8012c8 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  80193d:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  801940:	e8 6b fb ff ff       	call   8014b0 <sys_disable_interrupt>
	int c=0;
  ...
  80194c:	eb 08                	jmp    801956 <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  80194e:	e8 75 f9 ff ff       	call   8012c8 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  80195a:	74 f2                	je     80194e <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  80195c:	e8 69 fb ff ff       	call   8014ca <sys_enable_interrupt>
	return c;
