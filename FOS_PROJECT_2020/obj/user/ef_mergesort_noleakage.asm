...
void _main(void)
{
  ...
  800041:	e8 c6 1b 00 00       	call   801c0c <sys_disable_interrupt>
  ...
  8000b3:	68 ef 22 80 00       	push   $0x8022ef
  ...
  800118:	68 43 23 80 00       	push   $0x802343
  ...
  800158:	e8 c9 1a 00 00       	call   801c26 <sys_enable_interrupt>
  ...
  8001ca:	83 c4 10             	add    $0x10,%esp
		...
		sys_disable_interrupt();
  8001cd:	e8 3a 1a 00 00       	call   801c0c <sys_disable_interrupt>
		cprintf("Sorting is Finished!!!!it'll be checked now....\n") ;
  8001d2:	83 ec 0c             	sub    $0xc,%esp
  8001d5:	68 4c 23 80 00       	push   $0x80234c
  8001da:	e8 bf 09 00 00       	call   800b9e <cprintf>
  8001df:	83 c4 10             	add    $0x10,%esp
		//PrintElements(Elements, NumOfElements);
		sys_enable_interrupt();
  8001e2:	e8 3f 1a 00 00       	call   801c26 <sys_enable_interrupt>
  ...
  800204:	68 80 23 80 00       	push   $0x802380
  800209:	6a 4e                	push   $0x4e
  80020b:	68 a2 23 80 00       	push   $0x8023a2
  800210:	e8 e7 06 00 00       	call   8008fc <_panic>
		else
		{
			sys_disable_interrupt();
  800215:	e8 f2 19 00 00       	call   801c0c <sys_disable_interrupt>
			cprintf("===============================================\n") ;
  80021a:	83 ec 0c             	sub    $0xc,%esp
  80021d:	68 c0 23 80 00       	push   $0x8023c0
  800222:	e8 77 09 00 00       	call   800b9e <cprintf>
  800227:	83 c4 10             	add    $0x10,%esp
			cprintf("Congratulations!! The array is sorted correctly\n") ;
  80022a:	83 ec 0c             	sub    $0xc,%esp
  80022d:	68 f4 23 80 00       	push   $0x8023f4
  800232:	e8 67 09 00 00       	call   800b9e <cprintf>
  800237:	83 c4 10             	add    $0x10,%esp
			cprintf("===============================================\n\n") ;
  80023a:	83 ec 0c             	sub    $0xc,%esp
  80023d:	68 28 24 80 00       	push   $0x802428
  800242:	e8 57 09 00 00       	call   800b9e <cprintf>
  800247:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  80024a:	e8 d7 19 00 00       	call   801c26 <sys_enable_interrupt>
		}

		free(Elements) ;
  80024f:	83 ec 0c             	sub    $0xc,%esp
  800252:	ff 75 ec             	pushl  -0x14(%ebp)
  800255:	e8 22 17 00 00       	call   80197c <free>
  80025a:	83 c4 10             	add    $0x10,%esp

		sys_disable_interrupt();
  80025d:	e8 aa 19 00 00       	call   801c0c <sys_disable_interrupt>
			Chose = 0 ;
  ...
  80026b:	68 5a 24 80 00       	push   $0x80245a
  ...
  8002b0:	75 b6                	jne    800268 <_main+0x230>
		...
		sys_enable_interrupt();
  8002b2:	e8 6f 19 00 00       	call   801c26 <sys_enable_interrupt>
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800446:	68 a0 22 80 00       	push   $0x8022a0
  ...
  800467:	50                   	push   %eax
  800468:	68 78 24 80 00       	push   $0x802478
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800495:	50                   	push   %eax
  800496:	68 ef 22 80 00       	push   $0x8022ef
...
void Merge(int* A, int p, int q, int r)
{
  ...
  8006fe:	e8 79 12 00 00       	call   80197c <free>
  800703:	83 c4 10             	add    $0x10,%esp
	free(Right);
  800706:	83 ec 0c             	sub    $0xc,%esp
  800709:	ff 75 d4             	pushl  -0x2c(%ebp)
  80070c:	e8 6b 12 00 00       	call   80197c <free>
...
cputchar(int ch)
{
  ...
  80072a:	50                   	push   %eax
  80072b:	e8 10 15 00 00       	call   801c40 <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  800739:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80073c:	e8 cb 14 00 00       	call   801c0c <sys_disable_interrupt>
	char c = ch;
  ...
  80074e:	50                   	push   %eax
  80074f:	e8 ec 14 00 00       	call   801c40 <sys_cputc>
  800754:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800757:	e8 ca 14 00 00       	call   801c26 <sys_enable_interrupt>
}
  80075c:	90                   	nop
  80075d:	c9                   	leave  
  80075e:	c3                   	ret    
...
getchar(void)
{
  ...
  80076c:	eb 08                	jmp    800776 <getchar+0x17>
	{
		c = sys_cgetc();
  80076e:	e8 b1 12 00 00       	call   801a24 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800784:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800787:	e8 80 14 00 00       	call   801c0c <sys_disable_interrupt>
	int c=0;
  ...
  800793:	eb 08                	jmp    80079d <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  800795:	e8 8a 12 00 00       	call   801a24 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  8007a1:	74 f2                	je     800795 <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  8007a3:	e8 7e 14 00 00       	call   801c26 <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  8007bd:	e8 af 12 00 00       	call   801a71 <sys_getenvindex>
  ...
  800837:	83 c4 10             	add    $0x10,%esp
	...
	sys_disable_interrupt();
  80083a:	e8 cd 13 00 00       	call   801c0c <sys_disable_interrupt>
	cprintf("**************************************\n");
  80083f:	83 ec 0c             	sub    $0xc,%esp
  800842:	68 98 24 80 00       	push   $0x802498
  ...
  800868:	52                   	push   %edx
  800869:	50                   	push   %eax
  80086a:	68 c0 24 80 00       	push   $0x8024c0
  ...
  800890:	52                   	push   %edx
  800891:	50                   	push   %eax
  800892:	68 e8 24 80 00       	push   $0x8024e8
  ...
  8008ad:	50                   	push   %eax
  8008ae:	68 29 25 80 00       	push   $0x802529
  8008b3:	e8 e6 02 00 00       	call   800b9e <cprintf>
  8008b8:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  8008bb:	83 ec 0c             	sub    $0xc,%esp
  8008be:	68 98 24 80 00       	push   $0x802498
  8008c3:	e8 d6 02 00 00       	call   800b9e <cprintf>
  8008c8:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8008cb:	e8 56 13 00 00       	call   801c26 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8008e3:	e8 55 11 00 00       	call   801a3d <sys_env_destroy>
...
exit(void)
{
  ...
  8008f1:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  8008f4:	e8 aa 11 00 00       	call   801aa3 <sys_env_exit>
}
  8008f9:	90                   	nop
  8008fa:	c9                   	leave  
  8008fb:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80091c:	50                   	push   %eax
  80091d:	68 40 25 80 00       	push   $0x802540
  ...
  800935:	50                   	push   %eax
  800936:	68 45 25 80 00       	push   $0x802545
  ...
  80095a:	68 61 25 80 00       	push   $0x802561
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800986:	68 64 25 80 00       	push   $0x802564
  80098b:	6a 26                	push   $0x26
  80098d:	68 b0 25 80 00       	push   $0x8025b0
  ...
  800a4c:	68 bc 25 80 00       	push   $0x8025bc
  800a51:	6a 3a                	push   $0x3a
  800a53:	68 b0 25 80 00       	push   $0x8025b0
  ...
  800ab6:	68 10 26 80 00       	push   $0x802610
  800abb:	6a 44                	push   $0x44
  800abd:	68 b0 25 80 00       	push   $0x8025b0
...
static void putch(int ch, struct printbuf *b) {
  ...
  800b0e:	51                   	push   %ecx
  800b0f:	52                   	push   %edx
  800b10:	e8 e6 0e 00 00       	call   8019fb <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800b86:	50                   	push   %eax
  800b87:	e8 6f 0e 00 00       	call   8019fb <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800bce:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800bd1:	e8 36 10 00 00       	call   801c0c <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800bee:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800bf1:	e8 30 10 00 00       	call   801c26 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800c3b:	e8 ec 13 00 00       	call   80202c <__udivdi3>
  ...
  800c89:	52                   	push   %edx
  800c8a:	50                   	push   %eax
  800c8b:	e8 ac 14 00 00       	call   80213c <__umoddi3>
  800c90:	83 c4 10             	add    $0x10,%esp
  800c93:	05 74 28 80 00       	add    $0x802874,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800de6:	8b 04 85 98 28 80 00 	mov    0x802898(,%eax,4),%eax
  ...
  800ec7:	8b 34 9d e0 26 80 00 	mov    0x8026e0(,%ebx,4),%esi
  800ece:	85 f6                	test   %esi,%esi
  800ed0:	75 19                	jne    800eeb <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800ed2:	53                   	push   %ebx
  800ed3:	68 85 28 80 00       	push   $0x802885
  ...
  800ee6:	e9 49 02 00 00       	jmp    801134 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800eeb:	56                   	push   %esi
  800eec:	68 8e 28 80 00       	push   $0x80288e
  ...
  800f17:	75 05                	jne    800f1e <vprintfmt+0x1a6>
				p = "(null)";
  800f19:	be 91 28 80 00       	mov    $0x802891,%esi
			if (width > 0 && padc != '-')
...
void* malloc(uint32 size)
{
  ...
  801931:	68 f0 29 80 00       	push   $0x8029f0
  801936:	6a 19                	push   $0x19
  801938:	68 15 2a 80 00       	push   $0x802a15
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80194b:	88 45 f4             	mov    %al,-0xc(%ebp)
	//TODO: [PROJECT 2020  - Shared Variables: Creation] smalloc() [User Side]
	// Write your code here, remove the panic and write your code
	panic("smalloc() is not implemented yet...!!");
  80194e:	83 ec 04             	sub    $0x4,%esp
  801951:	68 24 2a 80 00       	push   $0x802a24
  801956:	6a 31                	push   $0x31
  801958:	68 15 2a 80 00       	push   $0x802a15
  80195d:	e8 9a ef ff ff       	call   8008fc <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  80196b:	68 4c 2a 80 00       	push   $0x802a4c
  801970:	6a 4a                	push   $0x4a
  801972:	68 15 2a 80 00       	push   $0x802a15
...
void free(void* virtual_address)
{
  ...
  801985:	68 70 2a 80 00       	push   $0x802a70
  80198a:	6a 70                	push   $0x70
  80198c:	68 15 2a 80 00       	push   $0x802a15
...
void sfree(void* virtual_address)
{
  ...
  80199f:	68 94 2a 80 00       	push   $0x802a94
  8019a4:	68 8b 00 00 00       	push   $0x8b
  8019a9:	68 15 2a 80 00       	push   $0x802a15
  8019ae:	e8 49 ef ff ff       	call   8008fc <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8019bc:	68 b8 2a 80 00       	push   $0x802ab8
  8019c1:	68 a8 00 00 00       	push   $0xa8
  8019c6:	68 15 2a 80 00       	push   $0x802a15
  8019cb:	e8 2c ef ff ff       	call   8008fc <_panic>
...
int sys_env_destroy(int32  envid)
{
  ...
  801a4b:	50                   	push   %eax
  801a4c:	6a 05                	push   $0x5
  801a4e:	e8 7d ff ff ff       	call   8019d0 <syscall>
...
int32 sys_getenvid(void)
{
  ...
  801a67:	e8 64 ff ff ff       	call   8019d0 <syscall>
...
int32 sys_getenvindex(void)
{
  ...
  801a80:	e8 4b ff ff ff       	call   8019d0 <syscall>
...
int32 sys_getparentenvid(void)
{
  ...
  801a99:	e8 32 ff ff ff       	call   8019d0 <syscall>
  801a9e:	83 c4 18             	add    $0x18,%esp
}
  801aa1:	c9                   	leave  
  801aa2:	c3                   	ret    

00801aa3 <sys_env_exit>:
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801ad0:	e8 fb fe ff ff       	call   8019d0 <syscall>
  801ad5:	83 c4 18             	add    $0x18,%esp
}
  801ad8:	c9                   	leave  
  801ad9:	c3                   	ret    

00801ada <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801adf:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  801af1:	52                   	push   %edx
  801af2:	50                   	push   %eax
  801af3:	6a 08                	push   $0x8
  801af5:	e8 d6 fe ff ff       	call   8019d0 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  801b13:	52                   	push   %edx
  801b14:	50                   	push   %eax
  801b15:	6a 09                	push   $0x9
  801b17:	e8 b4 fe ff ff       	call   8019d0 <syscall>
  801b1c:	83 c4 18             	add    $0x18,%esp
}
  801b1f:	c9                   	leave  
  801b20:	c3                   	ret    

00801b21 <sys_calculate_required_frames>:
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  801b30:	6a 0a                	push   $0xa
  801b32:	e8 99 fe ff ff       	call   8019d0 <syscall>
  801b37:	83 c4 18             	add    $0x18,%esp
}
  801b3a:	c9                   	leave  
  801b3b:	c3                   	ret    

00801b3c <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  801b49:	6a 0b                	push   $0xb
  801b4b:	e8 80 fe ff ff       	call   8019d0 <syscall>
  801b50:	83 c4 18             	add    $0x18,%esp
}
  801b53:	c9                   	leave  
  801b54:	c3                   	ret    

00801b55 <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  801b64:	e8 67 fe ff ff       	call   8019d0 <syscall>
  801b69:	83 c4 18             	add    $0x18,%esp
}
  801b6c:	c9                   	leave  
  801b6d:	c3                   	ret    

00801b6e <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  801b7b:	6a 0d                	push   $0xd
  801b7d:	e8 4e fe ff ff       	call   8019d0 <syscall>
  801b82:	83 c4 18             	add    $0x18,%esp
}
  801b85:	c9                   	leave  
  801b86:	c3                   	ret    

00801b87 <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  801b96:	6a 11                	push   $0x11
  801b98:	e8 33 fe ff ff       	call   8019d0 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  801bb2:	6a 12                	push   $0x12
  801bb4:	e8 17 fe ff ff       	call   8019d0 <syscall>
...
00801bbf <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  801bce:	e8 fd fd ff ff       	call   8019d0 <syscall>
  801bd3:	83 c4 18             	add    $0x18,%esp
}
  801bd6:	c9                   	leave  
  801bd7:	c3                   	ret    

00801bd8 <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801be6:	6a 0f                	push   $0xf
  801be8:	e8 e3 fd ff ff       	call   8019d0 <syscall>
  801bed:	83 c4 18             	add    $0x18,%esp
}
  801bf0:	c9                   	leave  
  801bf1:	c3                   	ret    

00801bf2 <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  801c01:	e8 ca fd ff ff       	call   8019d0 <syscall>
...
00801c0c <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  801c1b:	e8 b0 fd ff ff       	call   8019d0 <syscall>
...
sys_enable_interrupt()
{
  ...
  801c35:	e8 96 fd ff ff       	call   8019d0 <syscall>
...
sys_cputc(const char c)
{
  ...
  801c5b:	e8 70 fd ff ff       	call   8019d0 <syscall>
...
sys_clear_ffl()
{
  ...
  801c73:	6a 17                	push   $0x17
  801c75:	e8 56 fd ff ff       	call   8019d0 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  801c92:	e8 39 fd ff ff       	call   8019d0 <syscall>
  801c97:	83 c4 18             	add    $0x18,%esp
}
  801c9a:	c9                   	leave  
  801c9b:	c3                   	ret    

00801c9c <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801cab:	52                   	push   %edx
  801cac:	50                   	push   %eax
  801cad:	6a 1b                	push   $0x1b
  801caf:	e8 1c fd ff ff       	call   8019d0 <syscall>
  801cb4:	83 c4 18             	add    $0x18,%esp
}
  801cb7:	c9                   	leave  
  801cb8:	c3                   	ret    

00801cb9 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801cc8:	52                   	push   %edx
  801cc9:	50                   	push   %eax
  801cca:	6a 19                	push   $0x19
  801ccc:	e8 ff fc ff ff       	call   8019d0 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801cea:	e8 e1 fc ff ff       	call   8019d0 <syscall>
...
00801cf5 <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  801d12:	50                   	push   %eax
  801d13:	6a 1c                	push   $0x1c
  801d15:	e8 b6 fc ff ff       	call   8019d0 <syscall>
  801d1a:	83 c4 18             	add    $0x18,%esp
}
  801d1d:	c9                   	leave  
  801d1e:	c3                   	ret    

00801d1f <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  801d32:	e8 99 fc ff ff       	call   8019d0 <syscall>
  801d37:	83 c4 18             	add    $0x18,%esp
}
  801d3a:	c9                   	leave  
  801d3b:	c3                   	ret    

00801d3c <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  801d4d:	52                   	push   %edx
  801d4e:	50                   	push   %eax
  801d4f:	6a 1e                	push   $0x1e
  801d51:	e8 7a fc ff ff       	call   8019d0 <syscall>
  801d56:	83 c4 18             	add    $0x18,%esp
}
  801d59:	c9                   	leave  
  801d5a:	c3                   	ret    

00801d5b <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  801d6e:	e8 5d fc ff ff       	call   8019d0 <syscall>
  801d73:	83 c4 18             	add    $0x18,%esp
}
  801d76:	c9                   	leave  
  801d77:	c3                   	ret    

00801d78 <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  801d85:	6a 20                	push   $0x20
  801d87:	e8 44 fc ff ff       	call   8019d0 <syscall>
  801d8c:	83 c4 18             	add    $0x18,%esp
}
  801d8f:	c9                   	leave  
  801d90:	c3                   	ret    

00801d91 <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801da1:	50                   	push   %eax
  801da2:	6a 21                	push   $0x21
  801da4:	e8 27 fc ff ff       	call   8019d0 <syscall>
  801da9:	83 c4 18             	add    $0x18,%esp
}
  801dac:	c9                   	leave  
  801dad:	c3                   	ret    

00801dae <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  801dbc:	50                   	push   %eax
  801dbd:	6a 22                	push   $0x22
  801dbf:	e8 0c fc ff ff       	call   8019d0 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801ddb:	e8 f0 fb ff ff       	call   8019d0 <syscall>
...
sys_get_virtual_time()
{
  ...
  801dff:	e8 cc fb ff ff       	call   8019d0 <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801e2e:	e8 9d fb ff ff       	call   8019d0 <syscall>
...
uint32 sys_rcr2()
{
  ...
  801e48:	e8 83 fb ff ff       	call   8019d0 <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801e6a:	50                   	push   %eax
  801e6b:	6a 26                	push   $0x26
  801e6d:	e8 5e fb ff ff       	call   8019d0 <syscall>
...
void rsttst()
{
  ...
  801e87:	e8 44 fb ff ff       	call   8019d0 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801eb0:	6a 27                	push   $0x27
  801eb2:	e8 19 fb ff ff       	call   8019d0 <syscall>
...
void chktst(uint32 n)
{
  ...
  801ecb:	6a 29                	push   $0x29
  801ecd:	e8 fe fa ff ff       	call   8019d0 <syscall>
...
void inctst()
{
  ...
  801ee5:	6a 2a                	push   $0x2a
  801ee7:	e8 e4 fa ff ff       	call   8019d0 <syscall>
...
uint32 gettst()
{
  ...
  801eff:	6a 2b                	push   $0x2b
  801f01:	e8 ca fa ff ff       	call   8019d0 <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801f1b:	6a 2c                	push   $0x2c
  801f1d:	e8 ae fa ff ff       	call   8019d0 <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801f4e:	e8 7d fa ff ff       	call   8019d0 <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801f7f:	e8 4c fa ff ff       	call   8019d0 <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801fb0:	e8 1b fa ff ff       	call   8019d0 <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801fdd:	6a 2d                	push   $0x2d
  801fdf:	e8 ec f9 ff ff       	call   8019d0 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801ffe:	52                   	push   %edx
  801fff:	50                   	push   %eax
  802000:	6a 2e                	push   $0x2e
  802002:	e8 c9 f9 ff ff       	call   8019d0 <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  80201e:	52                   	push   %edx
  80201f:	50                   	push   %eax
  802020:	6a 2f                	push   $0x2f
  802022:	e8 a9 f9 ff ff       	call   8019d0 <syscall>
