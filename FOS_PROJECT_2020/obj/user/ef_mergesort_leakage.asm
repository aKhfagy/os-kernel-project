...
void _main(void)
{
  ...
  8000d2:	68 0f 23 80 00       	push   $0x80230f
  ...
  800137:	68 63 23 80 00       	push   $0x802363
  ...
  800189:	e8 bf 1a 00 00       	call   801c4d <sys_enable_interrupt>
  ...
  8001fb:	83 c4 10             	add    $0x10,%esp
		...
		sys_disable_interrupt();
  8001fe:	e8 30 1a 00 00       	call   801c33 <sys_disable_interrupt>
		cprintf("Sorting is Finished!!!!it'll be checked now....\n") ;
  800203:	83 ec 0c             	sub    $0xc,%esp
  800206:	68 6c 23 80 00       	push   $0x80236c
  80020b:	e8 b5 09 00 00       	call   800bc5 <cprintf>
  800210:	83 c4 10             	add    $0x10,%esp
		//PrintElements(Elements, NumOfElements);
		sys_enable_interrupt();
  800213:	e8 35 1a 00 00       	call   801c4d <sys_enable_interrupt>
  ...
  800235:	68 a0 23 80 00       	push   $0x8023a0
  80023a:	6a 58                	push   $0x58
  80023c:	68 c2 23 80 00       	push   $0x8023c2
  800241:	e8 dd 06 00 00       	call   800923 <_panic>
		else
		{
			sys_disable_interrupt();
  800246:	e8 e8 19 00 00       	call   801c33 <sys_disable_interrupt>
			cprintf("===============================================\n") ;
  80024b:	83 ec 0c             	sub    $0xc,%esp
  80024e:	68 e0 23 80 00       	push   $0x8023e0
  800253:	e8 6d 09 00 00       	call   800bc5 <cprintf>
  800258:	83 c4 10             	add    $0x10,%esp
			cprintf("Congratulations!! The array is sorted correctly\n") ;
  80025b:	83 ec 0c             	sub    $0xc,%esp
  80025e:	68 14 24 80 00       	push   $0x802414
  800263:	e8 5d 09 00 00       	call   800bc5 <cprintf>
  800268:	83 c4 10             	add    $0x10,%esp
			cprintf("===============================================\n\n") ;
  80026b:	83 ec 0c             	sub    $0xc,%esp
  80026e:	68 48 24 80 00       	push   $0x802448
  800273:	e8 4d 09 00 00       	call   800bc5 <cprintf>
  800278:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  80027b:	e8 cd 19 00 00       	call   801c4d <sys_enable_interrupt>
		}

		free(Elements) ;
  800280:	83 ec 0c             	sub    $0xc,%esp
  800283:	ff 75 e8             	pushl  -0x18(%ebp)
  800286:	e8 18 17 00 00       	call   8019a3 <free>
  80028b:	83 c4 10             	add    $0x10,%esp

		sys_disable_interrupt();
  80028e:	e8 a0 19 00 00       	call   801c33 <sys_disable_interrupt>
		Chose = 0 ;
  ...
  80029c:	68 7a 24 80 00       	push   $0x80247a
  ...
  8002f3:	75 a4                	jne    800299 <_main+0x261>
		...
		sys_enable_interrupt();
  8002f5:	e8 53 19 00 00       	call   801c4d <sys_enable_interrupt>
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800489:	68 c0 22 80 00       	push   $0x8022c0
  ...
  8004aa:	50                   	push   %eax
  8004ab:	68 98 24 80 00       	push   $0x802498
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  8004d8:	50                   	push   %eax
  8004d9:	68 0f 23 80 00       	push   $0x80230f
...
cputchar(int ch)
{
  ...
  800751:	50                   	push   %eax
  800752:	e8 10 15 00 00       	call   801c67 <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  800760:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800763:	e8 cb 14 00 00       	call   801c33 <sys_disable_interrupt>
	char c = ch;
  ...
  800775:	50                   	push   %eax
  800776:	e8 ec 14 00 00       	call   801c67 <sys_cputc>
  80077b:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  80077e:	e8 ca 14 00 00       	call   801c4d <sys_enable_interrupt>
}
  800783:	90                   	nop
  800784:	c9                   	leave  
  800785:	c3                   	ret    
...
getchar(void)
{
  ...
  800793:	eb 08                	jmp    80079d <getchar+0x17>
	{
		c = sys_cgetc();
  800795:	e8 b1 12 00 00       	call   801a4b <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  8007ab:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8007ae:	e8 80 14 00 00       	call   801c33 <sys_disable_interrupt>
	int c=0;
  ...
  8007ba:	eb 08                	jmp    8007c4 <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  8007bc:	e8 8a 12 00 00       	call   801a4b <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  8007c8:	74 f2                	je     8007bc <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  8007ca:	e8 7e 14 00 00       	call   801c4d <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  8007e4:	e8 af 12 00 00       	call   801a98 <sys_getenvindex>
  ...
  80085e:	83 c4 10             	add    $0x10,%esp
	...
	sys_disable_interrupt();
  800861:	e8 cd 13 00 00       	call   801c33 <sys_disable_interrupt>
	cprintf("**************************************\n");
  800866:	83 ec 0c             	sub    $0xc,%esp
  800869:	68 b8 24 80 00       	push   $0x8024b8
  ...
  80088f:	52                   	push   %edx
  800890:	50                   	push   %eax
  800891:	68 e0 24 80 00       	push   $0x8024e0
  ...
  8008b7:	52                   	push   %edx
  8008b8:	50                   	push   %eax
  8008b9:	68 08 25 80 00       	push   $0x802508
...
destroy(void)
{
  ...
  80090a:	e8 55 11 00 00       	call   801a64 <sys_env_destroy>
...
exit(void)
{
  ...
  800918:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  80091b:	e8 aa 11 00 00       	call   801aca <sys_env_exit>
}
  800920:	90                   	nop
  800921:	c9                   	leave  
  800922:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800943:	50                   	push   %eax
  800944:	68 60 25 80 00       	push   $0x802560
  ...
  80095c:	50                   	push   %eax
  80095d:	68 65 25 80 00       	push   $0x802565
  ...
  800981:	68 81 25 80 00       	push   $0x802581
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8009ad:	68 84 25 80 00       	push   $0x802584
  8009b2:	6a 26                	push   $0x26
  8009b4:	68 d0 25 80 00       	push   $0x8025d0
  ...
  800a73:	68 dc 25 80 00       	push   $0x8025dc
  800a78:	6a 3a                	push   $0x3a
  800a7a:	68 d0 25 80 00       	push   $0x8025d0
  ...
  800add:	68 30 26 80 00       	push   $0x802630
  800ae2:	6a 44                	push   $0x44
  800ae4:	68 d0 25 80 00       	push   $0x8025d0
...
static void putch(int ch, struct printbuf *b) {
  ...
  800b35:	51                   	push   %ecx
  800b36:	52                   	push   %edx
  800b37:	e8 e6 0e 00 00       	call   801a22 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800bad:	50                   	push   %eax
  800bae:	e8 6f 0e 00 00       	call   801a22 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800bf5:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800bf8:	e8 36 10 00 00       	call   801c33 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800c15:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800c18:	e8 30 10 00 00       	call   801c4d <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800c62:	e8 ed 13 00 00       	call   802054 <__udivdi3>
  ...
  800cb0:	52                   	push   %edx
  800cb1:	50                   	push   %eax
  800cb2:	e8 ad 14 00 00       	call   802164 <__umoddi3>
  800cb7:	83 c4 10             	add    $0x10,%esp
  800cba:	05 94 28 80 00       	add    $0x802894,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800e0d:	8b 04 85 b8 28 80 00 	mov    0x8028b8(,%eax,4),%eax
  ...
  800eee:	8b 34 9d 00 27 80 00 	mov    0x802700(,%ebx,4),%esi
  800ef5:	85 f6                	test   %esi,%esi
  800ef7:	75 19                	jne    800f12 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800ef9:	53                   	push   %ebx
  800efa:	68 a5 28 80 00       	push   $0x8028a5
  ...
  800f0d:	e9 49 02 00 00       	jmp    80115b <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800f12:	56                   	push   %esi
  800f13:	68 ae 28 80 00       	push   $0x8028ae
  ...
  800f3e:	75 05                	jne    800f45 <vprintfmt+0x1a6>
				p = "(null)";
  800f40:	be b1 28 80 00       	mov    $0x8028b1,%esi
			if (width > 0 && padc != '-')
...
void* malloc(uint32 size)
{
  ...
  801958:	68 10 2a 80 00       	push   $0x802a10
  80195d:	6a 19                	push   $0x19
  80195f:	68 35 2a 80 00       	push   $0x802a35
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80197f:	68 35 2a 80 00       	push   $0x802a35
  801984:	e8 9a ef ff ff       	call   800923 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801992:	68 6c 2a 80 00       	push   $0x802a6c
  801997:	6a 4a                	push   $0x4a
  801999:	68 35 2a 80 00       	push   $0x802a35
...
void free(void* virtual_address)
{
  ...
  8019ac:	68 90 2a 80 00       	push   $0x802a90
  8019b1:	6a 70                	push   $0x70
  8019b3:	68 35 2a 80 00       	push   $0x802a35
...
void sfree(void* virtual_address)
{
  ...
  8019c6:	68 b4 2a 80 00       	push   $0x802ab4
  8019cb:	68 8b 00 00 00       	push   $0x8b
  8019d0:	68 35 2a 80 00       	push   $0x802a35
  8019d5:	e8 49 ef ff ff       	call   800923 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8019e3:	68 d8 2a 80 00       	push   $0x802ad8
  8019e8:	68 a8 00 00 00       	push   $0xa8
  8019ed:	68 35 2a 80 00       	push   $0x802a35
  8019f2:	e8 2c ef ff ff       	call   800923 <_panic>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  801a06:	8b 4d 10             	mov    0x10(%ebp),%ecx
  801a09:	8b 5d 14             	mov    0x14(%ebp),%ebx
  801a0c:	8b 7d 18             	mov    0x18(%ebp),%edi
  801a0f:	8b 75 1c             	mov    0x1c(%ebp),%esi
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  801a40:	e8 b2 ff ff ff       	call   8019f7 <syscall>
...
sys_cgetc(void)
{
  ...
  801a5a:	e8 98 ff ff ff       	call   8019f7 <syscall>
  801a5f:	83 c4 18             	add    $0x18,%esp
}
  801a62:	c9                   	leave  
  801a63:	c3                   	ret    

00801a64 <sys_env_destroy>:
...
int sys_env_destroy(int32  envid)
{
  ...
  801a75:	e8 7d ff ff ff       	call   8019f7 <syscall>
...
int32 sys_getenvid(void)
{
  ...
  801a8e:	e8 64 ff ff ff       	call   8019f7 <syscall>
...
int32 sys_getenvindex(void)
{
  ...
  801aa7:	e8 4b ff ff ff       	call   8019f7 <syscall>
...
int32 sys_getparentenvid(void)
{
  ...
  801ac0:	e8 32 ff ff ff       	call   8019f7 <syscall>
  801ac5:	83 c4 18             	add    $0x18,%esp
}
  801ac8:	c9                   	leave  
  801ac9:	c3                   	ret    

00801aca <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  801ad7:	6a 06                	push   $0x6
  801ad9:	e8 19 ff ff ff       	call   8019f7 <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801af3:	52                   	push   %edx
  801af4:	50                   	push   %eax
  801af5:	6a 07                	push   $0x7
  801af7:	e8 fb fe ff ff       	call   8019f7 <syscall>
  801afc:	83 c4 18             	add    $0x18,%esp
}
  801aff:	c9                   	leave  
  801b00:	c3                   	ret    

00801b01 <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801b06:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  801b1c:	e8 d6 fe ff ff       	call   8019f7 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  801b3e:	e8 b4 fe ff ff       	call   8019f7 <syscall>
  801b43:	83 c4 18             	add    $0x18,%esp
}
  801b46:	c9                   	leave  
  801b47:	c3                   	ret    

00801b48 <sys_calculate_required_frames>:
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  801b57:	6a 0a                	push   $0xa
  801b59:	e8 99 fe ff ff       	call   8019f7 <syscall>
  801b5e:	83 c4 18             	add    $0x18,%esp
}
  801b61:	c9                   	leave  
  801b62:	c3                   	ret    

00801b63 <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  801b70:	6a 0b                	push   $0xb
  801b72:	e8 80 fe ff ff       	call   8019f7 <syscall>
  801b77:	83 c4 18             	add    $0x18,%esp
}
  801b7a:	c9                   	leave  
  801b7b:	c3                   	ret    

00801b7c <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  801b89:	6a 0c                	push   $0xc
  801b8b:	e8 67 fe ff ff       	call   8019f7 <syscall>
  801b90:	83 c4 18             	add    $0x18,%esp
}
  801b93:	c9                   	leave  
  801b94:	c3                   	ret    

00801b95 <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  801ba4:	e8 4e fe ff ff       	call   8019f7 <syscall>
  801ba9:	83 c4 18             	add    $0x18,%esp
}
  801bac:	c9                   	leave  
  801bad:	c3                   	ret    

00801bae <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  801bbd:	6a 11                	push   $0x11
  801bbf:	e8 33 fe ff ff       	call   8019f7 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  801bdb:	e8 17 fe ff ff       	call   8019f7 <syscall>
...
00801be6 <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  801bf5:	e8 fd fd ff ff       	call   8019f7 <syscall>
  801bfa:	83 c4 18             	add    $0x18,%esp
}
  801bfd:	c9                   	leave  
  801bfe:	c3                   	ret    

00801bff <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801c0d:	6a 0f                	push   $0xf
  801c0f:	e8 e3 fd ff ff       	call   8019f7 <syscall>
  801c14:	83 c4 18             	add    $0x18,%esp
}
  801c17:	c9                   	leave  
  801c18:	c3                   	ret    

00801c19 <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  801c26:	6a 10                	push   $0x10
  801c28:	e8 ca fd ff ff       	call   8019f7 <syscall>
...
00801c33 <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  801c40:	6a 14                	push   $0x14
  801c42:	e8 b0 fd ff ff       	call   8019f7 <syscall>
...
sys_enable_interrupt()
{
  ...
  801c5a:	6a 15                	push   $0x15
  801c5c:	e8 96 fd ff ff       	call   8019f7 <syscall>
...
sys_cputc(const char c)
{
  ...
  801c7f:	50                   	push   %eax
  801c80:	6a 16                	push   $0x16
  801c82:	e8 70 fd ff ff       	call   8019f7 <syscall>
...
sys_clear_ffl()
{
  ...
  801c9a:	6a 17                	push   $0x17
  801c9c:	e8 56 fd ff ff       	call   8019f7 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  801cb6:	50                   	push   %eax
  801cb7:	6a 18                	push   $0x18
  801cb9:	e8 39 fd ff ff       	call   8019f7 <syscall>
  801cbe:	83 c4 18             	add    $0x18,%esp
}
  801cc1:	c9                   	leave  
  801cc2:	c3                   	ret    

00801cc3 <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801cd2:	52                   	push   %edx
  801cd3:	50                   	push   %eax
  801cd4:	6a 1b                	push   $0x1b
  801cd6:	e8 1c fd ff ff       	call   8019f7 <syscall>
  801cdb:	83 c4 18             	add    $0x18,%esp
}
  801cde:	c9                   	leave  
  801cdf:	c3                   	ret    

00801ce0 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801cf3:	e8 ff fc ff ff       	call   8019f7 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801d11:	e8 e1 fc ff ff       	call   8019f7 <syscall>
...
00801d1c <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  801d28:	8b 4d 14             	mov    0x14(%ebp),%ecx
  801d2b:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  801d39:	50                   	push   %eax
  801d3a:	6a 1c                	push   $0x1c
  801d3c:	e8 b6 fc ff ff       	call   8019f7 <syscall>
  801d41:	83 c4 18             	add    $0x18,%esp
}
  801d44:	c9                   	leave  
  801d45:	c3                   	ret    

00801d46 <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  801d59:	e8 99 fc ff ff       	call   8019f7 <syscall>
  801d5e:	83 c4 18             	add    $0x18,%esp
}
  801d61:	c9                   	leave  
  801d62:	c3                   	ret    

00801d63 <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  801d74:	52                   	push   %edx
  801d75:	50                   	push   %eax
  801d76:	6a 1e                	push   $0x1e
  801d78:	e8 7a fc ff ff       	call   8019f7 <syscall>
  801d7d:	83 c4 18             	add    $0x18,%esp
}
  801d80:	c9                   	leave  
  801d81:	c3                   	ret    

00801d82 <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  801d91:	52                   	push   %edx
  801d92:	50                   	push   %eax
  801d93:	6a 1f                	push   $0x1f
  801d95:	e8 5d fc ff ff       	call   8019f7 <syscall>
  801d9a:	83 c4 18             	add    $0x18,%esp
}
  801d9d:	c9                   	leave  
  801d9e:	c3                   	ret    

00801d9f <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  801dae:	e8 44 fc ff ff       	call   8019f7 <syscall>
  801db3:	83 c4 18             	add    $0x18,%esp
}
  801db6:	c9                   	leave  
  801db7:	c3                   	ret    

00801db8 <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801dc8:	50                   	push   %eax
  801dc9:	6a 21                	push   $0x21
  801dcb:	e8 27 fc ff ff       	call   8019f7 <syscall>
  801dd0:	83 c4 18             	add    $0x18,%esp
}
  801dd3:	c9                   	leave  
  801dd4:	c3                   	ret    

00801dd5 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  801de3:	50                   	push   %eax
  801de4:	6a 22                	push   $0x22
  801de6:	e8 0c fc ff ff       	call   8019f7 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801e02:	e8 f0 fb ff ff       	call   8019f7 <syscall>
...
sys_get_virtual_time()
{
  ...
  801e16:	8d 50 04             	lea    0x4(%eax),%edx
  801e19:	8d 45 f8             	lea    -0x8(%ebp),%eax
  801e1c:	6a 00                	push   $0x0
  801e1e:	6a 00                	push   $0x0
  801e20:	6a 00                	push   $0x0
  801e22:	52                   	push   %edx
  801e23:	50                   	push   %eax
  801e24:	6a 24                	push   $0x24
  801e26:	e8 cc fb ff ff       	call   8019f7 <syscall>
  801e2b:	83 c4 18             	add    $0x18,%esp
	return result;
  801e2e:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801e31:	8b 45 f8             	mov    -0x8(%ebp),%eax
  801e34:	8b 55 fc             	mov    -0x4(%ebp),%edx
  801e37:	89 01                	mov    %eax,(%ecx)
  801e39:	89 51 04             	mov    %edx,0x4(%ecx)
}
  801e3c:	8b 45 08             	mov    0x8(%ebp),%eax
  801e3f:	c9                   	leave  
  801e40:	c2 04 00             	ret    $0x4

00801e43 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801e53:	6a 13                	push   $0x13
  801e55:	e8 9d fb ff ff       	call   8019f7 <syscall>
...
uint32 sys_rcr2()
{
  ...
  801e6d:	6a 25                	push   $0x25
  801e6f:	e8 83 fb ff ff       	call   8019f7 <syscall>
  801e74:	83 c4 18             	add    $0x18,%esp
}
  801e77:	c9                   	leave  
  801e78:	c3                   	ret    

00801e79 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801e85:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  801e89:	6a 00                	push   $0x0
  801e8b:	6a 00                	push   $0x0
  801e8d:	6a 00                	push   $0x0
  801e8f:	6a 00                	push   $0x0
  801e91:	50                   	push   %eax
  801e92:	6a 26                	push   $0x26
  801e94:	e8 5e fb ff ff       	call   8019f7 <syscall>
...
void rsttst()
{
  ...
  801eac:	6a 28                	push   $0x28
  801eae:	e8 44 fb ff ff       	call   8019f7 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801ec5:	8b 55 18             	mov    0x18(%ebp),%edx
  801ec8:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  801ecc:	52                   	push   %edx
  801ecd:	50                   	push   %eax
  801ece:	ff 75 10             	pushl  0x10(%ebp)
  801ed1:	ff 75 0c             	pushl  0xc(%ebp)
  801ed4:	ff 75 08             	pushl  0x8(%ebp)
  801ed7:	6a 27                	push   $0x27
  801ed9:	e8 19 fb ff ff       	call   8019f7 <syscall>
...
void chktst(uint32 n)
{
  ...
  801ef2:	6a 29                	push   $0x29
  801ef4:	e8 fe fa ff ff       	call   8019f7 <syscall>
...
void inctst()
{
  ...
  801f0c:	6a 2a                	push   $0x2a
  801f0e:	e8 e4 fa ff ff       	call   8019f7 <syscall>
...
uint32 gettst()
{
  ...
  801f28:	e8 ca fa ff ff       	call   8019f7 <syscall>
  801f2d:	83 c4 18             	add    $0x18,%esp
}
  801f30:	c9                   	leave  
  801f31:	c3                   	ret    

00801f32 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801f44:	e8 ae fa ff ff       	call   8019f7 <syscall>
  801f49:	83 c4 18             	add    $0x18,%esp
  801f4c:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801f4f:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801f53:	75 07                	jne    801f5c <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801f55:	b8 01 00 00 00       	mov    $0x1,%eax
  801f5a:	eb 05                	jmp    801f61 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801f63 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801f75:	e8 7d fa ff ff       	call   8019f7 <syscall>
  801f7a:	83 c4 18             	add    $0x18,%esp
  801f7d:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  801f80:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801f84:	75 07                	jne    801f8d <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801f86:	b8 01 00 00 00       	mov    $0x1,%eax
  801f8b:	eb 05                	jmp    801f92 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801f94 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801fa6:	e8 4c fa ff ff       	call   8019f7 <syscall>
  801fab:	83 c4 18             	add    $0x18,%esp
  801fae:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  801fb1:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801fb5:	75 07                	jne    801fbe <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801fb7:	b8 01 00 00 00       	mov    $0x1,%eax
  801fbc:	eb 05                	jmp    801fc3 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801fc5 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801fd7:	e8 1b fa ff ff       	call   8019f7 <syscall>
  801fdc:	83 c4 18             	add    $0x18,%esp
  801fdf:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801fe2:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801fe6:	75 07                	jne    801fef <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801fe8:	b8 01 00 00 00       	mov    $0x1,%eax
  801fed:	eb 05                	jmp    801ff4 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801ff6 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  802004:	6a 2d                	push   $0x2d
  802006:	e8 ec f9 ff ff       	call   8019f7 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  802025:	52                   	push   %edx
  802026:	50                   	push   %eax
  802027:	6a 2e                	push   $0x2e
  802029:	e8 c9 f9 ff ff       	call   8019f7 <syscall>
...
00802036 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  802045:	52                   	push   %edx
  802046:	50                   	push   %eax
  802047:	6a 2f                	push   $0x2f
  802049:	e8 a9 f9 ff ff       	call   8019f7 <syscall>
...
00802054 <__udivdi3>:
  ...
  802067:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  ...
  8020b4:	3b 44 24 08          	cmp    0x8(%esp),%eax
  ...
  8020f5:	89 eb                	mov    %ebp,%ebx
  8020f7:	29 fb                	sub    %edi,%ebx
  8020f9:	89 f9                	mov    %edi,%ecx
  8020fb:	d3 e6                	shl    %cl,%esi
  8020fd:	89 c5                	mov    %eax,%ebp
  8020ff:	88 d9                	mov    %bl,%cl
  802101:	d3 ed                	shr    %cl,%ebp
  802103:	89 e9                	mov    %ebp,%ecx
  802105:	09 f1                	or     %esi,%ecx
  802107:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
...
00802164 <__umoddi3>:
  ...
  802183:	89 f3                	mov    %esi,%ebx
  802185:	89 fa                	mov    %edi,%edx
  802187:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  80218b:	89 34 24             	mov    %esi,(%esp)
  80218e:	85 c0                	test   %eax,%eax
  802190:	75 1a                	jne    8021ac <__umoddi3+0x48>
  802192:	39 f7                	cmp    %esi,%edi
  802194:	0f 86 a2 00 00 00    	jbe    80223c <__umoddi3+0xd8>
  ...
  8021ae:	0f 87 ac 00 00 00    	ja     802260 <__umoddi3+0xfc>
  8021b4:	0f bd e8             	bsr    %eax,%ebp
  8021b7:	83 f5 1f             	xor    $0x1f,%ebp
  8021ba:	0f 84 ac 00 00 00    	je     80226c <__umoddi3+0x108>
  8021c0:	bf 20 00 00 00       	mov    $0x20,%edi
  8021c5:	29 ef                	sub    %ebp,%edi
  8021c7:	89 fe                	mov    %edi,%esi
  8021c9:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  8021cd:	89 e9                	mov    %ebp,%ecx
  8021cf:	d3 e0                	shl    %cl,%eax
  8021d1:	89 d7                	mov    %edx,%edi
  8021d3:	89 f1                	mov    %esi,%ecx
  8021d5:	d3 ef                	shr    %cl,%edi
  8021d7:	09 c7                	or     %eax,%edi
  8021d9:	89 e9                	mov    %ebp,%ecx
  8021db:	d3 e2                	shl    %cl,%edx
  8021dd:	89 14 24             	mov    %edx,(%esp)
  8021e0:	89 d8                	mov    %ebx,%eax
  8021e2:	d3 e0                	shl    %cl,%eax
  8021e4:	89 c2                	mov    %eax,%edx
  8021e6:	8b 44 24 08          	mov    0x8(%esp),%eax
  8021ea:	d3 e0                	shl    %cl,%eax
  8021ec:	89 44 24 04          	mov    %eax,0x4(%esp)
  8021f0:	8b 44 24 08          	mov    0x8(%esp),%eax
  8021f4:	89 f1                	mov    %esi,%ecx
  8021f6:	d3 e8                	shr    %cl,%eax
  8021f8:	09 d0                	or     %edx,%eax
  8021fa:	d3 eb                	shr    %cl,%ebx
  8021fc:	89 da                	mov    %ebx,%edx
  8021fe:	f7 f7                	div    %edi
  802200:	89 d3                	mov    %edx,%ebx
  802202:	f7 24 24             	mull   (%esp)
  802205:	89 c6                	mov    %eax,%esi
  802207:	89 d1                	mov    %edx,%ecx
  802209:	39 d3                	cmp    %edx,%ebx
  80220b:	0f 82 87 00 00 00    	jb     802298 <__umoddi3+0x134>
  802211:	0f 84 91 00 00 00    	je     8022a8 <__umoddi3+0x144>
  802217:	8b 54 24 04          	mov    0x4(%esp),%edx
  80221b:	29 f2                	sub    %esi,%edx
  80221d:	19 cb                	sbb    %ecx,%ebx
  80221f:	89 d8                	mov    %ebx,%eax
  802221:	8a 4c 24 0c          	mov    0xc(%esp),%cl
  802225:	d3 e0                	shl    %cl,%eax
  802227:	89 e9                	mov    %ebp,%ecx
  802229:	d3 ea                	shr    %cl,%edx
  80222b:	09 d0                	or     %edx,%eax
  80222d:	89 e9                	mov    %ebp,%ecx
  80222f:	d3 eb                	shr    %cl,%ebx
  802231:	89 da                	mov    %ebx,%edx
  802233:	83 c4 1c             	add    $0x1c,%esp
  802236:	5b                   	pop    %ebx
  802237:	5e                   	pop    %esi
  802238:	5f                   	pop    %edi
  802239:	5d                   	pop    %ebp
  80223a:	c3                   	ret    
  80223b:	90                   	nop
  80223c:	89 fd                	mov    %edi,%ebp
  80223e:	85 ff                	test   %edi,%edi
  802240:	75 0b                	jne    80224d <__umoddi3+0xe9>
  802242:	b8 01 00 00 00       	mov    $0x1,%eax
  802247:	31 d2                	xor    %edx,%edx
  802249:	f7 f7                	div    %edi
  ...
  802259:	e9 44 ff ff ff       	jmp    8021a2 <__umoddi3+0x3e>
  ...
  80226a:	5d                   	pop    %ebp
  80226b:	c3                   	ret    
  80226c:	3b 04 24             	cmp    (%esp),%eax
  80226f:	72 06                	jb     802277 <__umoddi3+0x113>
  802271:	3b 7c 24 04          	cmp    0x4(%esp),%edi
  802275:	77 0f                	ja     802286 <__umoddi3+0x122>
  802277:	89 f2                	mov    %esi,%edx
  802279:	29 f9                	sub    %edi,%ecx
  80227b:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  80227f:	89 14 24             	mov    %edx,(%esp)
  802282:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  802286:	8b 44 24 04          	mov    0x4(%esp),%eax
  80228a:	8b 14 24             	mov    (%esp),%edx
  ...
  802298:	2b 04 24             	sub    (%esp),%eax
  80229b:	19 fa                	sbb    %edi,%edx
  80229d:	89 d1                	mov    %edx,%ecx
  80229f:	89 c6                	mov    %eax,%esi
  8022a1:	e9 71 ff ff ff       	jmp    802217 <__umoddi3+0xb3>
  8022a6:	66 90                	xchg   %ax,%ax
  8022a8:	39 44 24 04          	cmp    %eax,0x4(%esp)
  8022ac:	72 ea                	jb     802298 <__umoddi3+0x134>
  8022ae:	89 d9                	mov    %ebx,%ecx
  8022b0:	e9 62 ff ff ff       	jmp    802217 <__umoddi3+0xb3>
