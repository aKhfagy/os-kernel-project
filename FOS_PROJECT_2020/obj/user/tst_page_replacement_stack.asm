...
//	cprintf("envID = %d\n",envID);
  ...
  800083:	68 60 1b 80 00       	push   $0x801b60
  ...
  8000ad:	68 98 1b 80 00       	push   $0x801b98
  8000b2:	6a 1a                	push   $0x1a
  8000b4:	68 c8 1b 80 00       	push   $0x801bc8
  ...
  8000de:	68 ec 1b 80 00       	push   $0x801bec
  8000e3:	6a 1c                	push   $0x1c
  8000e5:	68 c8 1b 80 00       	push   $0x801bc8
...
libmain(int argc, char **argv)
{
  ...
  8001ba:	68 ec 1c 80 00       	push   $0x801cec
  ...
  8001e0:	52                   	push   %edx
  8001e1:	50                   	push   %eax
  8001e2:	68 14 1d 80 00       	push   $0x801d14
  ...
  800208:	52                   	push   %edx
  800209:	50                   	push   %eax
  80020a:	68 3c 1d 80 00       	push   $0x801d3c
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800294:	50                   	push   %eax
  800295:	68 94 1d 80 00       	push   $0x801d94
  ...
  8002ad:	50                   	push   %eax
  8002ae:	68 99 1d 80 00       	push   $0x801d99
  ...
  8002d2:	68 b5 1d 80 00       	push   $0x801db5
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8002fe:	68 b8 1d 80 00       	push   $0x801db8
  800303:	6a 26                	push   $0x26
  800305:	68 04 1e 80 00       	push   $0x801e04
  ...
  8003c4:	68 10 1e 80 00       	push   $0x801e10
  8003c9:	6a 3a                	push   $0x3a
  8003cb:	68 04 1e 80 00       	push   $0x801e04
  ...
  80042e:	68 64 1e 80 00       	push   $0x801e64
  800433:	6a 44                	push   $0x44
  800435:	68 04 1e 80 00       	push   $0x801e04
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8005b3:	e8 44 13 00 00       	call   8018fc <__udivdi3>
  ...
  800601:	52                   	push   %edx
  800602:	50                   	push   %eax
  800603:	e8 04 14 00 00       	call   801a0c <__umoddi3>
  800608:	83 c4 10             	add    $0x10,%esp
  80060b:	05 d4 20 80 00       	add    $0x8020d4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80075e:	8b 04 85 f8 20 80 00 	mov    0x8020f8(,%eax,4),%eax
  ...
  80083f:	8b 34 9d 40 1f 80 00 	mov    0x801f40(,%ebx,4),%esi
  800846:	85 f6                	test   %esi,%esi
  800848:	75 19                	jne    800863 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80084a:	53                   	push   %ebx
  80084b:	68 e5 20 80 00       	push   $0x8020e5
  ...
  80085e:	e9 49 02 00 00       	jmp    800aac <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800863:	56                   	push   %esi
  800864:	68 ee 20 80 00       	push   $0x8020ee
  ...
  80088f:	75 05                	jne    800896 <vprintfmt+0x1a6>
				p = "(null)";
  800891:	be f1 20 80 00       	mov    $0x8020f1,%esi
			if (width > 0 && padc != '-')
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801674:	e8 27 fc ff ff       	call   8012a0 <syscall>
  801679:	83 c4 18             	add    $0x18,%esp
}
  80167c:	c9                   	leave  
  80167d:	c3                   	ret    

0080167e <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  80168f:	e8 0c fc ff ff       	call   8012a0 <syscall>
...
sys_get_virtual_time()
{
  ...
  8016bc:	8d 45 f8             	lea    -0x8(%ebp),%eax
  8016bf:	8d 50 04             	lea    0x4(%eax),%edx
  8016c2:	8d 45 f8             	lea    -0x8(%ebp),%eax
  8016c5:	6a 00                	push   $0x0
  8016c7:	6a 00                	push   $0x0
  8016c9:	6a 00                	push   $0x0
  8016cb:	52                   	push   %edx
  8016cc:	50                   	push   %eax
  8016cd:	6a 24                	push   $0x24
  8016cf:	e8 cc fb ff ff       	call   8012a0 <syscall>
  ...
  8016e2:	89 51 04             	mov    %edx,0x4(%ecx)
}
  8016e5:	8b 45 08             	mov    0x8(%ebp),%eax
  8016e8:	c9                   	leave  
  8016e9:	c2 04 00             	ret    $0x4

008016ec <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8016fe:	e8 9d fb ff ff       	call   8012a0 <syscall>
...
uint32 sys_rcr2()
{
  ...
  801718:	e8 83 fb ff ff       	call   8012a0 <syscall>
  80171d:	83 c4 18             	add    $0x18,%esp
}
  801720:	c9                   	leave  
  801721:	c3                   	ret    

00801722 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  80172e:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  801732:	6a 00                	push   $0x0
  801734:	6a 00                	push   $0x0
  801736:	6a 00                	push   $0x0
  801738:	6a 00                	push   $0x0
  80173a:	50                   	push   %eax
  80173b:	6a 26                	push   $0x26
  80173d:	e8 5e fb ff ff       	call   8012a0 <syscall>
...
void rsttst()
{
  ...
  801757:	e8 44 fb ff ff       	call   8012a0 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  80176e:	8b 55 18             	mov    0x18(%ebp),%edx
  ...
  801780:	6a 27                	push   $0x27
  801782:	e8 19 fb ff ff       	call   8012a0 <syscall>
...
void chktst(uint32 n)
{
  ...
  80179d:	e8 fe fa ff ff       	call   8012a0 <syscall>
...
void inctst()
{
  ...
  8017b5:	6a 2a                	push   $0x2a
  8017b7:	e8 e4 fa ff ff       	call   8012a0 <syscall>
...
uint32 gettst()
{
  ...
  8017d1:	e8 ca fa ff ff       	call   8012a0 <syscall>
  8017d6:	83 c4 18             	add    $0x18,%esp
}
  8017d9:	c9                   	leave  
  8017da:	c3                   	ret    

008017db <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8017ed:	e8 ae fa ff ff       	call   8012a0 <syscall>
  8017f2:	83 c4 18             	add    $0x18,%esp
  8017f5:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8017f8:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8017fc:	75 07                	jne    801805 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8017fe:	b8 01 00 00 00       	mov    $0x1,%eax
  801803:	eb 05                	jmp    80180a <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
0080180c <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  80181e:	e8 7d fa ff ff       	call   8012a0 <syscall>
  801823:	83 c4 18             	add    $0x18,%esp
  801826:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  801829:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  80182d:	75 07                	jne    801836 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  80182f:	b8 01 00 00 00       	mov    $0x1,%eax
  801834:	eb 05                	jmp    80183b <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
0080183d <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  80184f:	e8 4c fa ff ff       	call   8012a0 <syscall>
  801854:	83 c4 18             	add    $0x18,%esp
  801857:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  80185a:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  80185e:	75 07                	jne    801867 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801860:	b8 01 00 00 00       	mov    $0x1,%eax
  801865:	eb 05                	jmp    80186c <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
0080186e <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801880:	e8 1b fa ff ff       	call   8012a0 <syscall>
  801885:	83 c4 18             	add    $0x18,%esp
  801888:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  80188b:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  80188f:	75 07                	jne    801898 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801891:	b8 01 00 00 00       	mov    $0x1,%eax
  801896:	eb 05                	jmp    80189d <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
0080189f <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  8018ad:	6a 2d                	push   $0x2d
  8018af:	e8 ec f9 ff ff       	call   8012a0 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8018ce:	52                   	push   %edx
  8018cf:	50                   	push   %eax
  8018d0:	6a 2e                	push   $0x2e
  8018d2:	e8 c9 f9 ff ff       	call   8012a0 <syscall>
...
008018df <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8018ee:	52                   	push   %edx
  8018ef:	50                   	push   %eax
  8018f0:	6a 2f                	push   $0x2f
  8018f2:	e8 a9 f9 ff ff       	call   8012a0 <syscall>
