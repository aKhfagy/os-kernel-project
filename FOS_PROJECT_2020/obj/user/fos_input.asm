	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800391:	e8 9e 16 00 00       	call   801a34 <__udivdi3>
  ...
  8003df:	52                   	push   %edx
  8003e0:	50                   	push   %eax
  8003e1:	e8 5e 17 00 00       	call   801b44 <__umoddi3>
...
void readline(const char *prompt, char* buf)
{
  ...
  8009a1:	e8 84 10 00 00       	call   801a2a <iscons>
  8009a6:	83 c4 10             	add    $0x10,%esp
  8009a9:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  8009ac:	e8 2b 10 00 00       	call   8019dc <getchar>
  ...
  8009f7:	e8 98 0f 00 00       	call   801994 <cputchar>
  ...
  800a2e:	e8 61 0f 00 00       	call   801994 <cputchar>
  ...
  800a57:	e8 38 0f 00 00       	call   801994 <cputchar>
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  800aa4:	e8 81 0f 00 00       	call   801a2a <iscons>
  800aa9:	83 c4 10             	add    $0x10,%esp
  800aac:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  800aaf:	e8 28 0f 00 00       	call   8019dc <getchar>
  ...
  800afb:	e8 94 0e 00 00       	call   801994 <cputchar>
  ...
  800b32:	e8 5d 0e 00 00       	call   801994 <cputchar>
  ...
  800b5b:	e8 34 0e 00 00       	call   801994 <cputchar>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801658:	e8 27 fc ff ff       	call   801284 <syscall>
...
sys_run_env(int32 envId)
{
  ...
  801673:	e8 0c fc ff ff       	call   801284 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  80168c:	50                   	push   %eax
  80168d:	6a 23                	push   $0x23
  80168f:	e8 f0 fb ff ff       	call   801284 <syscall>
...
sys_get_virtual_time()
{
  ...
  8016a3:	8d 50 04             	lea    0x4(%eax),%edx
  ...
  8016b3:	e8 cc fb ff ff       	call   801284 <syscall>
  ...
  8016c6:	89 51 04             	mov    %edx,0x4(%ecx)
}
  8016c9:	8b 45 08             	mov    0x8(%ebp),%eax
  8016cc:	c9                   	leave  
  8016cd:	c2 04 00             	ret    $0x4

008016d0 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8016e0:	6a 13                	push   $0x13
  8016e2:	e8 9d fb ff ff       	call   801284 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8016fc:	e8 83 fb ff ff       	call   801284 <syscall>
  801701:	83 c4 18             	add    $0x18,%esp
}
  801704:	c9                   	leave  
  801705:	c3                   	ret    

00801706 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801712:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  801716:	6a 00                	push   $0x0
  801718:	6a 00                	push   $0x0
  80171a:	6a 00                	push   $0x0
  80171c:	6a 00                	push   $0x0
  80171e:	50                   	push   %eax
  80171f:	6a 26                	push   $0x26
  801721:	e8 5e fb ff ff       	call   801284 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801752:	8b 55 18             	mov    0x18(%ebp),%edx
  801755:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  801759:	52                   	push   %edx
  80175a:	50                   	push   %eax
  80175b:	ff 75 10             	pushl  0x10(%ebp)
  80175e:	ff 75 0c             	pushl  0xc(%ebp)
  801761:	ff 75 08             	pushl  0x8(%ebp)
  801764:	6a 27                	push   $0x27
  801766:	e8 19 fb ff ff       	call   801284 <syscall>
...
void chktst(uint32 n)
{
  ...
  80177f:	6a 29                	push   $0x29
  801781:	e8 fe fa ff ff       	call   801284 <syscall>
...
void inctst()
{
  ...
  80179b:	e8 e4 fa ff ff       	call   801284 <syscall>
...
008017bf <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8017d1:	e8 ae fa ff ff       	call   801284 <syscall>
  8017d6:	83 c4 18             	add    $0x18,%esp
  8017d9:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8017dc:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8017e0:	75 07                	jne    8017e9 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8017e2:	b8 01 00 00 00       	mov    $0x1,%eax
  8017e7:	eb 05                	jmp    8017ee <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
008017f0 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801802:	e8 7d fa ff ff       	call   801284 <syscall>
  801807:	83 c4 18             	add    $0x18,%esp
  80180a:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  80180d:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801811:	75 07                	jne    80181a <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801813:	b8 01 00 00 00       	mov    $0x1,%eax
  801818:	eb 05                	jmp    80181f <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801821 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801833:	e8 4c fa ff ff       	call   801284 <syscall>
  801838:	83 c4 18             	add    $0x18,%esp
  80183b:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  80183e:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801842:	75 07                	jne    80184b <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801844:	b8 01 00 00 00       	mov    $0x1,%eax
  801849:	eb 05                	jmp    801850 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801852 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801864:	e8 1b fa ff ff       	call   801284 <syscall>
  801869:	83 c4 18             	add    $0x18,%esp
  80186c:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  80186f:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801873:	75 07                	jne    80187c <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801875:	b8 01 00 00 00       	mov    $0x1,%eax
  80187a:	eb 05                	jmp    801881 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801883 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801893:	e8 ec f9 ff ff       	call   801284 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8018b2:	52                   	push   %edx
  8018b3:	50                   	push   %eax
  8018b4:	6a 2e                	push   $0x2e
  8018b6:	e8 c9 f9 ff ff       	call   801284 <syscall>
...
008018c3 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8018d2:	52                   	push   %edx
  8018d3:	50                   	push   %eax
  8018d4:	6a 2f                	push   $0x2f
  8018d6:	e8 a9 f9 ff ff       	call   801284 <syscall>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  80191e:	50                   	push   %eax
  80191f:	e8 76 fd ff ff       	call   80169a <sys_get_virtual_time>
  ...
  80192f:	50                   	push   %eax
  801930:	e8 65 fd ff ff       	call   80169a <sys_get_virtual_time>
...
cputchar(int ch)
{
  ...
  8019a7:	50                   	push   %eax
  8019a8:	e8 47 fb ff ff       	call   8014f4 <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  8019b6:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8019b9:	e8 02 fb ff ff       	call   8014c0 <sys_disable_interrupt>
	char c = ch;
  ...
  8019cb:	50                   	push   %eax
  8019cc:	e8 23 fb ff ff       	call   8014f4 <sys_cputc>
  8019d1:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8019d4:	e8 01 fb ff ff       	call   8014da <sys_enable_interrupt>
}
  8019d9:	90                   	nop
  8019da:	c9                   	leave  
  8019db:	c3                   	ret    
...
getchar(void)
{
  ...
  8019e9:	eb 08                	jmp    8019f3 <getchar+0x17>
	{
		c = sys_cgetc();
  8019eb:	e8 e8 f8 ff ff       	call   8012d8 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  801a01:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  801a04:	e8 b7 fa ff ff       	call   8014c0 <sys_disable_interrupt>
	int c=0;
  ...
  801a10:	eb 08                	jmp    801a1a <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  801a12:	e8 c1 f8 ff ff       	call   8012d8 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  801a1e:	74 f2                	je     801a12 <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  801a20:	e8 b5 fa ff ff       	call   8014da <sys_enable_interrupt>
	return c;
