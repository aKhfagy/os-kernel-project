...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801419:	e8 27 fc ff ff       	call   801045 <syscall>
  80141e:	83 c4 18             	add    $0x18,%esp
}
  801421:	c9                   	leave  
  801422:	c3                   	ret    

00801423 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  801434:	e8 0c fc ff ff       	call   801045 <syscall>
...
sys_get_virtual_time()
{
  ...
  801474:	e8 cc fb ff ff       	call   801045 <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8014a1:	6a 13                	push   $0x13
  8014a3:	e8 9d fb ff ff       	call   801045 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8014bd:	e8 83 fb ff ff       	call   801045 <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  8014e2:	e8 5e fb ff ff       	call   801045 <syscall>
...
void rsttst()
{
  ...
  8014fc:	e8 44 fb ff ff       	call   801045 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801527:	e8 19 fb ff ff       	call   801045 <syscall>
...
void chktst(uint32 n)
{
  ...
  801542:	e8 fe fa ff ff       	call   801045 <syscall>
...
void inctst()
{
  ...
  80155c:	e8 e4 fa ff ff       	call   801045 <syscall>
...
uint32 gettst()
{
  ...
  801576:	e8 ca fa ff ff       	call   801045 <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801592:	e8 ae fa ff ff       	call   801045 <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  8015c3:	e8 7d fa ff ff       	call   801045 <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  8015f4:	e8 4c fa ff ff       	call   801045 <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801625:	e8 1b fa ff ff       	call   801045 <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801654:	e8 ec f9 ff ff       	call   801045 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801677:	e8 c9 f9 ff ff       	call   801045 <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801697:	e8 a9 f9 ff ff       	call   801045 <syscall>
