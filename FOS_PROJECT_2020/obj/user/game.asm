...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801423:	50                   	push   %eax
  801424:	6a 21                	push   $0x21
  801426:	e8 27 fc ff ff       	call   801052 <syscall>
  80142b:	83 c4 18             	add    $0x18,%esp
}
  80142e:	c9                   	leave  
  80142f:	c3                   	ret    

00801430 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  801441:	e8 0c fc ff ff       	call   801052 <syscall>
...
sys_get_virtual_time()
{
  ...
  80147d:	52                   	push   %edx
  80147e:	50                   	push   %eax
  80147f:	6a 24                	push   $0x24
  801481:	e8 cc fb ff ff       	call   801052 <syscall>
  801486:	83 c4 18             	add    $0x18,%esp
	return result;
  801489:	8b 4d 08             	mov    0x8(%ebp),%ecx
  80148c:	8b 45 f8             	mov    -0x8(%ebp),%eax
  80148f:	8b 55 fc             	mov    -0x4(%ebp),%edx
  801492:	89 01                	mov    %eax,(%ecx)
  801494:	89 51 04             	mov    %edx,0x4(%ecx)
}
  801497:	8b 45 08             	mov    0x8(%ebp),%eax
  80149a:	c9                   	leave  
  80149b:	c2 04 00             	ret    $0x4

0080149e <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8014b0:	e8 9d fb ff ff       	call   801052 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8014c8:	6a 25                	push   $0x25
  8014ca:	e8 83 fb ff ff       	call   801052 <syscall>
  8014cf:	83 c4 18             	add    $0x18,%esp
}
  8014d2:	c9                   	leave  
  8014d3:	c3                   	ret    

008014d4 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  8014e0:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  8014e4:	6a 00                	push   $0x0
  8014e6:	6a 00                	push   $0x0
  8014e8:	6a 00                	push   $0x0
  8014ea:	6a 00                	push   $0x0
  8014ec:	50                   	push   %eax
  8014ed:	6a 26                	push   $0x26
  8014ef:	e8 5e fb ff ff       	call   801052 <syscall>
...
void rsttst()
{
  ...
  801509:	e8 44 fb ff ff       	call   801052 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801520:	8b 55 18             	mov    0x18(%ebp),%edx
  801523:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  801527:	52                   	push   %edx
  801528:	50                   	push   %eax
  801529:	ff 75 10             	pushl  0x10(%ebp)
  80152c:	ff 75 0c             	pushl  0xc(%ebp)
  80152f:	ff 75 08             	pushl  0x8(%ebp)
  801532:	6a 27                	push   $0x27
  801534:	e8 19 fb ff ff       	call   801052 <syscall>
...
void chktst(uint32 n)
{
  ...
  80154d:	6a 29                	push   $0x29
  80154f:	e8 fe fa ff ff       	call   801052 <syscall>
...
void inctst()
{
  ...
  801569:	e8 e4 fa ff ff       	call   801052 <syscall>
...
uint32 gettst()
{
  ...
  801581:	6a 2b                	push   $0x2b
  801583:	e8 ca fa ff ff       	call   801052 <syscall>
  801588:	83 c4 18             	add    $0x18,%esp
}
  80158b:	c9                   	leave  
  80158c:	c3                   	ret    

0080158d <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  80159f:	e8 ae fa ff ff       	call   801052 <syscall>
  8015a4:	83 c4 18             	add    $0x18,%esp
  8015a7:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8015aa:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8015ae:	75 07                	jne    8015b7 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8015b0:	b8 01 00 00 00       	mov    $0x1,%eax
  8015b5:	eb 05                	jmp    8015bc <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
008015be <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  8015d0:	e8 7d fa ff ff       	call   801052 <syscall>
  8015d5:	83 c4 18             	add    $0x18,%esp
  8015d8:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  8015db:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  8015df:	75 07                	jne    8015e8 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  8015e1:	b8 01 00 00 00       	mov    $0x1,%eax
  8015e6:	eb 05                	jmp    8015ed <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
008015ef <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  8015ff:	6a 2c                	push   $0x2c
  801601:	e8 4c fa ff ff       	call   801052 <syscall>
  801606:	83 c4 18             	add    $0x18,%esp
  801609:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  80160c:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801610:	75 07                	jne    801619 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801612:	b8 01 00 00 00       	mov    $0x1,%eax
  801617:	eb 05                	jmp    80161e <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801620 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801630:	6a 2c                	push   $0x2c
  801632:	e8 1b fa ff ff       	call   801052 <syscall>
  801637:	83 c4 18             	add    $0x18,%esp
  80163a:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  80163d:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801641:	75 07                	jne    80164a <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801643:	b8 01 00 00 00       	mov    $0x1,%eax
  801648:	eb 05                	jmp    80164f <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  80165f:	6a 2d                	push   $0x2d
  801661:	e8 ec f9 ff ff       	call   801052 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801684:	e8 c9 f9 ff ff       	call   801052 <syscall>
...
00801691 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8016a4:	e8 a9 f9 ff ff       	call   801052 <syscall>
