...
{	
  ...
  80005c:	68 20 1c 80 00       	push   $0x801c20
  ...
  8000b9:	68 33 1c 80 00       	push   $0x801c33
  ...
  8000d7:	e8 53 10 00 00       	call   80112f <free>
  ...
  80010f:	68 33 1c 80 00       	push   $0x801c33
  ...
  80012d:	e8 fd 0f 00 00       	call   80112f <free>
...
libmain(int argc, char **argv)
{
  ...
  80013e:	e8 e1 10 00 00       	call   801224 <sys_getenvindex>
  ...
  8001bb:	e8 ff 11 00 00       	call   8013bf <sys_disable_interrupt>
	cprintf("**************************************\n");
  8001c0:	83 ec 0c             	sub    $0xc,%esp
  8001c3:	68 58 1c 80 00       	push   $0x801c58
  ...
  8001e9:	52                   	push   %edx
  8001ea:	50                   	push   %eax
  8001eb:	68 80 1c 80 00       	push   $0x801c80
  ...
  800211:	52                   	push   %edx
  800212:	50                   	push   %eax
  800213:	68 a8 1c 80 00       	push   $0x801ca8
  ...
  80022e:	50                   	push   %eax
  80022f:	68 e9 1c 80 00       	push   $0x801ce9
  800234:	e8 18 01 00 00       	call   800351 <cprintf>
  800239:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  80023c:	83 ec 0c             	sub    $0xc,%esp
  80023f:	68 58 1c 80 00       	push   $0x801c58
  800244:	e8 08 01 00 00       	call   800351 <cprintf>
  800249:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  80024c:	e8 88 11 00 00       	call   8013d9 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  800264:	e8 87 0f 00 00       	call   8011f0 <sys_env_destroy>
...
exit(void)
{
  ...
  800272:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  800275:	e8 dc 0f 00 00       	call   801256 <sys_env_exit>
}
  80027a:	90                   	nop
  80027b:	c9                   	leave  
  80027c:	c3                   	ret    
...
static void putch(int ch, struct printbuf *b) {
  ...
  8002c1:	51                   	push   %ecx
  8002c2:	52                   	push   %edx
  8002c3:	e8 e6 0e 00 00       	call   8011ae <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800339:	50                   	push   %eax
  80033a:	e8 6f 0e 00 00       	call   8011ae <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800381:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800384:	e8 36 10 00 00       	call   8013bf <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8003a1:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8003a4:	e8 30 10 00 00       	call   8013d9 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8003ee:	e8 bd 15 00 00       	call   8019b0 <__udivdi3>
  ...
  80043c:	52                   	push   %edx
  80043d:	50                   	push   %eax
  80043e:	e8 7d 16 00 00       	call   801ac0 <__umoddi3>
  800443:	83 c4 10             	add    $0x10,%esp
  800446:	05 14 1f 80 00       	add    $0x801f14,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800599:	8b 04 85 38 1f 80 00 	mov    0x801f38(,%eax,4),%eax
  ...
  80067a:	8b 34 9d 80 1d 80 00 	mov    0x801d80(,%ebx,4),%esi
  800681:	85 f6                	test   %esi,%esi
  800683:	75 19                	jne    80069e <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800685:	53                   	push   %ebx
  800686:	68 25 1f 80 00       	push   $0x801f25
  ...
  800699:	e9 49 02 00 00       	jmp    8008e7 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  80069e:	56                   	push   %esi
  80069f:	68 2e 1f 80 00       	push   $0x801f2e
  ...
  8006ca:	75 05                	jne    8006d1 <vprintfmt+0x1a6>
				p = "(null)";
  8006cc:	be 31 1f 80 00       	mov    $0x801f31,%esi
			if (width > 0 && padc != '-')
...
void* malloc(uint32 size)
{
  ...
  8010e4:	68 90 20 80 00       	push   $0x802090
  8010e9:	6a 19                	push   $0x19
  8010eb:	68 b5 20 80 00       	push   $0x8020b5
  8010f0:	e8 ea 06 00 00       	call   8017df <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  8010fe:	88 45 f4             	mov    %al,-0xc(%ebp)
	//TODO: [PROJECT 2020  - Shared Variables: Creation] smalloc() [User Side]
	// Write your code here, remove the panic and write your code
	panic("smalloc() is not implemented yet...!!");
  801101:	83 ec 04             	sub    $0x4,%esp
  801104:	68 c4 20 80 00       	push   $0x8020c4
  801109:	6a 31                	push   $0x31
  80110b:	68 b5 20 80 00       	push   $0x8020b5
  801110:	e8 ca 06 00 00       	call   8017df <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  80111e:	68 ec 20 80 00       	push   $0x8020ec
  801123:	6a 4a                	push   $0x4a
  801125:	68 b5 20 80 00       	push   $0x8020b5
  80112a:	e8 b0 06 00 00       	call   8017df <_panic>
...
void free(void* virtual_address)
{
  ...
  801138:	68 10 21 80 00       	push   $0x802110
  80113d:	6a 70                	push   $0x70
  80113f:	68 b5 20 80 00       	push   $0x8020b5
  801144:	e8 96 06 00 00       	call   8017df <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801152:	68 34 21 80 00       	push   $0x802134
  801157:	68 8b 00 00 00       	push   $0x8b
  80115c:	68 b5 20 80 00       	push   $0x8020b5
  801161:	e8 79 06 00 00       	call   8017df <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  80116f:	68 58 21 80 00       	push   $0x802158
  801174:	68 a8 00 00 00       	push   $0xa8
  801179:	68 b5 20 80 00       	push   $0x8020b5
  80117e:	e8 5c 06 00 00       	call   8017df <_panic>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  801192:	8b 4d 10             	mov    0x10(%ebp),%ecx
  801195:	8b 5d 14             	mov    0x14(%ebp),%ebx
  801198:	8b 7d 18             	mov    0x18(%ebp),%edi
  80119b:	8b 75 1c             	mov    0x1c(%ebp),%esi
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  8011ba:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  8011cc:	e8 b2 ff ff ff       	call   801183 <syscall>
...
sys_cgetc(void)
{
  ...
  8011e6:	e8 98 ff ff ff       	call   801183 <syscall>
  8011eb:	83 c4 18             	add    $0x18,%esp
}
  8011ee:	c9                   	leave  
  8011ef:	c3                   	ret    

008011f0 <sys_env_destroy>:
...
int sys_env_destroy(int32  envid)
{
  ...
  801201:	e8 7d ff ff ff       	call   801183 <syscall>
  801206:	83 c4 18             	add    $0x18,%esp
}
  801209:	c9                   	leave  
  80120a:	c3                   	ret    

0080120b <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  80121a:	e8 64 ff ff ff       	call   801183 <syscall>
  80121f:	83 c4 18             	add    $0x18,%esp
}
  801222:	c9                   	leave  
  801223:	c3                   	ret    

00801224 <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  801231:	6a 03                	push   $0x3
  801233:	e8 4b ff ff ff       	call   801183 <syscall>
  801238:	83 c4 18             	add    $0x18,%esp
}
  80123b:	c9                   	leave  
  80123c:	c3                   	ret    

0080123d <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  80124a:	6a 04                	push   $0x4
  80124c:	e8 32 ff ff ff       	call   801183 <syscall>
  801251:	83 c4 18             	add    $0x18,%esp
}
  801254:	c9                   	leave  
  801255:	c3                   	ret    

00801256 <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  801263:	6a 06                	push   $0x6
  801265:	e8 19 ff ff ff       	call   801183 <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801283:	e8 fb fe ff ff       	call   801183 <syscall>
  801288:	83 c4 18             	add    $0x18,%esp
}
  80128b:	c9                   	leave  
  80128c:	c3                   	ret    

0080128d <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801292:	8b 75 18             	mov    0x18(%ebp),%esi
  801295:	8b 5d 14             	mov    0x14(%ebp),%ebx
  ...
  8012a8:	e8 d6 fe ff ff       	call   801183 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  8012ca:	e8 b4 fe ff ff       	call   801183 <syscall>
  8012cf:	83 c4 18             	add    $0x18,%esp
}
  8012d2:	c9                   	leave  
  8012d3:	c3                   	ret    

008012d4 <sys_calculate_required_frames>:
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  8012e3:	6a 0a                	push   $0xa
  8012e5:	e8 99 fe ff ff       	call   801183 <syscall>
  8012ea:	83 c4 18             	add    $0x18,%esp
}
  8012ed:	c9                   	leave  
  8012ee:	c3                   	ret    

008012ef <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  8012fc:	6a 0b                	push   $0xb
  8012fe:	e8 80 fe ff ff       	call   801183 <syscall>
  801303:	83 c4 18             	add    $0x18,%esp
}
  801306:	c9                   	leave  
  801307:	c3                   	ret    

00801308 <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  801315:	6a 0c                	push   $0xc
  801317:	e8 67 fe ff ff       	call   801183 <syscall>
  80131c:	83 c4 18             	add    $0x18,%esp
}
  80131f:	c9                   	leave  
  801320:	c3                   	ret    

00801321 <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  80132e:	6a 0d                	push   $0xd
  801330:	e8 4e fe ff ff       	call   801183 <syscall>
  801335:	83 c4 18             	add    $0x18,%esp
}
  801338:	c9                   	leave  
  801339:	c3                   	ret    

0080133a <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  801349:	6a 11                	push   $0x11
  80134b:	e8 33 fe ff ff       	call   801183 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  801365:	6a 12                	push   $0x12
  801367:	e8 17 fe ff ff       	call   801183 <syscall>
...
int sys_pf_calculate_allocated_pages()
{
  ...
  801381:	e8 fd fd ff ff       	call   801183 <syscall>
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801399:	6a 0f                	push   $0xf
  80139b:	e8 e3 fd ff ff       	call   801183 <syscall>
...
void sys_scarce_memory()
{
  ...
  8013b4:	e8 ca fd ff ff       	call   801183 <syscall>
...
008013bf <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  8013cc:	6a 14                	push   $0x14
  8013ce:	e8 b0 fd ff ff       	call   801183 <syscall>
...
sys_enable_interrupt()
{
  ...
  8013e6:	6a 15                	push   $0x15
  8013e8:	e8 96 fd ff ff       	call   801183 <syscall>
...
sys_cputc(const char c)
{
  ...
  80140b:	50                   	push   %eax
  80140c:	6a 16                	push   $0x16
  80140e:	e8 70 fd ff ff       	call   801183 <syscall>
...
sys_clear_ffl()
{
  ...
  801428:	e8 56 fd ff ff       	call   801183 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  801445:	e8 39 fd ff ff       	call   801183 <syscall>
  80144a:	83 c4 18             	add    $0x18,%esp
}
  80144d:	c9                   	leave  
  80144e:	c3                   	ret    

0080144f <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  80145e:	52                   	push   %edx
  80145f:	50                   	push   %eax
  801460:	6a 1b                	push   $0x1b
  801462:	e8 1c fd ff ff       	call   801183 <syscall>
  801467:	83 c4 18             	add    $0x18,%esp
}
  80146a:	c9                   	leave  
  80146b:	c3                   	ret    

0080146c <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  80147f:	e8 ff fc ff ff       	call   801183 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801499:	52                   	push   %edx
  80149a:	50                   	push   %eax
  80149b:	6a 1a                	push   $0x1a
  80149d:	e8 e1 fc ff ff       	call   801183 <syscall>
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  8014c5:	50                   	push   %eax
  8014c6:	6a 1c                	push   $0x1c
  8014c8:	e8 b6 fc ff ff       	call   801183 <syscall>
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  8014e1:	52                   	push   %edx
  8014e2:	50                   	push   %eax
  8014e3:	6a 1d                	push   $0x1d
  8014e5:	e8 99 fc ff ff       	call   801183 <syscall>
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  801500:	52                   	push   %edx
  801501:	50                   	push   %eax
  801502:	6a 1e                	push   $0x1e
  801504:	e8 7a fc ff ff       	call   801183 <syscall>
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  80151d:	52                   	push   %edx
  80151e:	50                   	push   %eax
  80151f:	6a 1f                	push   $0x1f
  801521:	e8 5d fc ff ff       	call   801183 <syscall>
  801526:	83 c4 18             	add    $0x18,%esp
}
  801529:	c9                   	leave  
  80152a:	c3                   	ret    

0080152b <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  801538:	6a 20                	push   $0x20
  80153a:	e8 44 fc ff ff       	call   801183 <syscall>
  80153f:	83 c4 18             	add    $0x18,%esp
}
  801542:	c9                   	leave  
  801543:	c3                   	ret    

00801544 <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801554:	50                   	push   %eax
  801555:	6a 21                	push   $0x21
  801557:	e8 27 fc ff ff       	call   801183 <syscall>
  80155c:	83 c4 18             	add    $0x18,%esp
}
  80155f:	c9                   	leave  
  801560:	c3                   	ret    

00801561 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  80156f:	50                   	push   %eax
  801570:	6a 22                	push   $0x22
  801572:	e8 0c fc ff ff       	call   801183 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  80158e:	e8 f0 fb ff ff       	call   801183 <syscall>
...
sys_get_virtual_time()
{
  ...
  80159f:	8d 45 f8             	lea    -0x8(%ebp),%eax
  ...
  8015ae:	52                   	push   %edx
  8015af:	50                   	push   %eax
  8015b0:	6a 24                	push   $0x24
  8015b2:	e8 cc fb ff ff       	call   801183 <syscall>
  8015b7:	83 c4 18             	add    $0x18,%esp
	return result;
  8015ba:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8015bd:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8015c0:	8b 55 fc             	mov    -0x4(%ebp),%edx
  8015c3:	89 01                	mov    %eax,(%ecx)
  8015c5:	89 51 04             	mov    %edx,0x4(%ecx)
}
  8015c8:	8b 45 08             	mov    0x8(%ebp),%eax
  8015cb:	c9                   	leave  
  8015cc:	c2 04 00             	ret    $0x4

008015cf <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8015df:	6a 13                	push   $0x13
  8015e1:	e8 9d fb ff ff       	call   801183 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8015fb:	e8 83 fb ff ff       	call   801183 <syscall>
  801600:	83 c4 18             	add    $0x18,%esp
}
  801603:	c9                   	leave  
  801604:	c3                   	ret    

00801605 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801611:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  ...
  801620:	e8 5e fb ff ff       	call   801183 <syscall>
...
void rsttst()
{
  ...
  801638:	6a 28                	push   $0x28
  80163a:	e8 44 fb ff ff       	call   801183 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801651:	8b 55 18             	mov    0x18(%ebp),%edx
  801654:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  801658:	52                   	push   %edx
  801659:	50                   	push   %eax
  80165a:	ff 75 10             	pushl  0x10(%ebp)
  80165d:	ff 75 0c             	pushl  0xc(%ebp)
  801660:	ff 75 08             	pushl  0x8(%ebp)
  801663:	6a 27                	push   $0x27
  801665:	e8 19 fb ff ff       	call   801183 <syscall>
...
void chktst(uint32 n)
{
  ...
  80167e:	6a 29                	push   $0x29
  801680:	e8 fe fa ff ff       	call   801183 <syscall>
...
void inctst()
{
  ...
  80169a:	e8 e4 fa ff ff       	call   801183 <syscall>
...
uint32 gettst()
{
  ...
  8016b2:	6a 2b                	push   $0x2b
  8016b4:	e8 ca fa ff ff       	call   801183 <syscall>
  8016b9:	83 c4 18             	add    $0x18,%esp
}
  8016bc:	c9                   	leave  
  8016bd:	c3                   	ret    

008016be <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8016ce:	6a 2c                	push   $0x2c
  8016d0:	e8 ae fa ff ff       	call   801183 <syscall>
  8016d5:	83 c4 18             	add    $0x18,%esp
  8016d8:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8016db:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8016df:	75 07                	jne    8016e8 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8016e1:	b8 01 00 00 00       	mov    $0x1,%eax
  8016e6:	eb 05                	jmp    8016ed <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
008016ef <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  8016ff:	6a 2c                	push   $0x2c
  801701:	e8 7d fa ff ff       	call   801183 <syscall>
  801706:	83 c4 18             	add    $0x18,%esp
  801709:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  80170c:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801710:	75 07                	jne    801719 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801712:	b8 01 00 00 00       	mov    $0x1,%eax
  801717:	eb 05                	jmp    80171e <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801720 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801730:	6a 2c                	push   $0x2c
  801732:	e8 4c fa ff ff       	call   801183 <syscall>
  801737:	83 c4 18             	add    $0x18,%esp
  80173a:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  80173d:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801741:	75 07                	jne    80174a <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801743:	b8 01 00 00 00       	mov    $0x1,%eax
  801748:	eb 05                	jmp    80174f <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801751 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801761:	6a 2c                	push   $0x2c
  801763:	e8 1b fa ff ff       	call   801183 <syscall>
  801768:	83 c4 18             	add    $0x18,%esp
  80176b:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  80176e:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801772:	75 07                	jne    80177b <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801774:	b8 01 00 00 00       	mov    $0x1,%eax
  801779:	eb 05                	jmp    801780 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801782 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801790:	6a 2d                	push   $0x2d
  801792:	e8 ec f9 ff ff       	call   801183 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8017b1:	52                   	push   %edx
  8017b2:	50                   	push   %eax
  8017b3:	6a 2e                	push   $0x2e
  8017b5:	e8 c9 f9 ff ff       	call   801183 <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8017d1:	52                   	push   %edx
  8017d2:	50                   	push   %eax
  8017d3:	6a 2f                	push   $0x2f
  8017d5:	e8 a9 f9 ff ff       	call   801183 <syscall>
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8017e2:	83 ec 18             	sub    $0x18,%esp
	va_list ap;
	va_start(ap, fmt);
  8017e5:	8d 45 10             	lea    0x10(%ebp),%eax
  8017e8:	83 c0 04             	add    $0x4,%eax
  8017eb:	89 45 f4             	mov    %eax,-0xc(%ebp)
	// Print the panic message
	if (argv0)
  8017ee:	a1 18 31 80 00       	mov    0x803118,%eax
  8017f3:	85 c0                	test   %eax,%eax
  8017f5:	74 16                	je     80180d <_panic+0x2e>
		cprintf("%s: ", argv0);
  8017f7:	a1 18 31 80 00       	mov    0x803118,%eax
  8017fc:	83 ec 08             	sub    $0x8,%esp
  8017ff:	50                   	push   %eax
  801800:	68 80 21 80 00       	push   $0x802180
  801805:	e8 47 eb ff ff       	call   800351 <cprintf>
  80180a:	83 c4 10             	add    $0x10,%esp
	cprintf("user panic in %s at %s:%d: ", binaryname, file, line);
  80180d:	a1 00 30 80 00       	mov    0x803000,%eax
  801812:	ff 75 0c             	pushl  0xc(%ebp)
  801815:	ff 75 08             	pushl  0x8(%ebp)
  801818:	50                   	push   %eax
  801819:	68 85 21 80 00       	push   $0x802185
  80181e:	e8 2e eb ff ff       	call   800351 <cprintf>
  ...
  80182f:	50                   	push   %eax
  801830:	e8 b1 ea ff ff       	call   8002e6 <vcprintf>
  801835:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  801838:	83 ec 08             	sub    $0x8,%esp
  80183b:	6a 00                	push   $0x0
  80183d:	68 a1 21 80 00       	push   $0x8021a1
  801842:	e8 9f ea ff ff       	call   8002e6 <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  80184a:	e8 20 ea ff ff       	call   80026f <exit>

	// should not return here
	while (1) ;
  80184f:	eb fe                	jmp    80184f <_panic+0x70>

00801851 <CheckWSWithoutLastIndex>:
}
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  801857:	a1 20 30 80 00       	mov    0x803020,%eax
  80185c:	8b 50 74             	mov    0x74(%eax),%edx
  80185f:	8b 45 0c             	mov    0xc(%ebp),%eax
  801862:	39 c2                	cmp    %eax,%edx
  801864:	74 14                	je     80187a <CheckWSWithoutLastIndex+0x29>
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
  801866:	83 ec 04             	sub    $0x4,%esp
  801869:	68 a4 21 80 00       	push   $0x8021a4
  80186e:	6a 26                	push   $0x26
  801870:	68 f0 21 80 00       	push   $0x8021f0
  801875:	e8 65 ff ff ff       	call   8017df <_panic>
	}
	int expectedNumOfEmptyLocs = 0;
  80187a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int e = 0; e < arraySize; e++) {
  801881:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801888:	e9 b6 00 00 00       	jmp    801943 <CheckWSWithoutLastIndex+0xf2>
		if (expectedPages[e] == 0) {
  80188d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801890:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801897:	8b 45 08             	mov    0x8(%ebp),%eax
  80189a:	01 d0                	add    %edx,%eax
  80189c:	8b 00                	mov    (%eax),%eax
  80189e:	85 c0                	test   %eax,%eax
  8018a0:	75 08                	jne    8018aa <CheckWSWithoutLastIndex+0x59>
			expectedNumOfEmptyLocs++;
  8018a2:	ff 45 f4             	incl   -0xc(%ebp)
			continue;
  8018a5:	e9 96 00 00 00       	jmp    801940 <CheckWSWithoutLastIndex+0xef>
		}
		int found = 0;
  8018aa:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  8018b1:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  8018b8:	eb 5d                	jmp    801917 <CheckWSWithoutLastIndex+0xc6>
			if (myEnv->__uptr_pws[w].empty == 0) {
  8018ba:	a1 20 30 80 00       	mov    0x803020,%eax
  8018bf:	8b 80 80 3c 01 00    	mov    0x13c80(%eax),%eax
  8018c5:	8b 55 e8             	mov    -0x18(%ebp),%edx
  8018c8:	c1 e2 04             	shl    $0x4,%edx
  8018cb:	01 d0                	add    %edx,%eax
  8018cd:	8a 40 04             	mov    0x4(%eax),%al
  8018d0:	84 c0                	test   %al,%al
  8018d2:	75 40                	jne    801914 <CheckWSWithoutLastIndex+0xc3>
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  8018d4:	a1 20 30 80 00       	mov    0x803020,%eax
  8018d9:	8b 80 80 3c 01 00    	mov    0x13c80(%eax),%eax
  8018df:	8b 55 e8             	mov    -0x18(%ebp),%edx
  8018e2:	c1 e2 04             	shl    $0x4,%edx
  8018e5:	01 d0                	add    %edx,%eax
  8018e7:	8b 00                	mov    (%eax),%eax
  8018e9:	89 45 dc             	mov    %eax,-0x24(%ebp)
  8018ec:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8018ef:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  8018f4:	89 c2                	mov    %eax,%edx
						== expectedPages[e]) {
  8018f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8018f9:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  ...
  801905:	8b 00                	mov    (%eax),%eax
		...
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
			if (myEnv->__uptr_pws[w].empty == 0) {
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  801907:	39 c2                	cmp    %eax,%edx
  801909:	75 09                	jne    801914 <CheckWSWithoutLastIndex+0xc3>
						== expectedPages[e]) {
					found = 1;
  80190b:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
					break;
  801912:	eb 12                	jmp    801926 <CheckWSWithoutLastIndex+0xd5>
		if (expectedPages[e] == 0) {
			expectedNumOfEmptyLocs++;
			continue;
		}
		int found = 0;
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801914:	ff 45 e8             	incl   -0x18(%ebp)
  801917:	a1 20 30 80 00       	mov    0x803020,%eax
  80191c:	8b 50 74             	mov    0x74(%eax),%edx
  80191f:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801922:	39 c2                	cmp    %eax,%edx
  801924:	77 94                	ja     8018ba <CheckWSWithoutLastIndex+0x69>
					found = 1;
					break;
				}
			}
  ...
  80192a:	75 14                	jne    801940 <CheckWSWithoutLastIndex+0xef>
			panic(
  80192c:	83 ec 04             	sub    $0x4,%esp
  80192f:	68 fc 21 80 00       	push   $0x8021fc
  801934:	6a 3a                	push   $0x3a
  801936:	68 f0 21 80 00       	push   $0x8021f0
  80193b:	e8 9f fe ff ff       	call   8017df <_panic>
	if (arraySize != myEnv->page_WS_max_size)
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
	}
  ...
  801949:	0f 8c 3e ff ff ff    	jl     80188d <CheckWSWithoutLastIndex+0x3c>
		}
		if (!found)
			panic(
  ...
  80195d:	eb 20                	jmp    80197f <CheckWSWithoutLastIndex+0x12e>
		if (myEnv->__uptr_pws[w].empty == 1) {
  80195f:	a1 20 30 80 00       	mov    0x803020,%eax
  801964:	8b 80 80 3c 01 00    	mov    0x13c80(%eax),%eax
  80196a:	8b 55 e0             	mov    -0x20(%ebp),%edx
  80196d:	c1 e2 04             	shl    $0x4,%edx
  801970:	01 d0                	add    %edx,%eax
  801972:	8a 40 04             	mov    0x4(%eax),%al
  801975:	3c 01                	cmp    $0x1,%al
  801977:	75 03                	jne    80197c <CheckWSWithoutLastIndex+0x12b>
			actualNumOfEmptyLocs++;
  801979:	ff 45 e4             	incl   -0x1c(%ebp)
		if (!found)
			panic(
					"PAGE WS entry checking failed... trace it by printing page WS before & after fault");
	}
	int actualNumOfEmptyLocs = 0;
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  80197c:	ff 45 e0             	incl   -0x20(%ebp)
  80197f:	a1 20 30 80 00       	mov    0x803020,%eax
  801984:	8b 50 74             	mov    0x74(%eax),%edx
  801987:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80198a:	39 c2                	cmp    %eax,%edx
  80198c:	77 d1                	ja     80195f <CheckWSWithoutLastIndex+0x10e>
		if (myEnv->__uptr_pws[w].empty == 1) {
			actualNumOfEmptyLocs++;
		}
	}
  ...
  801991:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
  801994:	74 14                	je     8019aa <CheckWSWithoutLastIndex+0x159>
		panic(
  801996:	83 ec 04             	sub    $0x4,%esp
  801999:	68 50 22 80 00       	push   $0x802250
  80199e:	6a 44                	push   $0x44
  8019a0:	68 f0 21 80 00       	push   $0x8021f0
  8019a5:	e8 35 fe ff ff       	call   8017df <_panic>
