...
void _main(void)
{
  ...
  80036f:	e8 a5 18 00 00       	call   801c19 <env_sleep>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  80198e:	50                   	push   %eax
  80198f:	6a 21                	push   $0x21
  801991:	e8 27 fc ff ff       	call   8015bd <syscall>
  801996:	83 c4 18             	add    $0x18,%esp
}
  801999:	c9                   	leave  
  80199a:	c3                   	ret    

0080199b <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  8019ac:	e8 0c fc ff ff       	call   8015bd <syscall>
...
sys_free_env(int32 envId)
{
  ...
  8019c8:	e8 f0 fb ff ff       	call   8015bd <syscall>
...
sys_get_virtual_time()
{
  ...
  8019d9:	8d 45 f8             	lea    -0x8(%ebp),%eax
  ...
  8019e8:	52                   	push   %edx
  8019e9:	50                   	push   %eax
  8019ea:	6a 24                	push   $0x24
  8019ec:	e8 cc fb ff ff       	call   8015bd <syscall>
  ...
  8019fd:	89 01                	mov    %eax,(%ecx)
  8019ff:	89 51 04             	mov    %edx,0x4(%ecx)
}
  801a02:	8b 45 08             	mov    0x8(%ebp),%eax
  801a05:	c9                   	leave  
  801a06:	c2 04 00             	ret    $0x4

00801a09 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801a19:	6a 13                	push   $0x13
  801a1b:	e8 9d fb ff ff       	call   8015bd <syscall>
...
uint32 sys_rcr2()
{
  ...
  801a33:	6a 25                	push   $0x25
  801a35:	e8 83 fb ff ff       	call   8015bd <syscall>
  801a3a:	83 c4 18             	add    $0x18,%esp
}
  801a3d:	c9                   	leave  
  801a3e:	c3                   	ret    

00801a3f <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801a4b:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  801a4f:	6a 00                	push   $0x0
  801a51:	6a 00                	push   $0x0
  801a53:	6a 00                	push   $0x0
  801a55:	6a 00                	push   $0x0
  801a57:	50                   	push   %eax
  801a58:	6a 26                	push   $0x26
...
void rsttst()
{
  ...
  801a72:	6a 28                	push   $0x28
  801a74:	e8 44 fb ff ff       	call   8015bd <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801a8b:	8b 55 18             	mov    0x18(%ebp),%edx
  ...
  801a9d:	6a 27                	push   $0x27
  801a9f:	e8 19 fb ff ff       	call   8015bd <syscall>
...
void chktst(uint32 n)
{
  ...
  801ab8:	6a 29                	push   $0x29
  801aba:	e8 fe fa ff ff       	call   8015bd <syscall>
...
void inctst()
{
  ...
  801ad2:	6a 2a                	push   $0x2a
  801ad4:	e8 e4 fa ff ff       	call   8015bd <syscall>
...
uint32 gettst()
{
  ...
  801aec:	6a 2b                	push   $0x2b
  801aee:	e8 ca fa ff ff       	call   8015bd <syscall>
  801af3:	83 c4 18             	add    $0x18,%esp
}
  801af6:	c9                   	leave  
  801af7:	c3                   	ret    

00801af8 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801b08:	6a 2c                	push   $0x2c
  801b0a:	e8 ae fa ff ff       	call   8015bd <syscall>
  801b0f:	83 c4 18             	add    $0x18,%esp
  801b12:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801b15:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801b19:	75 07                	jne    801b22 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801b1b:	b8 01 00 00 00       	mov    $0x1,%eax
  801b20:	eb 05                	jmp    801b27 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801b29 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801b3b:	e8 7d fa ff ff       	call   8015bd <syscall>
  801b40:	83 c4 18             	add    $0x18,%esp
  801b43:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  801b46:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801b4a:	75 07                	jne    801b53 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801b4c:	b8 01 00 00 00       	mov    $0x1,%eax
  801b51:	eb 05                	jmp    801b58 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801b5a <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801b6c:	e8 4c fa ff ff       	call   8015bd <syscall>
  801b71:	83 c4 18             	add    $0x18,%esp
  801b74:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  801b77:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801b7b:	75 07                	jne    801b84 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801b7d:	b8 01 00 00 00       	mov    $0x1,%eax
  801b82:	eb 05                	jmp    801b89 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801b8b <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801b9d:	e8 1b fa ff ff       	call   8015bd <syscall>
  801ba2:	83 c4 18             	add    $0x18,%esp
  801ba5:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801ba8:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801bac:	75 07                	jne    801bb5 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801bae:	b8 01 00 00 00       	mov    $0x1,%eax
  801bb3:	eb 05                	jmp    801bba <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801bbc <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801bca:	6a 2d                	push   $0x2d
  801bcc:	e8 ec f9 ff ff       	call   8015bd <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801beb:	52                   	push   %edx
  801bec:	50                   	push   %eax
  801bed:	6a 2e                	push   $0x2e
  801bef:	e8 c9 f9 ff ff       	call   8015bd <syscall>
...
00801bfc <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801c0b:	52                   	push   %edx
  801c0c:	50                   	push   %eax
  801c0d:	6a 2f                	push   $0x2f
  801c0f:	e8 a9 f9 ff ff       	call   8015bd <syscall>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801c57:	50                   	push   %eax
  801c58:	e8 76 fd ff ff       	call   8019d3 <sys_get_virtual_time>
  ...
  801c68:	50                   	push   %eax
  801c69:	e8 65 fd ff ff       	call   8019d3 <sys_get_virtual_time>
