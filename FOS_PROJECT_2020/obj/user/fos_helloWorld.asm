...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8013de:	e8 27 fc ff ff       	call   80100a <syscall>
  8013e3:	83 c4 18             	add    $0x18,%esp
}
  8013e6:	c9                   	leave  
  8013e7:	c3                   	ret    

008013e8 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  8013f6:	50                   	push   %eax
  8013f7:	6a 22                	push   $0x22
  8013f9:	e8 0c fc ff ff       	call   80100a <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801415:	e8 f0 fb ff ff       	call   80100a <syscall>
...
sys_get_virtual_time()
{
  ...
  801426:	8d 45 f8             	lea    -0x8(%ebp),%eax
  ...
  801435:	52                   	push   %edx
  801436:	50                   	push   %eax
  801437:	6a 24                	push   $0x24
  801439:	e8 cc fb ff ff       	call   80100a <syscall>
  ...
  80144c:	89 51 04             	mov    %edx,0x4(%ecx)
}
  80144f:	8b 45 08             	mov    0x8(%ebp),%eax
  801452:	c9                   	leave  
  801453:	c2 04 00             	ret    $0x4

00801456 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801466:	6a 13                	push   $0x13
  801468:	e8 9d fb ff ff       	call   80100a <syscall>
...
uint32 sys_rcr2()
{
  ...
  801480:	6a 25                	push   $0x25
  801482:	e8 83 fb ff ff       	call   80100a <syscall>
  801487:	83 c4 18             	add    $0x18,%esp
}
  80148a:	c9                   	leave  
  80148b:	c3                   	ret    

0080148c <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801498:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  80149c:	6a 00                	push   $0x0
  80149e:	6a 00                	push   $0x0
  8014a0:	6a 00                	push   $0x0
  8014a2:	6a 00                	push   $0x0
  8014a4:	50                   	push   %eax
  8014a5:	6a 26                	push   $0x26
  8014a7:	e8 5e fb ff ff       	call   80100a <syscall>
...
void rsttst()
{
  ...
  8014bf:	6a 28                	push   $0x28
  8014c1:	e8 44 fb ff ff       	call   80100a <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8014d8:	8b 55 18             	mov    0x18(%ebp),%edx
  8014db:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  8014df:	52                   	push   %edx
  8014e0:	50                   	push   %eax
  8014e1:	ff 75 10             	pushl  0x10(%ebp)
  8014e4:	ff 75 0c             	pushl  0xc(%ebp)
  8014e7:	ff 75 08             	pushl  0x8(%ebp)
  8014ea:	6a 27                	push   $0x27
  8014ec:	e8 19 fb ff ff       	call   80100a <syscall>
...
void chktst(uint32 n)
{
  ...
  801505:	6a 29                	push   $0x29
  801507:	e8 fe fa ff ff       	call   80100a <syscall>
...
void inctst()
{
  ...
  801521:	e8 e4 fa ff ff       	call   80100a <syscall>
...
uint32 gettst()
{
  ...
  801539:	6a 2b                	push   $0x2b
  80153b:	e8 ca fa ff ff       	call   80100a <syscall>
  801540:	83 c4 18             	add    $0x18,%esp
}
  801543:	c9                   	leave  
  801544:	c3                   	ret    

00801545 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801555:	6a 2c                	push   $0x2c
  801557:	e8 ae fa ff ff       	call   80100a <syscall>
  80155c:	83 c4 18             	add    $0x18,%esp
  80155f:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801562:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801566:	75 07                	jne    80156f <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801568:	b8 01 00 00 00       	mov    $0x1,%eax
  80156d:	eb 05                	jmp    801574 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801576 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801588:	e8 7d fa ff ff       	call   80100a <syscall>
  80158d:	83 c4 18             	add    $0x18,%esp
  801590:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  801593:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801597:	75 07                	jne    8015a0 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801599:	b8 01 00 00 00       	mov    $0x1,%eax
  80159e:	eb 05                	jmp    8015a5 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
008015a7 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  8015b9:	e8 4c fa ff ff       	call   80100a <syscall>
  8015be:	83 c4 18             	add    $0x18,%esp
  8015c1:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  8015c4:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  8015c8:	75 07                	jne    8015d1 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  8015ca:	b8 01 00 00 00       	mov    $0x1,%eax
  8015cf:	eb 05                	jmp    8015d6 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
008015d8 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  8015ea:	e8 1b fa ff ff       	call   80100a <syscall>
  8015ef:	83 c4 18             	add    $0x18,%esp
  8015f2:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  8015f5:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  8015f9:	75 07                	jne    801602 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  8015fb:	b8 01 00 00 00       	mov    $0x1,%eax
  801600:	eb 05                	jmp    801607 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801609 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801619:	e8 ec f9 ff ff       	call   80100a <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  80163c:	e8 c9 f9 ff ff       	call   80100a <syscall>
...
00801649 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801658:	52                   	push   %edx
  801659:	50                   	push   %eax
  80165a:	6a 2f                	push   $0x2f
  80165c:	e8 a9 f9 ff ff       	call   80100a <syscall>
