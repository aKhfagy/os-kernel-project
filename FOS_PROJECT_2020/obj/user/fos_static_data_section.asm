	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800307:	e8 44 13 00 00       	call   801650 <__udivdi3>
  ...
  800355:	52                   	push   %edx
  800356:	50                   	push   %eax
  800357:	e8 04 14 00 00       	call   801760 <__umoddi3>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8013c5:	50                   	push   %eax
  8013c6:	6a 21                	push   $0x21
  8013c8:	e8 27 fc ff ff       	call   800ff4 <syscall>
...
sys_run_env(int32 envId)
{
  ...
  8013e0:	50                   	push   %eax
  8013e1:	6a 22                	push   $0x22
  8013e3:	e8 0c fc ff ff       	call   800ff4 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  8013fc:	50                   	push   %eax
  8013fd:	6a 23                	push   $0x23
  8013ff:	e8 f0 fb ff ff       	call   800ff4 <syscall>
...
sys_get_virtual_time()
{
  ...
  80141f:	52                   	push   %edx
  801420:	50                   	push   %eax
  801421:	6a 24                	push   $0x24
  801423:	e8 cc fb ff ff       	call   800ff4 <syscall>
  ...
  80143c:	c9                   	leave  
  80143d:	c2 04 00             	ret    $0x4

00801440 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801450:	6a 13                	push   $0x13
  801452:	e8 9d fb ff ff       	call   800ff4 <syscall>
...
uint32 sys_rcr2()
{
  ...
  80146a:	6a 25                	push   $0x25
  80146c:	e8 83 fb ff ff       	call   800ff4 <syscall>
  801471:	83 c4 18             	add    $0x18,%esp
}
  801474:	c9                   	leave  
  801475:	c3                   	ret    

00801476 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801482:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  801486:	6a 00                	push   $0x0
  801488:	6a 00                	push   $0x0
  80148a:	6a 00                	push   $0x0
  80148c:	6a 00                	push   $0x0
  80148e:	50                   	push   %eax
  80148f:	6a 26                	push   $0x26
  801491:	e8 5e fb ff ff       	call   800ff4 <syscall>
...
void rsttst()
{
  ...
  8014a9:	6a 28                	push   $0x28
  8014ab:	e8 44 fb ff ff       	call   800ff4 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8014c2:	8b 55 18             	mov    0x18(%ebp),%edx
  8014c5:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  8014c9:	52                   	push   %edx
  8014ca:	50                   	push   %eax
  8014cb:	ff 75 10             	pushl  0x10(%ebp)
  8014ce:	ff 75 0c             	pushl  0xc(%ebp)
  8014d1:	ff 75 08             	pushl  0x8(%ebp)
  8014d4:	6a 27                	push   $0x27
  8014d6:	e8 19 fb ff ff       	call   800ff4 <syscall>
...
void chktst(uint32 n)
{
  ...
  8014ef:	6a 29                	push   $0x29
  8014f1:	e8 fe fa ff ff       	call   800ff4 <syscall>
...
void inctst()
{
  ...
  80150b:	e8 e4 fa ff ff       	call   800ff4 <syscall>
...
uint32 gettst()
{
  ...
  801523:	6a 2b                	push   $0x2b
  801525:	e8 ca fa ff ff       	call   800ff4 <syscall>
  80152a:	83 c4 18             	add    $0x18,%esp
}
  80152d:	c9                   	leave  
  80152e:	c3                   	ret    

0080152f <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  80153f:	6a 2c                	push   $0x2c
  801541:	e8 ae fa ff ff       	call   800ff4 <syscall>
  801546:	83 c4 18             	add    $0x18,%esp
  801549:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  80154c:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801550:	75 07                	jne    801559 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801552:	b8 01 00 00 00       	mov    $0x1,%eax
  801557:	eb 05                	jmp    80155e <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801560 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801572:	e8 7d fa ff ff       	call   800ff4 <syscall>
  801577:	83 c4 18             	add    $0x18,%esp
  80157a:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  80157d:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801581:	75 07                	jne    80158a <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801583:	b8 01 00 00 00       	mov    $0x1,%eax
  801588:	eb 05                	jmp    80158f <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801591 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  8015a3:	e8 4c fa ff ff       	call   800ff4 <syscall>
  8015a8:	83 c4 18             	add    $0x18,%esp
  8015ab:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  8015ae:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  8015b2:	75 07                	jne    8015bb <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  8015b4:	b8 01 00 00 00       	mov    $0x1,%eax
  8015b9:	eb 05                	jmp    8015c0 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
008015c2 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  8015d4:	e8 1b fa ff ff       	call   800ff4 <syscall>
  8015d9:	83 c4 18             	add    $0x18,%esp
  8015dc:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  8015df:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  8015e3:	75 07                	jne    8015ec <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  8015e5:	b8 01 00 00 00       	mov    $0x1,%eax
  8015ea:	eb 05                	jmp    8015f1 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
008015f3 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801603:	e8 ec f9 ff ff       	call   800ff4 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801622:	52                   	push   %edx
  801623:	50                   	push   %eax
  801624:	6a 2e                	push   $0x2e
  801626:	e8 c9 f9 ff ff       	call   800ff4 <syscall>
...
00801633 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801642:	52                   	push   %edx
  801643:	50                   	push   %eax
  801644:	6a 2f                	push   $0x2f
  801646:	e8 a9 f9 ff ff       	call   800ff4 <syscall>
