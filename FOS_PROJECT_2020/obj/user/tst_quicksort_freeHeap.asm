...
void _main(void)
{
  ...
  80004c:	e8 50 1e 00 00       	call   801ea1 <sys_disable_interrupt>
  ...
  8000aa:	e8 22 1d 00 00       	call   801dd1 <sys_calculate_free_frames>
  8000af:	89 c3                	mov    %eax,%ebx
  8000b1:	e8 34 1d 00 00       	call   801dea <sys_calculate_modified_frames>
  ...
  80011b:	68 b0 25 80 00       	push   $0x8025b0
  ...
  80015f:	e8 57 1d 00 00       	call   801ebb <sys_enable_interrupt>
		int  i ;
		switch (Chose)
  ...
  800266:	68 ac 26 80 00       	push   $0x8026ac
  80026b:	6a 69                	push   $0x69
  80026d:	68 de 25 80 00       	push   $0x8025de
  ...
  80028b:	e8 41 1b 00 00       	call   801dd1 <sys_calculate_free_frames>
  800290:	89 c3                	mov    %eax,%ebx
  800292:	e8 53 1b 00 00       	call   801dea <sys_calculate_modified_frames>
  ...
  8002b0:	68 fc 26 80 00       	push   $0x8026fc
  8002b5:	68 21 27 80 00       	push   $0x802721
  8002ba:	6a 6d                	push   $0x6d
  8002bc:	68 de 25 80 00       	push   $0x8025de
  ...
  8002de:	68 ac 26 80 00       	push   $0x8026ac
  8002e3:	6a 72                	push   $0x72
  8002e5:	68 de 25 80 00       	push   $0x8025de
  ...
  800300:	89 45 d4             	mov    %eax,-0x2c(%ebp)
			int CurrFreeFrames = sys_calculate_free_frames() + sys_calculate_modified_frames() - numOFEmptyLocInWS;
  800303:	e8 c9 1a 00 00       	call   801dd1 <sys_calculate_free_frames>
  800308:	89 c3                	mov    %eax,%ebx
  80030a:	e8 db 1a 00 00       	call   801dea <sys_calculate_modified_frames>
  ...
  800328:	68 fc 26 80 00       	push   $0x8026fc
  80032d:	68 21 27 80 00       	push   $0x802721
  800332:	6a 76                	push   $0x76
  800334:	68 de 25 80 00       	push   $0x8025de
  ...
  800356:	68 ac 26 80 00       	push   $0x8026ac
  80035b:	6a 7b                	push   $0x7b
  80035d:	68 de 25 80 00       	push   $0x8025de
  ...
  800378:	89 45 cc             	mov    %eax,-0x34(%ebp)
			int CurrFreeFrames = sys_calculate_free_frames() + sys_calculate_modified_frames() - numOFEmptyLocInWS;
  80037b:	e8 51 1a 00 00       	call   801dd1 <sys_calculate_free_frames>
  800380:	89 c3                	mov    %eax,%ebx
  800382:	e8 63 1a 00 00       	call   801dea <sys_calculate_modified_frames>
  ...
  80039c:	68 fc 26 80 00       	push   $0x8026fc
  8003a1:	68 21 27 80 00       	push   $0x802721
  8003a6:	68 80 00 00 00       	push   $0x80
  8003ab:	68 de 25 80 00       	push   $0x8025de
  8003b0:	e8 d6 05 00 00       	call   80098b <_panic>
		}
		///========================================================================
	sys_disable_interrupt();
  8003b5:	e8 e7 1a 00 00       	call   801ea1 <sys_disable_interrupt>
		Chose = 0 ;
  ...
  8003c3:	68 36 27 80 00       	push   $0x802736
  ...
  80040c:	75 b2                	jne    8003c0 <_main+0x388>
	...
	sys_enable_interrupt();
  80040e:	e8 a8 1a 00 00       	call   801ebb <sys_enable_interrupt>
...
int CheckAndCountEmptyLocInWS(volatile struct Env *myEnv)
{
  ...
  80048a:	68 54 27 80 00       	push   $0x802754
  80048f:	68 9f 00 00 00       	push   $0x9f
  800494:	68 de 25 80 00       	push   $0x8025de
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800746:	68 82 27 80 00       	push   $0x802782
  ...
  800767:	50                   	push   %eax
  800768:	68 84 27 80 00       	push   $0x802784
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800795:	50                   	push   %eax
  800796:	68 89 27 80 00       	push   $0x802789
...
cputchar(int ch)
{
  ...
  8007b9:	50                   	push   %eax
  8007ba:	e8 16 17 00 00       	call   801ed5 <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  8007c8:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8007cb:	e8 d1 16 00 00       	call   801ea1 <sys_disable_interrupt>
	char c = ch;
  ...
  8007dd:	50                   	push   %eax
  8007de:	e8 f2 16 00 00       	call   801ed5 <sys_cputc>
  8007e3:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8007e6:	e8 d0 16 00 00       	call   801ebb <sys_enable_interrupt>
}
  8007eb:	90                   	nop
  8007ec:	c9                   	leave  
  8007ed:	c3                   	ret    
...
getchar(void)
{
  ...
  8007fb:	eb 08                	jmp    800805 <getchar+0x17>
	{
		c = sys_cgetc();
  8007fd:	e8 b7 14 00 00       	call   801cb9 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800813:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800816:	e8 86 16 00 00       	call   801ea1 <sys_disable_interrupt>
	int c=0;
  ...
  800822:	eb 08                	jmp    80082c <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  800824:	e8 90 14 00 00       	call   801cb9 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800830:	74 f2                	je     800824 <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  800832:	e8 84 16 00 00       	call   801ebb <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  80084c:	e8 b5 14 00 00       	call   801d06 <sys_getenvindex>
  ...
  8008c6:	83 c4 10             	add    $0x10,%esp
	...
	sys_disable_interrupt();
  8008c9:	e8 d3 15 00 00       	call   801ea1 <sys_disable_interrupt>
	cprintf("**************************************\n");
  8008ce:	83 ec 0c             	sub    $0xc,%esp
  8008d1:	68 a8 27 80 00       	push   $0x8027a8
  ...
  8008f7:	52                   	push   %edx
  8008f8:	50                   	push   %eax
  8008f9:	68 d0 27 80 00       	push   $0x8027d0
  ...
  80091f:	52                   	push   %edx
  800920:	50                   	push   %eax
  800921:	68 f8 27 80 00       	push   $0x8027f8
...
destroy(void)
{
  ...
  800972:	e8 5b 13 00 00       	call   801cd2 <sys_env_destroy>
...
exit(void)
{
  ...
  800980:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  800983:	e8 b0 13 00 00       	call   801d38 <sys_env_exit>
}
  800988:	90                   	nop
  800989:	c9                   	leave  
  80098a:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8009ab:	50                   	push   %eax
  8009ac:	68 50 28 80 00       	push   $0x802850
  ...
  8009c4:	50                   	push   %eax
  8009c5:	68 55 28 80 00       	push   $0x802855
  ...
  8009e9:	68 71 28 80 00       	push   $0x802871
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800a15:	68 74 28 80 00       	push   $0x802874
  800a1a:	6a 26                	push   $0x26
  800a1c:	68 c0 28 80 00       	push   $0x8028c0
  ...
  800adb:	68 cc 28 80 00       	push   $0x8028cc
  800ae0:	6a 3a                	push   $0x3a
  800ae2:	68 c0 28 80 00       	push   $0x8028c0
  ...
  800b4c:	68 c0 28 80 00       	push   $0x8028c0
...
static void putch(int ch, struct printbuf *b) {
  ...
  800b9d:	51                   	push   %ecx
  800b9e:	52                   	push   %edx
  800b9f:	e8 ec 10 00 00       	call   801c90 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800c15:	50                   	push   %eax
  800c16:	e8 75 10 00 00       	call   801c90 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800c5d:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800c60:	e8 3c 12 00 00       	call   801ea1 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800c7d:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800c80:	e8 36 12 00 00       	call   801ebb <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800cca:	e8 f5 15 00 00       	call   8022c4 <__udivdi3>
  ...
  800d18:	52                   	push   %edx
  800d19:	50                   	push   %eax
  800d1a:	e8 b5 16 00 00       	call   8023d4 <__umoddi3>
  800d1f:	83 c4 10             	add    $0x10,%esp
  800d22:	05 94 2b 80 00       	add    $0x802b94,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800e75:	8b 04 85 b8 2b 80 00 	mov    0x802bb8(,%eax,4),%eax
  ...
  800f56:	8b 34 9d 00 2a 80 00 	mov    0x802a00(,%ebx,4),%esi
  800f5d:	85 f6                	test   %esi,%esi
  800f5f:	75 19                	jne    800f7a <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800f61:	53                   	push   %ebx
  800f62:	68 a5 2b 80 00       	push   $0x802ba5
  ...
  800f75:	e9 49 02 00 00       	jmp    8011c3 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800f7a:	56                   	push   %esi
  800f7b:	68 ae 2b 80 00       	push   $0x802bae
  ...
  800fa6:	75 05                	jne    800fad <vprintfmt+0x1a6>
				p = "(null)";
  800fa8:	be b1 2b 80 00       	mov    $0x802bb1,%esi
			if (width > 0 && padc != '-')
...
void readline(const char *prompt, char* buf)
{
  ...
  8012c1:	68 10 2d 80 00       	push   $0x802d10
  ...
  801303:	68 13 2d 80 00       	push   $0x802d13
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  8013b0:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8013b3:	e8 e9 0a 00 00       	call   801ea1 <sys_disable_interrupt>
	int i, c, echoing;
  ...
  8013c4:	68 10 2d 80 00       	push   $0x802d10
  ...
  801402:	68 13 2d 80 00       	push   $0x802d13
  801407:	e8 21 f8 ff ff       	call   800c2d <cprintf>
  80140c:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  80140f:	e8 a7 0a 00 00       	call   801ebb <sys_enable_interrupt>
			return;
  ...
  8014a4:	c6 00 00             	movb   $0x0,(%eax)
			sys_enable_interrupt();
  8014a7:	e8 0f 0a 00 00       	call   801ebb <sys_enable_interrupt>
			return;
...
void* malloc(uint32 size)
{
  ...
  801bc6:	68 24 2d 80 00       	push   $0x802d24
  801bcb:	6a 19                	push   $0x19
  801bcd:	68 49 2d 80 00       	push   $0x802d49
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801be0:	88 45 f4             	mov    %al,-0xc(%ebp)
	//TODO: [PROJECT 2020  - Shared Variables: Creation] smalloc() [User Side]
	// Write your code here, remove the panic and write your code
	panic("smalloc() is not implemented yet...!!");
  801be3:	83 ec 04             	sub    $0x4,%esp
  801be6:	68 58 2d 80 00       	push   $0x802d58
  801beb:	6a 31                	push   $0x31
  801bed:	68 49 2d 80 00       	push   $0x802d49
  801bf2:	e8 94 ed ff ff       	call   80098b <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801c00:	68 80 2d 80 00       	push   $0x802d80
  801c05:	6a 4a                	push   $0x4a
  801c07:	68 49 2d 80 00       	push   $0x802d49
...
void free(void* virtual_address)
{
  ...
  801c1a:	68 a4 2d 80 00       	push   $0x802da4
  801c1f:	6a 70                	push   $0x70
  801c21:	68 49 2d 80 00       	push   $0x802d49
...
void sfree(void* virtual_address)
{
  ...
  801c34:	68 c8 2d 80 00       	push   $0x802dc8
  801c39:	68 8b 00 00 00       	push   $0x8b
  801c3e:	68 49 2d 80 00       	push   $0x802d49
  801c43:	e8 43 ed ff ff       	call   80098b <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801c51:	68 ec 2d 80 00       	push   $0x802dec
  801c56:	68 a8 00 00 00       	push   $0xa8
  801c5b:	68 49 2d 80 00       	push   $0x802d49
  801c60:	e8 26 ed ff ff       	call   80098b <_panic>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  802297:	e8 c9 f9 ff ff       	call   801c65 <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8022b7:	e8 a9 f9 ff ff       	call   801c65 <syscall>
  8022bc:	83 c4 18             	add    $0x18,%esp
}
  8022bf:	c9                   	leave  
  8022c0:	c3                   	ret    
  8022c1:	66 90                	xchg   %ax,%ax
  8022c3:	90                   	nop
