...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  80142f:	e8 27 fc ff ff       	call   80105b <syscall>
  801434:	83 c4 18             	add    $0x18,%esp
}
  801437:	c9                   	leave  
  801438:	c3                   	ret    

00801439 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  801447:	50                   	push   %eax
  801448:	6a 22                	push   $0x22
  80144a:	e8 0c fc ff ff       	call   80105b <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801463:	50                   	push   %eax
  801464:	6a 23                	push   $0x23
  801466:	e8 f0 fb ff ff       	call   80105b <syscall>
...
sys_get_virtual_time()
{
  ...
  801477:	8d 45 f8             	lea    -0x8(%ebp),%eax
  80147a:	8d 50 04             	lea    0x4(%eax),%edx
  80147d:	8d 45 f8             	lea    -0x8(%ebp),%eax
  801480:	6a 00                	push   $0x0
  801482:	6a 00                	push   $0x0
  801484:	6a 00                	push   $0x0
  801486:	52                   	push   %edx
  801487:	50                   	push   %eax
  801488:	6a 24                	push   $0x24
  80148a:	e8 cc fb ff ff       	call   80105b <syscall>
  ...
  80149d:	89 51 04             	mov    %edx,0x4(%ecx)
}
  8014a0:	8b 45 08             	mov    0x8(%ebp),%eax
  8014a3:	c9                   	leave  
  8014a4:	c2 04 00             	ret    $0x4

008014a7 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8014b7:	6a 13                	push   $0x13
  8014b9:	e8 9d fb ff ff       	call   80105b <syscall>
...
uint32 sys_rcr2()
{
  ...
  8014d3:	e8 83 fb ff ff       	call   80105b <syscall>
  8014d8:	83 c4 18             	add    $0x18,%esp
}
  8014db:	c9                   	leave  
  8014dc:	c3                   	ret    

008014dd <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  8014e9:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  ...
  8014f8:	e8 5e fb ff ff       	call   80105b <syscall>
...
void rsttst()
{
  ...
  801510:	6a 28                	push   $0x28
  801512:	e8 44 fb ff ff       	call   80105b <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801529:	8b 55 18             	mov    0x18(%ebp),%edx
  80152c:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  801530:	52                   	push   %edx
  801531:	50                   	push   %eax
  801532:	ff 75 10             	pushl  0x10(%ebp)
  801535:	ff 75 0c             	pushl  0xc(%ebp)
  801538:	ff 75 08             	pushl  0x8(%ebp)
  80153b:	6a 27                	push   $0x27
  80153d:	e8 19 fb ff ff       	call   80105b <syscall>
...
void chktst(uint32 n)
{
  ...
  801556:	6a 29                	push   $0x29
  801558:	e8 fe fa ff ff       	call   80105b <syscall>
...
void inctst()
{
  ...
  801570:	6a 2a                	push   $0x2a
  801572:	e8 e4 fa ff ff       	call   80105b <syscall>
...
uint32 gettst()
{
  ...
  80158a:	6a 2b                	push   $0x2b
  80158c:	e8 ca fa ff ff       	call   80105b <syscall>
  801591:	83 c4 18             	add    $0x18,%esp
}
  801594:	c9                   	leave  
  801595:	c3                   	ret    

00801596 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8015a8:	e8 ae fa ff ff       	call   80105b <syscall>
  8015ad:	83 c4 18             	add    $0x18,%esp
  8015b0:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8015b3:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8015b7:	75 07                	jne    8015c0 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8015b9:	b8 01 00 00 00       	mov    $0x1,%eax
  8015be:	eb 05                	jmp    8015c5 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
008015c7 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  8015d9:	e8 7d fa ff ff       	call   80105b <syscall>
  8015de:	83 c4 18             	add    $0x18,%esp
  8015e1:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  8015e4:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  8015e8:	75 07                	jne    8015f1 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  8015ea:	b8 01 00 00 00       	mov    $0x1,%eax
  8015ef:	eb 05                	jmp    8015f6 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
008015f8 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  80160a:	e8 4c fa ff ff       	call   80105b <syscall>
  80160f:	83 c4 18             	add    $0x18,%esp
  801612:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  801615:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801619:	75 07                	jne    801622 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  80161b:	b8 01 00 00 00       	mov    $0x1,%eax
  801620:	eb 05                	jmp    801627 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801629 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  80163b:	e8 1b fa ff ff       	call   80105b <syscall>
  801640:	83 c4 18             	add    $0x18,%esp
  801643:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801646:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  80164a:	75 07                	jne    801653 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  80164c:	b8 01 00 00 00       	mov    $0x1,%eax
  801651:	eb 05                	jmp    801658 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801668:	6a 2d                	push   $0x2d
  80166a:	e8 ec f9 ff ff       	call   80105b <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801689:	52                   	push   %edx
  80168a:	50                   	push   %eax
  80168b:	6a 2e                	push   $0x2e
  80168d:	e8 c9 f9 ff ff       	call   80105b <syscall>
...
0080169a <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8016a9:	52                   	push   %edx
  8016aa:	50                   	push   %eax
  8016ab:	6a 2f                	push   $0x2f
  8016ad:	e8 a9 f9 ff ff       	call   80105b <syscall>
