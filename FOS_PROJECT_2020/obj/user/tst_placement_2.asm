...
void _main(void)
{
  ...
  8000f4:	50                   	push   %eax
  8000f5:	e8 3d 1a 00 00       	call   801b37 <sys_check_LRU_lists>
  ...
  80035e:	50                   	push   %eax
  80035f:	e8 d3 17 00 00       	call   801b37 <sys_check_LRU_lists>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8018ee:	50                   	push   %eax
  8018ef:	6a 21                	push   $0x21
  8018f1:	e8 27 fc ff ff       	call   80151d <syscall>
...
sys_run_env(int32 envId)
{
  ...
  801909:	50                   	push   %eax
  80190a:	6a 22                	push   $0x22
  80190c:	e8 0c fc ff ff       	call   80151d <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801925:	50                   	push   %eax
  801926:	6a 23                	push   $0x23
  801928:	e8 f0 fb ff ff       	call   80151d <syscall>
...
sys_get_virtual_time()
{
  ...
  801948:	52                   	push   %edx
  801949:	50                   	push   %eax
  80194a:	6a 24                	push   $0x24
  80194c:	e8 cc fb ff ff       	call   80151d <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  80197b:	e8 9d fb ff ff       	call   80151d <syscall>
...
uint32 sys_rcr2()
{
  ...
  801993:	6a 25                	push   $0x25
  801995:	e8 83 fb ff ff       	call   80151d <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  8019ba:	e8 5e fb ff ff       	call   80151d <syscall>
...
void rsttst()
{
  ...
  8019d2:	6a 28                	push   $0x28
  8019d4:	e8 44 fb ff ff       	call   80151d <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8019ff:	e8 19 fb ff ff       	call   80151d <syscall>
...
void chktst(uint32 n)
{
  ...
  801a18:	6a 29                	push   $0x29
  801a1a:	e8 fe fa ff ff       	call   80151d <syscall>
...
void inctst()
{
  ...
  801a32:	6a 2a                	push   $0x2a
  801a34:	e8 e4 fa ff ff       	call   80151d <syscall>
...
uint32 gettst()
{
  ...
  801a4c:	6a 2b                	push   $0x2b
  801a4e:	e8 ca fa ff ff       	call   80151d <syscall>
  801a53:	83 c4 18             	add    $0x18,%esp
}
  801a56:	c9                   	leave  
  801a57:	c3                   	ret    

00801a58 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801a6a:	e8 ae fa ff ff       	call   80151d <syscall>
  801a6f:	83 c4 18             	add    $0x18,%esp
  801a72:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801a75:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801a79:	75 07                	jne    801a82 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801a7b:	b8 01 00 00 00       	mov    $0x1,%eax
  801a80:	eb 05                	jmp    801a87 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801a89 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801a9b:	e8 7d fa ff ff       	call   80151d <syscall>
  801aa0:	83 c4 18             	add    $0x18,%esp
  801aa3:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  801aa6:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801aaa:	75 07                	jne    801ab3 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801aac:	b8 01 00 00 00       	mov    $0x1,%eax
  801ab1:	eb 05                	jmp    801ab8 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801aba <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801aca:	6a 2c                	push   $0x2c
  801acc:	e8 4c fa ff ff       	call   80151d <syscall>
  801ad1:	83 c4 18             	add    $0x18,%esp
  801ad4:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  801ad7:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801adb:	75 07                	jne    801ae4 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801add:	b8 01 00 00 00       	mov    $0x1,%eax
  801ae2:	eb 05                	jmp    801ae9 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801aeb <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801afb:	6a 2c                	push   $0x2c
  801afd:	e8 1b fa ff ff       	call   80151d <syscall>
  801b02:	83 c4 18             	add    $0x18,%esp
  801b05:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801b08:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801b0c:	75 07                	jne    801b15 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801b0e:	b8 01 00 00 00       	mov    $0x1,%eax
  801b13:	eb 05                	jmp    801b1a <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801b1c <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801b2a:	6a 2d                	push   $0x2d
  801b2c:	e8 ec f9 ff ff       	call   80151d <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801b3b:	8b 5d 14             	mov    0x14(%ebp),%ebx
  ...
  801b4f:	e8 c9 f9 ff ff       	call   80151d <syscall>
...
00801b5c <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801b6b:	52                   	push   %edx
  801b6c:	50                   	push   %eax
  801b6d:	6a 2f                	push   $0x2f
  801b6f:	e8 a9 f9 ff ff       	call   80151d <syscall>
