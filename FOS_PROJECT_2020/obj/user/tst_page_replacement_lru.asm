...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  80186e:	50                   	push   %eax
  80186f:	6a 21                	push   $0x21
  801871:	e8 27 fc ff ff       	call   80149d <syscall>
...
sys_run_env(int32 envId)
{
  ...
  80188c:	e8 0c fc ff ff       	call   80149d <syscall>
...
sys_free_env(int32 envId)
{
  ...
  8018a5:	50                   	push   %eax
  8018a6:	6a 23                	push   $0x23
  8018a8:	e8 f0 fb ff ff       	call   80149d <syscall>
...
sys_get_virtual_time()
{
  ...
  8018bc:	8d 50 04             	lea    0x4(%eax),%edx
  ...
  8018c8:	52                   	push   %edx
  8018c9:	50                   	push   %eax
  8018ca:	6a 24                	push   $0x24
  8018cc:	e8 cc fb ff ff       	call   80149d <syscall>
  8018d1:	83 c4 18             	add    $0x18,%esp
	return result;
  8018d4:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8018d7:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8018da:	8b 55 fc             	mov    -0x4(%ebp),%edx
  8018dd:	89 01                	mov    %eax,(%ecx)
  8018df:	89 51 04             	mov    %edx,0x4(%ecx)
}
  8018e2:	8b 45 08             	mov    0x8(%ebp),%eax
  8018e5:	c9                   	leave  
  8018e6:	c2 04 00             	ret    $0x4

008018e9 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8018fb:	e8 9d fb ff ff       	call   80149d <syscall>
...
uint32 sys_rcr2()
{
  ...
  801913:	6a 25                	push   $0x25
  801915:	e8 83 fb ff ff       	call   80149d <syscall>
  80191a:	83 c4 18             	add    $0x18,%esp
}
  80191d:	c9                   	leave  
  80191e:	c3                   	ret    

0080191f <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  80192b:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  ...
  80193a:	e8 5e fb ff ff       	call   80149d <syscall>
...
void rsttst()
{
  ...
  801952:	6a 28                	push   $0x28
  801954:	e8 44 fb ff ff       	call   80149d <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  80196b:	8b 55 18             	mov    0x18(%ebp),%edx
  80196e:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  801972:	52                   	push   %edx
  801973:	50                   	push   %eax
  801974:	ff 75 10             	pushl  0x10(%ebp)
  801977:	ff 75 0c             	pushl  0xc(%ebp)
  80197a:	ff 75 08             	pushl  0x8(%ebp)
  80197d:	6a 27                	push   $0x27
  80197f:	e8 19 fb ff ff       	call   80149d <syscall>
...
void chktst(uint32 n)
{
  ...
  801998:	6a 29                	push   $0x29
  80199a:	e8 fe fa ff ff       	call   80149d <syscall>
...
void inctst()
{
  ...
  8019b2:	6a 2a                	push   $0x2a
  8019b4:	e8 e4 fa ff ff       	call   80149d <syscall>
...
uint32 gettst()
{
  ...
  8019cc:	6a 2b                	push   $0x2b
  8019ce:	e8 ca fa ff ff       	call   80149d <syscall>
  8019d3:	83 c4 18             	add    $0x18,%esp
}
  8019d6:	c9                   	leave  
  8019d7:	c3                   	ret    

008019d8 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8019ea:	e8 ae fa ff ff       	call   80149d <syscall>
  8019ef:	83 c4 18             	add    $0x18,%esp
  8019f2:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8019f5:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8019f9:	75 07                	jne    801a02 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8019fb:	b8 01 00 00 00       	mov    $0x1,%eax
  801a00:	eb 05                	jmp    801a07 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801a09 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801a1b:	e8 7d fa ff ff       	call   80149d <syscall>
  801a20:	83 c4 18             	add    $0x18,%esp
  801a23:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  801a26:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801a2a:	75 07                	jne    801a33 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801a2c:	b8 01 00 00 00       	mov    $0x1,%eax
  801a31:	eb 05                	jmp    801a38 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801a3a <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801a4a:	6a 2c                	push   $0x2c
  801a4c:	e8 4c fa ff ff       	call   80149d <syscall>
  801a51:	83 c4 18             	add    $0x18,%esp
  801a54:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  801a57:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801a5b:	75 07                	jne    801a64 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801a5d:	b8 01 00 00 00       	mov    $0x1,%eax
  801a62:	eb 05                	jmp    801a69 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801a6b <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801a7b:	6a 2c                	push   $0x2c
  801a7d:	e8 1b fa ff ff       	call   80149d <syscall>
  801a82:	83 c4 18             	add    $0x18,%esp
  801a85:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801a88:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801a8c:	75 07                	jne    801a95 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801a8e:	b8 01 00 00 00       	mov    $0x1,%eax
  801a93:	eb 05                	jmp    801a9a <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801a9c <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801aaa:	6a 2d                	push   $0x2d
  801aac:	e8 ec f9 ff ff       	call   80149d <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801abb:	8b 5d 14             	mov    0x14(%ebp),%ebx
  ...
  801acb:	52                   	push   %edx
  801acc:	50                   	push   %eax
  801acd:	6a 2e                	push   $0x2e
  801acf:	e8 c9 f9 ff ff       	call   80149d <syscall>
...
00801adc <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801aef:	e8 a9 f9 ff ff       	call   80149d <syscall>
