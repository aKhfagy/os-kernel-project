...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8013cb:	e8 27 fc ff ff       	call   800ff7 <syscall>
...
sys_run_env(int32 envId)
{
  ...
  8013e6:	e8 0c fc ff ff       	call   800ff7 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801402:	e8 f0 fb ff ff       	call   800ff7 <syscall>
...
sys_get_virtual_time()
{
  ...
  801426:	e8 cc fb ff ff       	call   800ff7 <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801455:	e8 9d fb ff ff       	call   800ff7 <syscall>
...
uint32 sys_rcr2()
{
  ...
  80146f:	e8 83 fb ff ff       	call   800ff7 <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801494:	e8 5e fb ff ff       	call   800ff7 <syscall>
...
void rsttst()
{
  ...
  8014ae:	e8 44 fb ff ff       	call   800ff7 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8014d9:	e8 19 fb ff ff       	call   800ff7 <syscall>
...
void chktst(uint32 n)
{
  ...
  8014f4:	e8 fe fa ff ff       	call   800ff7 <syscall>
...
void inctst()
{
  ...
  80150e:	e8 e4 fa ff ff       	call   800ff7 <syscall>
...
uint32 gettst()
{
  ...
  801528:	e8 ca fa ff ff       	call   800ff7 <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801544:	e8 ae fa ff ff       	call   800ff7 <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801575:	e8 7d fa ff ff       	call   800ff7 <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  8015a6:	e8 4c fa ff ff       	call   800ff7 <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  8015d7:	e8 1b fa ff ff       	call   800ff7 <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801606:	e8 ec f9 ff ff       	call   800ff7 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801629:	e8 c9 f9 ff ff       	call   800ff7 <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801649:	e8 a9 f9 ff ff       	call   800ff7 <syscall>
