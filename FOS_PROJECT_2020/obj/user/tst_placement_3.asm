...
void _main(void)
{
  ...
  8000fb:	50                   	push   %eax
  8000fc:	e8 6c 1a 00 00       	call   801b6d <sys_check_LRU_lists>
  ...
  800394:	50                   	push   %eax
  800395:	e8 d3 17 00 00       	call   801b6d <sys_check_LRU_lists>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801924:	50                   	push   %eax
  801925:	6a 21                	push   $0x21
  801927:	e8 27 fc ff ff       	call   801553 <syscall>
  80192c:	83 c4 18             	add    $0x18,%esp
}
  80192f:	c9                   	leave  
  801930:	c3                   	ret    

00801931 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  80193f:	50                   	push   %eax
  801940:	6a 22                	push   $0x22
  801942:	e8 0c fc ff ff       	call   801553 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  80195b:	50                   	push   %eax
  80195c:	6a 23                	push   $0x23
  80195e:	e8 f0 fb ff ff       	call   801553 <syscall>
...
sys_get_virtual_time()
{
  ...
  80197e:	52                   	push   %edx
  80197f:	50                   	push   %eax
  801980:	6a 24                	push   $0x24
  801982:	e8 cc fb ff ff       	call   801553 <syscall>
  801987:	83 c4 18             	add    $0x18,%esp
	return result;
  80198a:	8b 4d 08             	mov    0x8(%ebp),%ecx
  80198d:	8b 45 f8             	mov    -0x8(%ebp),%eax
  801990:	8b 55 fc             	mov    -0x4(%ebp),%edx
  801993:	89 01                	mov    %eax,(%ecx)
  801995:	89 51 04             	mov    %edx,0x4(%ecx)
}
  801998:	8b 45 08             	mov    0x8(%ebp),%eax
  80199b:	c9                   	leave  
  80199c:	c2 04 00             	ret    $0x4

0080199f <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8019af:	6a 13                	push   $0x13
  8019b1:	e8 9d fb ff ff       	call   801553 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8019c9:	6a 25                	push   $0x25
  8019cb:	e8 83 fb ff ff       	call   801553 <syscall>
  8019d0:	83 c4 18             	add    $0x18,%esp
}
  8019d3:	c9                   	leave  
  8019d4:	c3                   	ret    

008019d5 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  8019e1:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  8019e5:	6a 00                	push   $0x0
  8019e7:	6a 00                	push   $0x0
  8019e9:	6a 00                	push   $0x0
  8019eb:	6a 00                	push   $0x0
  8019ed:	50                   	push   %eax
  8019ee:	6a 26                	push   $0x26
...
void rsttst()
{
  ...
  801a08:	6a 28                	push   $0x28
  801a0a:	e8 44 fb ff ff       	call   801553 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801a21:	8b 55 18             	mov    0x18(%ebp),%edx
  ...
  801a33:	6a 27                	push   $0x27
  801a35:	e8 19 fb ff ff       	call   801553 <syscall>
...
void chktst(uint32 n)
{
  ...
  801a4e:	6a 29                	push   $0x29
  801a50:	e8 fe fa ff ff       	call   801553 <syscall>
...
void inctst()
{
  ...
  801a68:	6a 2a                	push   $0x2a
  801a6a:	e8 e4 fa ff ff       	call   801553 <syscall>
...
uint32 gettst()
{
  ...
  801a82:	6a 2b                	push   $0x2b
  801a84:	e8 ca fa ff ff       	call   801553 <syscall>
  801a89:	83 c4 18             	add    $0x18,%esp
}
  801a8c:	c9                   	leave  
  801a8d:	c3                   	ret    

00801a8e <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801aa0:	e8 ae fa ff ff       	call   801553 <syscall>
  801aa5:	83 c4 18             	add    $0x18,%esp
  801aa8:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801aab:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801aaf:	75 07                	jne    801ab8 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801ab1:	b8 01 00 00 00       	mov    $0x1,%eax
  801ab6:	eb 05                	jmp    801abd <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801abf <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801ad1:	e8 7d fa ff ff       	call   801553 <syscall>
  801ad6:	83 c4 18             	add    $0x18,%esp
  801ad9:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  801adc:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801ae0:	75 07                	jne    801ae9 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801ae2:	b8 01 00 00 00       	mov    $0x1,%eax
  801ae7:	eb 05                	jmp    801aee <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801af0 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801b02:	e8 4c fa ff ff       	call   801553 <syscall>
  801b07:	83 c4 18             	add    $0x18,%esp
  801b0a:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  801b0d:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801b11:	75 07                	jne    801b1a <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801b13:	b8 01 00 00 00       	mov    $0x1,%eax
  801b18:	eb 05                	jmp    801b1f <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801b21 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801b33:	e8 1b fa ff ff       	call   801553 <syscall>
  801b38:	83 c4 18             	add    $0x18,%esp
  801b3b:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801b3e:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801b42:	75 07                	jne    801b4b <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801b44:	b8 01 00 00 00       	mov    $0x1,%eax
  801b49:	eb 05                	jmp    801b50 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801b52 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801b60:	6a 2d                	push   $0x2d
  801b62:	e8 ec f9 ff ff       	call   801553 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801b81:	52                   	push   %edx
  801b82:	50                   	push   %eax
  801b83:	6a 2e                	push   $0x2e
  801b85:	e8 c9 f9 ff ff       	call   801553 <syscall>
...
00801b92 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801ba1:	52                   	push   %edx
  801ba2:	50                   	push   %eax
  801ba3:	6a 2f                	push   $0x2f
  801ba5:	e8 a9 f9 ff ff       	call   801553 <syscall>
