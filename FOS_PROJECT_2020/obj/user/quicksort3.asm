...
{	
  ...
  800049:	e8 3c 1b 00 00       	call   801b8a <sys_calculate_free_frames>
  80004e:	89 c3                	mov    %eax,%ebx
  800050:	e8 4e 1b 00 00       	call   801ba3 <sys_calculate_modified_frames>
  ...
  80005d:	e8 f8 1b 00 00       	call   801c5a <sys_disable_interrupt>
		readline("Enter the number of elements: ", Line);
  800062:	83 ec 08             	sub    $0x8,%esp
  800065:	8d 85 e1 fe ff ff    	lea    -0x11f(%ebp),%eax
  80006b:	50                   	push   %eax
  80006c:	68 e0 22 80 00       	push   $0x8022e0
  ...
  800121:	e8 4e 1b 00 00       	call   801c74 <sys_enable_interrupt>
		int  i ;
		switch (Chose)
  ...
  8001f5:	68 26 24 80 00       	push   $0x802426
  8001fa:	e8 e7 07 00 00       	call   8009e6 <cprintf>
  8001ff:	83 c4 10             	add    $0x10,%esp
		free(Elements) ;
  800202:	83 ec 0c             	sub    $0xc,%esp
  800205:	ff 75 e8             	pushl  -0x18(%ebp)
  800208:	e8 bd 17 00 00       	call   8019ca <free>
  80020d:	83 c4 10             	add    $0x10,%esp


		///========================================================================
	sys_disable_interrupt();
  800210:	e8 45 1a 00 00       	call   801c5a <sys_disable_interrupt>
		cprintf("Do you want to repeat (y/n): ") ;
  800215:	83 ec 0c             	sub    $0xc,%esp
  800218:	68 3c 24 80 00       	push   $0x80243c
  ...
  800254:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800257:	e8 18 1a 00 00       	call   801c74 <sys_enable_interrupt>
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  8004ff:	68 5a 24 80 00       	push   $0x80245a
  ...
  800520:	50                   	push   %eax
  800521:	68 5c 24 80 00       	push   $0x80245c
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  80054e:	50                   	push   %eax
  80054f:	68 61 24 80 00       	push   $0x802461
...
cputchar(int ch)
{
  ...
  800572:	50                   	push   %eax
  800573:	e8 16 17 00 00       	call   801c8e <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  800581:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800584:	e8 d1 16 00 00       	call   801c5a <sys_disable_interrupt>
	char c = ch;
  ...
  800596:	50                   	push   %eax
  800597:	e8 f2 16 00 00       	call   801c8e <sys_cputc>
  80059c:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  80059f:	e8 d0 16 00 00       	call   801c74 <sys_enable_interrupt>
}
  8005a4:	90                   	nop
  8005a5:	c9                   	leave  
  8005a6:	c3                   	ret    
...
getchar(void)
{
  ...
  8005b4:	eb 08                	jmp    8005be <getchar+0x17>
	{
		c = sys_cgetc();
  8005b6:	e8 b7 14 00 00       	call   801a72 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  8005cc:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8005cf:	e8 86 16 00 00       	call   801c5a <sys_disable_interrupt>
	int c=0;
  ...
  8005db:	eb 08                	jmp    8005e5 <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  8005dd:	e8 90 14 00 00       	call   801a72 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  8005e9:	74 f2                	je     8005dd <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  8005eb:	e8 84 16 00 00       	call   801c74 <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  800605:	e8 b5 14 00 00       	call   801abf <sys_getenvindex>
  ...
  80067f:	83 c4 10             	add    $0x10,%esp
	...
	sys_disable_interrupt();
  800682:	e8 d3 15 00 00       	call   801c5a <sys_disable_interrupt>
	cprintf("**************************************\n");
  800687:	83 ec 0c             	sub    $0xc,%esp
  80068a:	68 80 24 80 00       	push   $0x802480
  ...
  8006b0:	52                   	push   %edx
  8006b1:	50                   	push   %eax
  8006b2:	68 a8 24 80 00       	push   $0x8024a8
  ...
  8006d8:	52                   	push   %edx
  8006d9:	50                   	push   %eax
  8006da:	68 d0 24 80 00       	push   $0x8024d0
  ...
  8006f5:	50                   	push   %eax
  8006f6:	68 11 25 80 00       	push   $0x802511
  8006fb:	e8 e6 02 00 00       	call   8009e6 <cprintf>
  800700:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  800703:	83 ec 0c             	sub    $0xc,%esp
  800706:	68 80 24 80 00       	push   $0x802480
  80070b:	e8 d6 02 00 00       	call   8009e6 <cprintf>
  800710:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800713:	e8 5c 15 00 00       	call   801c74 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  80072b:	e8 5b 13 00 00       	call   801a8b <sys_env_destroy>
...
exit(void)
{
  ...
  800739:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  80073c:	e8 b0 13 00 00       	call   801af1 <sys_env_exit>
}
  800741:	90                   	nop
  800742:	c9                   	leave  
  800743:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800764:	50                   	push   %eax
  800765:	68 28 25 80 00       	push   $0x802528
  ...
  80077d:	50                   	push   %eax
  80077e:	68 2d 25 80 00       	push   $0x80252d
  ...
  8007a2:	68 49 25 80 00       	push   $0x802549
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8007ce:	68 4c 25 80 00       	push   $0x80254c
  8007d3:	6a 26                	push   $0x26
  8007d5:	68 98 25 80 00       	push   $0x802598
  ...
  800894:	68 a4 25 80 00       	push   $0x8025a4
  800899:	6a 3a                	push   $0x3a
  80089b:	68 98 25 80 00       	push   $0x802598
  ...
  8008fe:	68 f8 25 80 00       	push   $0x8025f8
  800903:	6a 44                	push   $0x44
  800905:	68 98 25 80 00       	push   $0x802598
...
static void putch(int ch, struct printbuf *b) {
  ...
  800956:	51                   	push   %ecx
  800957:	52                   	push   %edx
  800958:	e8 ec 10 00 00       	call   801a49 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8009ce:	50                   	push   %eax
  8009cf:	e8 75 10 00 00       	call   801a49 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800a16:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800a19:	e8 3c 12 00 00       	call   801c5a <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800a36:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800a39:	e8 36 12 00 00       	call   801c74 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800a83:	e8 f4 15 00 00       	call   80207c <__udivdi3>
  ...
  800ad1:	52                   	push   %edx
  800ad2:	50                   	push   %eax
  800ad3:	e8 b4 16 00 00       	call   80218c <__umoddi3>
  800ad8:	83 c4 10             	add    $0x10,%esp
  800adb:	05 74 28 80 00       	add    $0x802874,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800c2e:	8b 04 85 98 28 80 00 	mov    0x802898(,%eax,4),%eax
  ...
  800d0f:	8b 34 9d e0 26 80 00 	mov    0x8026e0(,%ebx,4),%esi
  800d16:	85 f6                	test   %esi,%esi
  800d18:	75 19                	jne    800d33 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800d1a:	53                   	push   %ebx
  800d1b:	68 85 28 80 00       	push   $0x802885
  ...
  800d2e:	e9 49 02 00 00       	jmp    800f7c <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800d33:	56                   	push   %esi
  800d34:	68 8e 28 80 00       	push   $0x80288e
  ...
  800d5f:	75 05                	jne    800d66 <vprintfmt+0x1a6>
				p = "(null)";
  800d61:	be 91 28 80 00       	mov    $0x802891,%esi
			if (width > 0 && padc != '-')
...
void readline(const char *prompt, char* buf)
{
  ...
  80107a:	68 f0 29 80 00       	push   $0x8029f0
  ...
  8010bc:	68 f3 29 80 00       	push   $0x8029f3
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  801169:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80116c:	e8 e9 0a 00 00       	call   801c5a <sys_disable_interrupt>
	int i, c, echoing;
  ...
  80117d:	68 f0 29 80 00       	push   $0x8029f0
  ...
  8011bb:	68 f3 29 80 00       	push   $0x8029f3
  8011c0:	e8 21 f8 ff ff       	call   8009e6 <cprintf>
  8011c5:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  8011c8:	e8 a7 0a 00 00       	call   801c74 <sys_enable_interrupt>
			return;
  ...
  80125d:	c6 00 00             	movb   $0x0,(%eax)
			sys_enable_interrupt();
  801260:	e8 0f 0a 00 00       	call   801c74 <sys_enable_interrupt>
			return;
...
void* malloc(uint32 size)
{
  ...
  80197f:	68 04 2a 80 00       	push   $0x802a04
  801984:	6a 19                	push   $0x19
  801986:	68 29 2a 80 00       	push   $0x802a29
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801999:	88 45 f4             	mov    %al,-0xc(%ebp)
	//TODO: [PROJECT 2020  - Shared Variables: Creation] smalloc() [User Side]
	// Write your code here, remove the panic and write your code
	panic("smalloc() is not implemented yet...!!");
  80199c:	83 ec 04             	sub    $0x4,%esp
  80199f:	68 38 2a 80 00       	push   $0x802a38
  8019a4:	6a 31                	push   $0x31
  8019a6:	68 29 2a 80 00       	push   $0x802a29
  8019ab:	e8 94 ed ff ff       	call   800744 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8019b9:	68 60 2a 80 00       	push   $0x802a60
  8019be:	6a 4a                	push   $0x4a
  8019c0:	68 29 2a 80 00       	push   $0x802a29
...
void free(void* virtual_address)
{
  ...
  8019d3:	68 84 2a 80 00       	push   $0x802a84
  8019d8:	6a 70                	push   $0x70
  8019da:	68 29 2a 80 00       	push   $0x802a29
...
void sfree(void* virtual_address)
{
  ...
  8019ed:	68 a8 2a 80 00       	push   $0x802aa8
  8019f2:	68 8b 00 00 00       	push   $0x8b
  8019f7:	68 29 2a 80 00       	push   $0x802a29
  8019fc:	e8 43 ed ff ff       	call   800744 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801a0a:	68 cc 2a 80 00       	push   $0x802acc
  801a0f:	68 a8 00 00 00       	push   $0xa8
  801a14:	68 29 2a 80 00       	push   $0x802a29
  801a19:	e8 26 ed ff ff       	call   800744 <_panic>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801df2:	e8 27 fc ff ff       	call   801a1e <syscall>
...
sys_run_env(int32 envId)
{
  ...
  801e0d:	e8 0c fc ff ff       	call   801a1e <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801e29:	e8 f0 fb ff ff       	call   801a1e <syscall>
...
sys_get_virtual_time()
{
  ...
  801e4d:	e8 cc fb ff ff       	call   801a1e <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801e7c:	e8 9d fb ff ff       	call   801a1e <syscall>
...
uint32 sys_rcr2()
{
  ...
  801e96:	e8 83 fb ff ff       	call   801a1e <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801ebb:	e8 5e fb ff ff       	call   801a1e <syscall>
...
void rsttst()
{
  ...
  801ed5:	e8 44 fb ff ff       	call   801a1e <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801f00:	e8 19 fb ff ff       	call   801a1e <syscall>
...
void chktst(uint32 n)
{
  ...
  801f1b:	e8 fe fa ff ff       	call   801a1e <syscall>
...
void inctst()
{
  ...
  801f35:	e8 e4 fa ff ff       	call   801a1e <syscall>
...
uint32 gettst()
{
  ...
  801f4f:	e8 ca fa ff ff       	call   801a1e <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801f6b:	e8 ae fa ff ff       	call   801a1e <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801f9c:	e8 7d fa ff ff       	call   801a1e <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801fcd:	e8 4c fa ff ff       	call   801a1e <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801ffe:	e8 1b fa ff ff       	call   801a1e <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  80202d:	e8 ec f9 ff ff       	call   801a1e <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  802050:	e8 c9 f9 ff ff       	call   801a1e <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  802070:	e8 a9 f9 ff ff       	call   801a1e <syscall>
