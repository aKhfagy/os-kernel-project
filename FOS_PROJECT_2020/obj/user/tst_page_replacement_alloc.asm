	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800803:	e8 44 13 00 00       	call   801b4c <__udivdi3>
  ...
  800851:	52                   	push   %edx
  800852:	50                   	push   %eax
  800853:	e8 04 14 00 00       	call   801c5c <__umoddi3>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8018c1:	50                   	push   %eax
  8018c2:	6a 21                	push   $0x21
  8018c4:	e8 27 fc ff ff       	call   8014f0 <syscall>
  8018c9:	83 c4 18             	add    $0x18,%esp
}
  8018cc:	c9                   	leave  
  8018cd:	c3                   	ret    

008018ce <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  8018df:	e8 0c fc ff ff       	call   8014f0 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  8018f8:	50                   	push   %eax
  8018f9:	6a 23                	push   $0x23
  8018fb:	e8 f0 fb ff ff       	call   8014f0 <syscall>
...
sys_get_virtual_time()
{
  ...
  80190f:	8d 50 04             	lea    0x4(%eax),%edx
  801912:	8d 45 f8             	lea    -0x8(%ebp),%eax
  801915:	6a 00                	push   $0x0
  801917:	6a 00                	push   $0x0
  801919:	6a 00                	push   $0x0
  80191b:	52                   	push   %edx
  80191c:	50                   	push   %eax
  80191d:	6a 24                	push   $0x24
  80191f:	e8 cc fb ff ff       	call   8014f0 <syscall>
  ...
  801932:	89 51 04             	mov    %edx,0x4(%ecx)
}
  801935:	8b 45 08             	mov    0x8(%ebp),%eax
  801938:	c9                   	leave  
  801939:	c2 04 00             	ret    $0x4

0080193c <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  80194c:	6a 13                	push   $0x13
  80194e:	e8 9d fb ff ff       	call   8014f0 <syscall>
...
uint32 sys_rcr2()
{
  ...
  801966:	6a 25                	push   $0x25
  801968:	e8 83 fb ff ff       	call   8014f0 <syscall>
  80196d:	83 c4 18             	add    $0x18,%esp
}
  801970:	c9                   	leave  
  801971:	c3                   	ret    

00801972 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  80197e:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  801982:	6a 00                	push   $0x0
  801984:	6a 00                	push   $0x0
  801986:	6a 00                	push   $0x0
  801988:	6a 00                	push   $0x0
  80198a:	50                   	push   %eax
  80198b:	6a 26                	push   $0x26
  80198d:	e8 5e fb ff ff       	call   8014f0 <syscall>
...
void rsttst()
{
  ...
  8019a5:	6a 28                	push   $0x28
  8019a7:	e8 44 fb ff ff       	call   8014f0 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8019be:	8b 55 18             	mov    0x18(%ebp),%edx
  ...
  8019d0:	6a 27                	push   $0x27
  8019d2:	e8 19 fb ff ff       	call   8014f0 <syscall>
...
void chktst(uint32 n)
{
  ...
  8019ed:	e8 fe fa ff ff       	call   8014f0 <syscall>
...
void inctst()
{
  ...
  801a07:	e8 e4 fa ff ff       	call   8014f0 <syscall>
...
uint32 gettst()
{
  ...
  801a21:	e8 ca fa ff ff       	call   8014f0 <syscall>
  801a26:	83 c4 18             	add    $0x18,%esp
}
  801a29:	c9                   	leave  
  801a2a:	c3                   	ret    

00801a2b <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801a3d:	e8 ae fa ff ff       	call   8014f0 <syscall>
  801a42:	83 c4 18             	add    $0x18,%esp
  801a45:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801a48:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801a4c:	75 07                	jne    801a55 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801a4e:	b8 01 00 00 00       	mov    $0x1,%eax
  801a53:	eb 05                	jmp    801a5a <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801a5c <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801a6c:	6a 2c                	push   $0x2c
  801a6e:	e8 7d fa ff ff       	call   8014f0 <syscall>
  801a73:	83 c4 18             	add    $0x18,%esp
  801a76:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  801a79:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801a7d:	75 07                	jne    801a86 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801a7f:	b8 01 00 00 00       	mov    $0x1,%eax
  801a84:	eb 05                	jmp    801a8b <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801a8d <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801a9d:	6a 2c                	push   $0x2c
  801a9f:	e8 4c fa ff ff       	call   8014f0 <syscall>
  801aa4:	83 c4 18             	add    $0x18,%esp
  801aa7:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  801aaa:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801aae:	75 07                	jne    801ab7 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801ab0:	b8 01 00 00 00       	mov    $0x1,%eax
  801ab5:	eb 05                	jmp    801abc <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801abe <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801ace:	6a 2c                	push   $0x2c
  801ad0:	e8 1b fa ff ff       	call   8014f0 <syscall>
  801ad5:	83 c4 18             	add    $0x18,%esp
  801ad8:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801adb:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801adf:	75 07                	jne    801ae8 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801ae1:	b8 01 00 00 00       	mov    $0x1,%eax
  801ae6:	eb 05                	jmp    801aed <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801aef <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801aff:	e8 ec f9 ff ff       	call   8014f0 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801b0e:	8b 5d 14             	mov    0x14(%ebp),%ebx
  ...
  801b1e:	52                   	push   %edx
  801b1f:	50                   	push   %eax
  801b20:	6a 2e                	push   $0x2e
  801b22:	e8 c9 f9 ff ff       	call   8014f0 <syscall>
...
00801b2f <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801b3e:	52                   	push   %edx
  801b3f:	50                   	push   %eax
  801b40:	6a 2f                	push   $0x2f
  801b42:	e8 a9 f9 ff ff       	call   8014f0 <syscall>
