...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8015d2:	e8 27 fc ff ff       	call   8011fe <syscall>
  8015d7:	83 c4 18             	add    $0x18,%esp
}
  8015da:	c9                   	leave  
  8015db:	c3                   	ret    

008015dc <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  8015ea:	50                   	push   %eax
  8015eb:	6a 22                	push   $0x22
  8015ed:	e8 0c fc ff ff       	call   8011fe <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801606:	50                   	push   %eax
  801607:	6a 23                	push   $0x23
  801609:	e8 f0 fb ff ff       	call   8011fe <syscall>
...
sys_get_virtual_time()
{
  ...
  80162d:	e8 cc fb ff ff       	call   8011fe <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  80165a:	6a 13                	push   $0x13
  80165c:	e8 9d fb ff ff       	call   8011fe <syscall>
...
uint32 sys_rcr2()
{
  ...
  801676:	e8 83 fb ff ff       	call   8011fe <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  80169b:	e8 5e fb ff ff       	call   8011fe <syscall>
...
void rsttst()
{
  ...
  8016b5:	e8 44 fb ff ff       	call   8011fe <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8016de:	6a 27                	push   $0x27
  8016e0:	e8 19 fb ff ff       	call   8011fe <syscall>
...
void chktst(uint32 n)
{
  ...
  8016fb:	e8 fe fa ff ff       	call   8011fe <syscall>
...
void inctst()
{
  ...
  801713:	6a 2a                	push   $0x2a
  801715:	e8 e4 fa ff ff       	call   8011fe <syscall>
...
uint32 gettst()
{
  ...
  80172d:	6a 2b                	push   $0x2b
  80172f:	e8 ca fa ff ff       	call   8011fe <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  80174b:	e8 ae fa ff ff       	call   8011fe <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  80177c:	e8 7d fa ff ff       	call   8011fe <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  8017ad:	e8 4c fa ff ff       	call   8011fe <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  8017dc:	6a 2c                	push   $0x2c
  8017de:	e8 1b fa ff ff       	call   8011fe <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  80180b:	6a 2d                	push   $0x2d
  80180d:	e8 ec f9 ff ff       	call   8011fe <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  80182c:	52                   	push   %edx
  80182d:	50                   	push   %eax
  80182e:	6a 2e                	push   $0x2e
  801830:	e8 c9 f9 ff ff       	call   8011fe <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  80184c:	52                   	push   %edx
  80184d:	50                   	push   %eax
  80184e:	6a 2f                	push   $0x2f
  801850:	e8 a9 f9 ff ff       	call   8011fe <syscall>
