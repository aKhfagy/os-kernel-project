...
void readline(const char *prompt, char* buf)
{
  ...
  8009a7:	e8 d0 0f 00 00       	call   80197c <iscons>
  8009ac:	83 c4 10             	add    $0x10,%esp
  8009af:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  8009b2:	e8 77 0f 00 00       	call   80192e <getchar>
  ...
  8009fd:	e8 e4 0e 00 00       	call   8018e6 <cputchar>
  ...
  800a34:	e8 ad 0e 00 00       	call   8018e6 <cputchar>
  ...
  800a5d:	e8 84 0e 00 00       	call   8018e6 <cputchar>
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  800aaa:	e8 cd 0e 00 00       	call   80197c <iscons>
  800aaf:	83 c4 10             	add    $0x10,%esp
  800ab2:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  800ab5:	e8 74 0e 00 00       	call   80192e <getchar>
  ...
  800b01:	e8 e0 0d 00 00       	call   8018e6 <cputchar>
  ...
  800b38:	e8 a9 0d 00 00       	call   8018e6 <cputchar>
  ...
  800b61:	e8 80 0d 00 00       	call   8018e6 <cputchar>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  80165e:	e8 27 fc ff ff       	call   80128a <syscall>
...
sys_run_env(int32 envId)
{
  ...
  801679:	e8 0c fc ff ff       	call   80128a <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801695:	e8 f0 fb ff ff       	call   80128a <syscall>
...
sys_get_virtual_time()
{
  ...
  8016b9:	e8 cc fb ff ff       	call   80128a <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8016e8:	e8 9d fb ff ff       	call   80128a <syscall>
...
uint32 sys_rcr2()
{
  ...
  801702:	e8 83 fb ff ff       	call   80128a <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801727:	e8 5e fb ff ff       	call   80128a <syscall>
...
void rsttst()
{
  ...
  801741:	e8 44 fb ff ff       	call   80128a <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  80176c:	e8 19 fb ff ff       	call   80128a <syscall>
...
void chktst(uint32 n)
{
  ...
  801787:	e8 fe fa ff ff       	call   80128a <syscall>
...
void inctst()
{
  ...
  8017a1:	e8 e4 fa ff ff       	call   80128a <syscall>
...
uint32 gettst()
{
  ...
  8017bb:	e8 ca fa ff ff       	call   80128a <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8017d7:	e8 ae fa ff ff       	call   80128a <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801808:	e8 7d fa ff ff       	call   80128a <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801839:	e8 4c fa ff ff       	call   80128a <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  80186a:	e8 1b fa ff ff       	call   80128a <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801899:	e8 ec f9 ff ff       	call   80128a <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8018bc:	e8 c9 f9 ff ff       	call   80128a <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8018dc:	e8 a9 f9 ff ff       	call   80128a <syscall>
...
cputchar(int ch)
{
  ...
  8018f9:	50                   	push   %eax
  8018fa:	e8 fb fb ff ff       	call   8014fa <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  801908:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80190b:	e8 b6 fb ff ff       	call   8014c6 <sys_disable_interrupt>
	char c = ch;
  ...
  80191d:	50                   	push   %eax
  80191e:	e8 d7 fb ff ff       	call   8014fa <sys_cputc>
  801923:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  801926:	e8 b5 fb ff ff       	call   8014e0 <sys_enable_interrupt>
}
  80192b:	90                   	nop
  80192c:	c9                   	leave  
  80192d:	c3                   	ret    
...
getchar(void)
{
  ...
  80193b:	eb 08                	jmp    801945 <getchar+0x17>
	{
		c = sys_cgetc();
  80193d:	e8 9c f9 ff ff       	call   8012de <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  801953:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  801956:	e8 6b fb ff ff       	call   8014c6 <sys_disable_interrupt>
	int c=0;
  ...
  801962:	eb 08                	jmp    80196c <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  801964:	e8 75 f9 ff ff       	call   8012de <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  801970:	74 f2                	je     801964 <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  801972:	e8 69 fb ff ff       	call   8014e0 <sys_enable_interrupt>
	return c;
