...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  80140a:	50                   	push   %eax
  80140b:	6a 21                	push   $0x21
  80140d:	e8 27 fc ff ff       	call   801039 <syscall>
  801412:	83 c4 18             	add    $0x18,%esp
}
  801415:	c9                   	leave  
  801416:	c3                   	ret    

00801417 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  801428:	e8 0c fc ff ff       	call   801039 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801441:	50                   	push   %eax
  801442:	6a 23                	push   $0x23
  801444:	e8 f0 fb ff ff       	call   801039 <syscall>
...
sys_get_virtual_time()
{
  ...
  801458:	8d 50 04             	lea    0x4(%eax),%edx
  ...
  801464:	52                   	push   %edx
  801465:	50                   	push   %eax
  801466:	6a 24                	push   $0x24
  801468:	e8 cc fb ff ff       	call   801039 <syscall>
  ...
  801479:	89 01                	mov    %eax,(%ecx)
  80147b:	89 51 04             	mov    %edx,0x4(%ecx)
}
  80147e:	8b 45 08             	mov    0x8(%ebp),%eax
  801481:	c9                   	leave  
  801482:	c2 04 00             	ret    $0x4

00801485 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  80148c:	ff 75 10             	pushl  0x10(%ebp)
  80148f:	ff 75 0c             	pushl  0xc(%ebp)
  801492:	ff 75 08             	pushl  0x8(%ebp)
  801495:	6a 13                	push   $0x13
  801497:	e8 9d fb ff ff       	call   801039 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8014b1:	e8 83 fb ff ff       	call   801039 <syscall>
  8014b6:	83 c4 18             	add    $0x18,%esp
}
  8014b9:	c9                   	leave  
  8014ba:	c3                   	ret    

008014bb <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  8014c7:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  8014cb:	6a 00                	push   $0x0
  8014cd:	6a 00                	push   $0x0
  8014cf:	6a 00                	push   $0x0
  8014d1:	6a 00                	push   $0x0
  8014d3:	50                   	push   %eax
  8014d4:	6a 26                	push   $0x26
  8014d6:	e8 5e fb ff ff       	call   801039 <syscall>
...
void rsttst()
{
  ...
  8014ee:	6a 28                	push   $0x28
  8014f0:	e8 44 fb ff ff       	call   801039 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801507:	8b 55 18             	mov    0x18(%ebp),%edx
  80150a:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  80150e:	52                   	push   %edx
  80150f:	50                   	push   %eax
  801510:	ff 75 10             	pushl  0x10(%ebp)
  801513:	ff 75 0c             	pushl  0xc(%ebp)
  801516:	ff 75 08             	pushl  0x8(%ebp)
  801519:	6a 27                	push   $0x27
  80151b:	e8 19 fb ff ff       	call   801039 <syscall>
...
void chktst(uint32 n)
{
  ...
  801534:	6a 29                	push   $0x29
  801536:	e8 fe fa ff ff       	call   801039 <syscall>
...
void inctst()
{
  ...
  801550:	e8 e4 fa ff ff       	call   801039 <syscall>
...
uint32 gettst()
{
  ...
  801568:	6a 2b                	push   $0x2b
  80156a:	e8 ca fa ff ff       	call   801039 <syscall>
  80156f:	83 c4 18             	add    $0x18,%esp
}
  801572:	c9                   	leave  
  801573:	c3                   	ret    

00801574 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801584:	6a 2c                	push   $0x2c
  801586:	e8 ae fa ff ff       	call   801039 <syscall>
  80158b:	83 c4 18             	add    $0x18,%esp
  80158e:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801591:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801595:	75 07                	jne    80159e <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801597:	b8 01 00 00 00       	mov    $0x1,%eax
  80159c:	eb 05                	jmp    8015a3 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
008015a5 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  8015b5:	6a 2c                	push   $0x2c
  8015b7:	e8 7d fa ff ff       	call   801039 <syscall>
  8015bc:	83 c4 18             	add    $0x18,%esp
  8015bf:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  8015c2:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  8015c6:	75 07                	jne    8015cf <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  8015c8:	b8 01 00 00 00       	mov    $0x1,%eax
  8015cd:	eb 05                	jmp    8015d4 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
008015d6 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  8015e6:	6a 2c                	push   $0x2c
  8015e8:	e8 4c fa ff ff       	call   801039 <syscall>
  8015ed:	83 c4 18             	add    $0x18,%esp
  8015f0:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  8015f3:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  8015f7:	75 07                	jne    801600 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  8015f9:	b8 01 00 00 00       	mov    $0x1,%eax
  8015fe:	eb 05                	jmp    801605 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801607 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801617:	6a 2c                	push   $0x2c
  801619:	e8 1b fa ff ff       	call   801039 <syscall>
  80161e:	83 c4 18             	add    $0x18,%esp
  801621:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801624:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801628:	75 07                	jne    801631 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  80162a:	b8 01 00 00 00       	mov    $0x1,%eax
  80162f:	eb 05                	jmp    801636 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801638 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801646:	6a 2d                	push   $0x2d
  801648:	e8 ec f9 ff ff       	call   801039 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801667:	52                   	push   %edx
  801668:	50                   	push   %eax
  801669:	6a 2e                	push   $0x2e
  80166b:	e8 c9 f9 ff ff       	call   801039 <syscall>
...
00801678 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801687:	52                   	push   %edx
  801688:	50                   	push   %eax
  801689:	6a 2f                	push   $0x2f
  80168b:	e8 a9 f9 ff ff       	call   801039 <syscall>
