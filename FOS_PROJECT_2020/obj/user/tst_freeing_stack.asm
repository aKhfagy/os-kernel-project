...
void _main(void)
{
  ...
  8000bc:	e8 a7 19 00 00       	call   801a68 <env_sleep>
  ...
  8000f3:	68 80 1d 80 00       	push   $0x801d80
  8000f8:	6a 28                	push   $0x28
  8000fa:	68 a9 1d 80 00       	push   $0x801da9
  ...
  800111:	68 c4 1d 80 00       	push   $0x801dc4
  800116:	6a 29                	push   $0x29
  800118:	68 a9 1d 80 00       	push   $0x801da9
  ...
  80016a:	68 f8 1d 80 00       	push   $0x801df8
  80016f:	6a 31                	push   $0x31
  800171:	68 a9 1d 80 00       	push   $0x801da9
  ...
  8001f0:	68 30 1e 80 00       	push   $0x801e30
  8001f5:	6a 3f                	push   $0x3f
  8001f7:	68 a9 1d 80 00       	push   $0x801da9
  ...
  800211:	68 5c 1e 80 00       	push   $0x801e5c
...
libmain(int argc, char **argv)
{
  ...
  800326:	68 c0 1e 80 00       	push   $0x801ec0
  ...
  80034c:	52                   	push   %edx
  80034d:	50                   	push   %eax
  80034e:	68 e8 1e 80 00       	push   $0x801ee8
  ...
  800374:	52                   	push   %edx
  800375:	50                   	push   %eax
  800376:	68 10 1f 80 00       	push   $0x801f10
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800400:	50                   	push   %eax
  800401:	68 68 1f 80 00       	push   $0x801f68
  ...
  800419:	50                   	push   %eax
  80041a:	68 6d 1f 80 00       	push   $0x801f6d
  ...
  80043e:	68 89 1f 80 00       	push   $0x801f89
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80046a:	68 8c 1f 80 00       	push   $0x801f8c
  80046f:	6a 26                	push   $0x26
  800471:	68 d8 1f 80 00       	push   $0x801fd8
  ...
  800530:	68 e4 1f 80 00       	push   $0x801fe4
  800535:	6a 3a                	push   $0x3a
  800537:	68 d8 1f 80 00       	push   $0x801fd8
  ...
  80059a:	68 38 20 80 00       	push   $0x802038
  80059f:	6a 44                	push   $0x44
  8005a1:	68 d8 1f 80 00       	push   $0x801fd8
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80071f:	e8 f8 13 00 00       	call   801b1c <__udivdi3>
  ...
  80076d:	52                   	push   %edx
  80076e:	50                   	push   %eax
  80076f:	e8 b8 14 00 00       	call   801c2c <__umoddi3>
  800774:	83 c4 10             	add    $0x10,%esp
  800777:	05 b4 22 80 00       	add    $0x8022b4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8008ca:	8b 04 85 d8 22 80 00 	mov    0x8022d8(,%eax,4),%eax
  ...
  8009ab:	8b 34 9d 20 21 80 00 	mov    0x802120(,%ebx,4),%esi
  8009b2:	85 f6                	test   %esi,%esi
  8009b4:	75 19                	jne    8009cf <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8009b6:	53                   	push   %ebx
  8009b7:	68 c5 22 80 00       	push   $0x8022c5
  ...
  8009ca:	e9 49 02 00 00       	jmp    800c18 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8009cf:	56                   	push   %esi
  8009d0:	68 ce 22 80 00       	push   $0x8022ce
  ...
  8009fb:	75 05                	jne    800a02 <vprintfmt+0x1a6>
				p = "(null)";
  8009fd:	be d1 22 80 00       	mov    $0x8022d1,%esi
			if (width > 0 && padc != '-')
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8017dd:	50                   	push   %eax
  8017de:	6a 21                	push   $0x21
  8017e0:	e8 27 fc ff ff       	call   80140c <syscall>
  8017e5:	83 c4 18             	add    $0x18,%esp
}
  8017e8:	c9                   	leave  
  8017e9:	c3                   	ret    

008017ea <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  8017f8:	50                   	push   %eax
  8017f9:	6a 22                	push   $0x22
  8017fb:	e8 0c fc ff ff       	call   80140c <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801814:	50                   	push   %eax
  801815:	6a 23                	push   $0x23
  801817:	e8 f0 fb ff ff       	call   80140c <syscall>
...
sys_get_virtual_time()
{
  ...
  801837:	52                   	push   %edx
  801838:	50                   	push   %eax
  801839:	6a 24                	push   $0x24
  80183b:	e8 cc fb ff ff       	call   80140c <syscall>
  ...
  80184c:	89 01                	mov    %eax,(%ecx)
  80184e:	89 51 04             	mov    %edx,0x4(%ecx)
}
  801851:	8b 45 08             	mov    0x8(%ebp),%eax
  801854:	c9                   	leave  
  801855:	c2 04 00             	ret    $0x4

00801858 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801868:	6a 13                	push   $0x13
  80186a:	e8 9d fb ff ff       	call   80140c <syscall>
...
uint32 sys_rcr2()
{
  ...
  801884:	e8 83 fb ff ff       	call   80140c <syscall>
  801889:	83 c4 18             	add    $0x18,%esp
}
  80188c:	c9                   	leave  
  80188d:	c3                   	ret    

0080188e <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  80189a:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  ...
  8018a9:	e8 5e fb ff ff       	call   80140c <syscall>
...
void rsttst()
{
  ...
  8018c1:	6a 28                	push   $0x28
  8018c3:	e8 44 fb ff ff       	call   80140c <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8018da:	8b 55 18             	mov    0x18(%ebp),%edx
  ...
  8018ee:	e8 19 fb ff ff       	call   80140c <syscall>
...
void chktst(uint32 n)
{
  ...
  801907:	6a 29                	push   $0x29
  801909:	e8 fe fa ff ff       	call   80140c <syscall>
...
void inctst()
{
  ...
  801921:	6a 2a                	push   $0x2a
  801923:	e8 e4 fa ff ff       	call   80140c <syscall>
...
uint32 gettst()
{
  ...
  80193d:	e8 ca fa ff ff       	call   80140c <syscall>
  801942:	83 c4 18             	add    $0x18,%esp
}
  801945:	c9                   	leave  
  801946:	c3                   	ret    

00801947 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801957:	6a 2c                	push   $0x2c
  801959:	e8 ae fa ff ff       	call   80140c <syscall>
  80195e:	83 c4 18             	add    $0x18,%esp
  801961:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801964:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801968:	75 07                	jne    801971 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  80196a:	b8 01 00 00 00       	mov    $0x1,%eax
  80196f:	eb 05                	jmp    801976 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801978 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801988:	6a 2c                	push   $0x2c
  80198a:	e8 7d fa ff ff       	call   80140c <syscall>
  80198f:	83 c4 18             	add    $0x18,%esp
  801992:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  801995:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801999:	75 07                	jne    8019a2 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  80199b:	b8 01 00 00 00       	mov    $0x1,%eax
  8019a0:	eb 05                	jmp    8019a7 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
008019a9 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  8019bb:	e8 4c fa ff ff       	call   80140c <syscall>
  8019c0:	83 c4 18             	add    $0x18,%esp
  8019c3:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  8019c6:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  8019ca:	75 07                	jne    8019d3 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  8019cc:	b8 01 00 00 00       	mov    $0x1,%eax
  8019d1:	eb 05                	jmp    8019d8 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
008019da <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  8019ec:	e8 1b fa ff ff       	call   80140c <syscall>
  8019f1:	83 c4 18             	add    $0x18,%esp
  8019f4:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  8019f7:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  8019fb:	75 07                	jne    801a04 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  8019fd:	b8 01 00 00 00       	mov    $0x1,%eax
  801a02:	eb 05                	jmp    801a09 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801a0b <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801a19:	6a 2d                	push   $0x2d
  801a1b:	e8 ec f9 ff ff       	call   80140c <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801a3a:	52                   	push   %edx
  801a3b:	50                   	push   %eax
  801a3c:	6a 2e                	push   $0x2e
  801a3e:	e8 c9 f9 ff ff       	call   80140c <syscall>
...
00801a4b <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801a5a:	52                   	push   %edx
  801a5b:	50                   	push   %eax
  801a5c:	6a 2f                	push   $0x2f
  801a5e:	e8 a9 f9 ff ff       	call   80140c <syscall>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801aa0:	8d 45 e8             	lea    -0x18(%ebp),%eax
  801aa3:	83 ec 0c             	sub    $0xc,%esp
  801aa6:	50                   	push   %eax
  801aa7:	e8 76 fd ff ff       	call   801822 <sys_get_virtual_time>
  801aac:	83 c4 0c             	add    $0xc,%esp
	while(cycles_counter<time_in_cycles)
  801aaf:	eb 41                	jmp    801af2 <env_sleep+0x8a>
	{
		struct uint64 currentTime = sys_get_virtual_time() ;
  801ab1:	8d 45 e0             	lea    -0x20(%ebp),%eax
  801ab4:	83 ec 0c             	sub    $0xc,%esp
  801ab7:	50                   	push   %eax
  801ab8:	e8 65 fd ff ff       	call   801822 <sys_get_virtual_time>
  ...
  801ac0:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801ac3:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801ac6:	29 c2                	sub    %eax,%edx
  801ac8:	89 d0                	mov    %edx,%eax
  801aca:	89 45 d8             	mov    %eax,-0x28(%ebp)
		res.hi = (currentTime.hi - baseTime.hi - (res.low > currentTime.low)) & M32;
  801acd:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  ...
  801adf:	0f 97 c0             	seta   %al
  801ae2:	0f b6 c0             	movzbl %al,%eax
  801ae5:	29 c1                	sub    %eax,%ecx
  801ae7:	89 c8                	mov    %ecx,%eax
  801ae9:	89 45 dc             	mov    %eax,-0x24(%ebp)
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801af5:	3b 45 f0             	cmp    -0x10(%ebp),%eax
  801af8:	72 b7                	jb     801ab1 <env_sleep+0x49>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  801b00:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  801b03:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  801b0a:	eb 03                	jmp    801b0f <busy_wait+0x12>
  801b0c:	ff 45 fc             	incl   -0x4(%ebp)
  801b0f:	8b 45 fc             	mov    -0x4(%ebp),%eax
  801b12:	3b 45 08             	cmp    0x8(%ebp),%eax
  801b15:	72 f5                	jb     801b0c <busy_wait+0xf>
	return i;
