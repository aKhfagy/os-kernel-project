...
// malloc()
//	This function use Worst FIT strategy to allocate space in heap
...
void* malloc(uint32 size)
{
	...
	// Steps:
	//	1) Implement Worst FIT strategy to search the heap for suitable space
	...
	//Use sys_isUHeapPlacementStrategyWorstFIT() to check the current strategy
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
	...
	//	3) Implement Worst FIT strategy to search the heap for suitable space
