...
// [PROJECT 2020 - [0 GIVEN] Size of Working Set & LRU Second List]
...
struct Env {
	...
	int priority;
	uint32 sharing_variables_max_size;
	struct SharingVarInfo* ptr_sharing_variables;


	//2020
	//: [PROJECT 2020 - [0 GIVEN] LRU Data Structures]
